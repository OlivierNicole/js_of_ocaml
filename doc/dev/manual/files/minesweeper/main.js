...
(function(globalThis){
   ...
   function sub_string(b, ofs, len){
    ...
    if(! switch$0) var _eC_ = invalid_arg(_j_);
   ...
   function string_to_caml_string(str$0){
    ...
    if(_dW_ >= 0){
     ...
     for(;;){
      ...
      if(32 <= match){
       var _d0_ = match - 34 | 0, switch$1 = 0;
       if(58 < _d0_ >>> 0){
        if(93 > _d0_) switch$1 = 1;
       }
       else if(56 < _d0_ - 1 >>> 0) switch$0 = 1; else switch$1 = 1;
       if(switch$1){var _d1_ = 1; switch$0 = 2;}
      }
      else
       if(11 <= match){
      ...
      n[1] = n[1] + _d1_ | 0;
      var _d2_ = i$0 + 1 | 0;
      if(_dW_ !== i$0){var i$0 = _d2_; continue;}
      break;
     }
    }
   ...
   function transform_int_alt(iconv, s){
    ...
    if(_dQ_ >= 0){
     ...
     for(;;){
      ...
      var _dU_ = i$0 + 1 | 0;
      if(_dQ_ !== i$0){var i$0 = _dU_; continue;}
      break;
     }
    }
    var
      ...
      case 5:
       ...
       for(;;){
        if(i$0 === len)
         ...
         var _dI_ = caml_string_get(str, i$0) - 46 | 0, switch$0 = 0;
         if(23 < _dI_ >>> 0){
          if(55 === _dI_) switch$0 = 1;
         }
         else if(21 < _dI_ - 1 >>> 0) switch$0 = 1;
   ...
   function to_string(e){
    ...
    for(;;){
     if(param){
      ...
      try{var val = caml_call1(hd, e);}catch(_dt_){switch$0 = 1;}
      var switch$1 = 0;
      if(switch$0 || ! val)
       switch$1 = 1;
      else
   ...
   function print_raw_backtrace(outchan, raw_backtrace){
    ...
    if(_dn_ >= 0){
     ...
     for(;;){
      ...
      var _do_ = pos + 1 | 0;
      if(_dn_ !== pos){var pos = _do_; continue;}
      break;
     }
    }
    return 0;
   ...
   function neighbours(cf, param$0){
    ...
    for(;;){
     ...
     if(_cO_){
      ...
      var _cR_ = _cO_;
     if(_cR_){var accu$0 = [0, x, accu], accu = accu$0, param = l; continue;}
     var param = l;
    }
   }
     ...
     for(;;){
      ...
      if(_cJ_ >= 0){
       ...
       for(;;){
        ...
        var _cM_ = x + 1 | 0;
        if(_cJ_ !== x){var x = _cM_; continue;}
        break;
       }
      }
      var _cK_ = y + 1 | 0;
      if(_cH_ !== y){var y = _cK_; continue;}
      break;
     }
    }
    return 0;
     ...
     for(;;){
      ...
      if(_cD_ >= 0){
       ...
       for(;;){
        ...
        t6.onclick = t5;
        var _cF_ = x + 1 | 0;
        if(_cD_ !== x){var x = _cF_; continue;}
        break;
       }
      }
      var _cE_ = y + 1 | 0;
      if(_cB_ !== y){var y = _cE_; continue;}
      break;
     }
    }
    return 0;
    ...
    function callback(param$3){
     ...
     if(_b7_ >= 0){
      ...
      for(;;){
       ...
       var _b$_ = i$1 + 1 | 0;
       if(_b7_ !== i$1){var i$1 = _b$_; continue;}
       break;
      }
     }
     ...
     for(;;){
      ...
      for(;;){
       ...
       if(len < m){
        ...
        if(! switch$0) var n$0 = invalid_arg(_bL_);
        ...
        for(;;){
         ...
         if(_cj_ >= 0){
          ...
          for(;;){
           ...
           var _cm_ = x$0 + 1 | 0;
           if(_cj_ !== x$0){var x$0 = _cm_; continue;}
           break;
          }
         }
         appendChild(buf, createBr(document$0));
         ...
         var _cl_ = y$0 + 1 | 0;
         if(_ch_ !== y$0){var y$0 = _cl_; continue;}
         break;
        }
       }
