...
(function(globalThis){
   ...
   var
    ...
    _cC_ = cst$4,
    _cD_ = "Choose a level",
    _cv_ = [0, "examples/boulderdash/boulderdash.ml", 331, 72],
    _cw_ = "--",
    _cE_ = "maps.txt",
    _cs_ =
      [0,
   ...
   function symbol_bind(p, f){
    ...
    function create_result_promise_and_call(param){
     ...
     function callback(p_result){
      ...
      catch(exn$0){var exn = caml_wrap_exception(exn$0), p$0 = fail(exn);}
   ...
   function catch$0(f, h){
    ...
    function create_result_promise_and_call(param){
     ...
     function callback(p_result){
      ...
      catch(exn){var exn$0 = caml_wrap_exception(exn), p$1 = fail(exn$0);}
      var p$2 = underlying(p);
