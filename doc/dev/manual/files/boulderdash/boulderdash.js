...
(function(globalThis){
   ...
   var
    ...
    cst_border_1px_black_solid_bac =
      "border: 1px black solid; background-color: white ; display: inline ; padding-right: .5em; padding-left: .5em;",
    cst_camlinternalFormat_ml = "camlinternalFormat.ml",
    cst_false = "false",
    cst_g = "g",
    cst_sprites_boulder_png = "sprites/boulder.png",
    cst_sprites_end_png = "sprites/end.png",
    cst_sprites_guy_png = "sprites/guy.png",
    cst_true = "true";
   ...
   var
    ...
    s$0 = "5.4.0",
    git_version = "e2e1f3d",
    api_function_name = "wakeup_later";
   ...
   var
    ...
    _j_ = "nth",
    _k_ = "List.nth",
    _n_ = "String.blit / Bytes.blit_string",
    _m_ = "Bytes.blit",
    _l_ = "String.sub / Bytes.sub",
    _o_ = "String.index_from / Bytes.index_from",
    _p_ = "Array.blit",
    ...
    _a$_ = [0, cst_camlinternalFormat_ml, 1558, 4],
    _ba_ = "Printf: bad conversion %[",
    _bb_ = [0, cst_camlinternalFormat_ml, 1626, 39],
    _bc_ = [0, cst_camlinternalFormat_ml, 1649, 31],
    _bd_ = [0, cst_camlinternalFormat_ml, 1650, 31],
    _be_ = "Printf: bad conversion %_",
    _bf_ = cst$0,
    _bg_ = cst$1,
    _bh_ = cst$0,
    _bi_ = cst$1,
    ...
    _y_ = "@%",
    _z_ = "@",
    _ag_ = "CamlinternalFormat.Type_mismatch",
    _bm_ = cst$2,
    _bn_ = [0, [11, ", ", [2, 0, [2, 0, 0]]], ", %s%s"],
    _bJ_ =
      [0,
    ...
    _bI_ = "Fatal error: out of memory in uncaught exception handler",
    _bH_ =
      [0,
       [11, cst_Fatal_error_exception, [2, 0, [12, 10, 0]]],
       cst_Fatal_error_exception_s],
    ...
    _bx_ = "Raised at",
    _by_ = "Re-raised at",
    _bz_ = "Raised by primitive operation at",
    _bA_ = "Called from",
    _bB_ = " (inlined)",
    _bD_ = cst$2,
    _bC_ =
    ...
    _bs_ = "Out of memory",
    _bt_ = "Stack overflow",
    _bu_ = "Pattern matching failed",
    _bv_ = "Assertion failed",
    _bw_ = "Undefined recursive module",
    _bo_ = [0, [12, 40, [2, 0, [2, 0, [12, 41, 0]]]], "(%s%s)"],
    _bp_ = cst$2,
    _bq_ = cst$2,
    _br_ = [0, [12, 40, [2, 0, [12, 41, 0]]], "(%s)"],
    _bl_ = [0, [4, 0, 0, 0, 0], cst_d],
    _bj_ = [0, [3, 0, 0], "%S"],
    _bk_ = "_",
    _bG_ =
      [0,
    ...
    _bQ_ = caml_int64_create_lo_mi_hi(14371852, 15349651, 22696),
    _bR_ = caml_int64_create_lo_mi_hi(12230193, 11438743, 35013),
    _bS_ = caml_int64_create_lo_mi_hi(1424933, 15549263, 2083),
    _bT_ = caml_int64_create_lo_mi_hi(9492471, 4696708, 43520),
    _bL_ = caml_int64_create_lo_mi_hi(1, 0, 0),
    _bM_ = caml_int64_create_lo_mi_hi(0, 0, 0),
    _bP_ = caml_int64_create_lo_mi_hi(1, 0, 0),
    _bN_ = caml_int64_create_lo_mi_hi(0, 0, 0),
    _bO_ = caml_int64_create_lo_mi_hi(2, 0, 0),
    _bU_ = "Jsoo_runtime.Error.Exn",
    _b0_ = "table",
    _bZ_ = "img",
    _bY_ = "br",
    _bX_ = "h1",
    ...
    _ce_ = [0, 0],
    _cf_ = [0, 0],
    _cb_ = [0, [11, cst_Lwt, [2, 0, 0]], cst_Lwt_s],
    _cc_ = [0, [11, cst_Lwt, [2, 0, 0]], cst_Lwt_s],
    _cd_ = [0, 1],
    _ca_ = "wakeup_exn",
    _b$_ = "wakeup",
    _b8_ = [0, [11, cst_Lwt, [2, 0, 0]], cst_Lwt_s],
    _b9_ = [0, [11, cst_Lwt, [2, 0, 0]], cst_Lwt_s],
    _b__ = [0, 0],
    _b6_ = cst_Fatal_error_exception,
    _b7_ = "Lwt.Resolution_loop.Canceled",
    _co_ = cst$2,
    _cn_ = "Js_of_ocaml_lwt__Lwt_xmlHttpRequest.Wrong_headers",
    _cp_ = "Exception during Lwt.async: ",
    _cx_ = [0, [8, [0, 0, 3], 0, 0, 0], "%g"],
    _cy_ = "malformed level",
    _cz_ = "Boulder Dash in Ocaml",
    _cA_ = "Elapsed time: ",
    _cB_ = " Remaining diamonds: ",
    _cC_ = cst$4,
    _cD_ = "Choose a level",
    _cv_ = [0, "examples/boulderdash/boulderdash.ml", 335, 72],
    _cw_ = "--",
    _cE_ = "maps.txt",
    _cs_ =
      [0,
    ...
    _cr_ = "--:--:--",
    _cq_ = "LOADING...",
    _ct_ = "Dune__exe__Boulderdash.Death",
    _cu_ = "Dune__exe__Boulderdash.Eos";
   ...
   function flush_all(param){
    ...
    for(;;){
     ...
     try{caml_ml_flush(a);}
      ...
      var _gI_ = caml_wrap_exception(_gJ_);
      if(_gI_[1] !== Sys_error) throw caml_maybe_attach_backtrace(_gI_, 0);
     }
     var param$0 = l;
    }
   }
   ...
   var at_exit_key = new_key(0, function(param, _gE_){return 0;});
     ...
     switch(param[0]){
       case 0:
        var
         ...
         af = match[2],
         fa = match[1],
         _gh_ = function(param){af(0); return 0;};
        return [0, function(param){fa(0); return 0;}, _gh_, ed, de];
       case 1:
        var
         rest$0 = param[1],
         ...
         af$0 = match$0[2],
         fa$0 = match$0[1],
         _gi_ = function(param){af$0(0); return 0;};
        return [0, function(param){fa$0(0); return 0;}, _gi_, ed$0, de$0];
       case 2:
        var
         rest$1 = param[1],
         ...
         af$1 = match$1[2],
         fa$1 = match$1[1],
         _gj_ = function(param){af$1(0); return 0;};
        return [0, function(param){fa$1(0); return 0;}, _gj_, ed$1, de$1];
       case 3:
        var
         rest$2 = param[1],
         ...
         af$2 = match$2[2],
         fa$2 = match$2[1],
         _gk_ = function(param){af$2(0); return 0;};
        return [0, function(param){fa$2(0); return 0;}, _gk_, ed$2, de$2];
       case 4:
        var
         rest$3 = param[1],
         ...
         af$3 = match$3[2],
         fa$3 = match$3[1],
         _gl_ = function(param){af$3(0); return 0;};
        return [0, function(param){fa$3(0); return 0;}, _gl_, ed$3, de$3];
       case 5:
        var
         rest$4 = param[1],
         ...
         af$4 = match$4[2],
         fa$4 = match$4[1],
         _gm_ = function(param){af$4(0); return 0;};
        return [0, function(param){fa$4(0); return 0;}, _gm_, ed$4, de$4];
       case 6:
        var
         rest$5 = param[1],
         ...
         af$5 = match$5[2],
         fa$5 = match$5[1],
         _gn_ = function(param){af$5(0); return 0;};
        return [0, function(param){fa$5(0); return 0;}, _gn_, ed$5, de$5];
       case 7:
        var
         rest$6 = param[1],
         ...
         af$6 = match$6[2],
         fa$6 = match$6[1],
         _go_ = function(param){af$6(0); return 0;};
        return [0, function(param){fa$6(0); return 0;}, _go_, ed$6, de$6];
       case 8:
        var
         rest$7 = param[2],
         ...
         af$7 = match$7[2],
         fa$7 = match$7[1],
         _gp_ = function(param){af$7(0); return 0;};
        return [0, function(param){fa$7(0); return 0;}, _gp_, ed$7, de$7];
       case 9:
        var
         rest$8 = param[3],
         ty2 = param[2],
         ...
         ga = match$9[2],
         ag = match$9[1],
         _gq_ = function(param){jd(0); de$8(0); return 0;},
         _gr_ = function(param){ed$8(0); dj(0); return 0;},
         _gs_ = function(param){ga(0); af$8(0); return 0;};
        return [0,
       ...
       case 10:
        var
         ...
         af$9 = match$10[2],
         fa$9 = match$10[1],
         _gt_ = function(param){af$9(0); return 0;};
        return [0, function(param){fa$9(0); return 0;}, _gt_, ed$9, de$9];
       case 11:
        var
         rest$10 = param[1],
         ...
         af$10 = match$11[2],
         fa$10 = match$11[1],
         _gu_ = function(param){af$10(0); return 0;};
        return [0, function(param){fa$10(0); return 0;}, _gu_, ed$10, de$10];
       case 12:
        var
         rest$11 = param[1],
         ...
         af$11 = match$12[2],
         fa$11 = match$12[1],
         _gv_ = function(param){af$11(0); return 0;};
        return [0, function(param){fa$11(0); return 0;}, _gv_, ed$11, de$11];
       case 13:
        var
         rest$12 = param[1],
         ...
         af$12 = match$13[2],
         fa$12 = match$13[1],
         _gw_ = function(param){de$12(0); return 0;},
         _gx_ = function(param){ed$12(0); return 0;},
         _gy_ = function(param){af$12(0); return 0;};
        return [0, function(param){fa$12(0); return 0;}, _gy_, _gx_, _gw_];
       default:
        var
         rest$13 = param[1],
         ...
         af$13 = match$14[2],
         fa$13 = match$14[1],
         _gz_ = function(param){de$13(0); return 0;},
         _gA_ = function(param){ed$13(0); return 0;},
         _gB_ = function(param){af$13(0); return 0;};
        return [0, function(param){fa$13(0); return 0;}, _gB_, _gA_, _gz_];
     }
    function _ge_(param){return 0;}
   ...
   function trans(ty1, ty2){
         ...
         switch(ty2[0]){
           case 8:
            var
             rest2$7 = ty2[2],
             ty2$0 = ty2[1],
             _gd_ = trans(rest1$7, rest2$7);
            return [8, trans(ty1$0, ty2$0), _gd_];
           case 10: break;
           case 11:
            switch$0 = 1; break;
           case 12:
    ...
    switch(switch$0){
      ...
      default: throw caml_maybe_attach_backtrace([0, Assert_failure, ___], 1);
    }
   }
        ...
        switch(ign[0]){
          ...
          case 9:
           var
            sub_fmtty$3 = ign[2],
            pad_opt$2 = ign[1],
            _gc_ = type_ignored_format_substituti(sub_fmtty$3, rest, fmtty0),
            match$43 = _gc_[2],
            fmtty$21 = match$43[2],
            fmt$22 = match$43[1],
            sub_fmtty$4 = _gc_[1];
      ...
      case 9:
       if(typeof fmtty !== "number" && 9 === fmtty[0]){
        var
         ...
         _f$_ = [0, erase_rel(sub1_fmtty)];
        if(caml_notequal([0, erase_rel(sub1_fmtty$0)], _f$_))
         throw caml_maybe_attach_backtrace(Type_mismatch, 1);
        var _ga_ = [0, erase_rel(sub2_fmtty$1)];
        if(caml_notequal([0, erase_rel(sub2_fmtty$2)], _ga_))
         throw caml_maybe_attach_backtrace(Type_mismatch, 1);
        var
   ...
   function fix_padding(padty, width, str){
    ...
    var _f__ = 2 === padty$0 ? 48 : 32, res = make(width$0, _f__);
    switch(padty$0){
      case 0:
   ...
   function string_to_caml_string(str$0){
    var
     ...
     n = [0, 0],
     _f2_ = caml_ml_bytes_length(b) - 1 | 0,
     _f1_ = 0;
    if(_f2_ >= 0){
     var i$0 = _f1_;
     for(;;){
      ...
      if(32 <= match){
       var _f6_ = match - 34 | 0, switch$1 = 0;
       if(58 < _f6_ >>> 0){
        if(93 > _f6_) switch$1 = 1;
       }
       else if(56 < _f6_ - 1 >>> 0) switch$0 = 1; else switch$1 = 1;
       if(switch$1){var _f7_ = 1; switch$0 = 2;}
      }
      else
       if(11 <= match){
      ...
      n[1] = n[1] + _f7_ | 0;
      var _f8_ = i$0 + 1 | 0;
      if(_f2_ !== i$0){var i$0 = _f8_; continue;}
      break;
     }
    }
    if(n[1] === caml_ml_bytes_length(b))
     ...
     n[1] = 0;
     var _f4_ = caml_ml_bytes_length(b) - 1 | 0, _f3_ = 0;
     if(_f4_ >= 0){
      var i = _f3_;
      for(;;){
   ...
   function transform_int_alt(iconv, s){
    ...
    var n = [0, 0], _fW_ = caml_ml_string_length(s) - 1 | 0, _fV_ = 0;
    if(_fW_ >= 0){
     var i$0 = _fV_;
     for(;;){
      if(9 >= caml_string_unsafe_get(s, i$0) - 48 >>> 0) n[1]++;
      var _f0_ = i$0 + 1 | 0;
      if(_fW_ !== i$0){var i$0 = _f0_; continue;}
      break;
     }
    }
    var
    ...
    var
     ...
     _fY_ = caml_ml_string_length(s) - 1 | 0,
     _fX_ = 0;
    if(_fY_ >= 0){
     var i = _fX_;
     for(;;){
   ...
   function convert_int32(iconv, n){
    switch(iconv){
      ...
      case 14:
       var _fT_ = _aK_; break;
      default: var _fT_ = _aT_;
    }
    return transform_int_alt(iconv, caml_format_int(_fT_, n));
   }
   function convert_nativeint(iconv, n){
    switch(iconv){
      ...
      case 14:
       var _fS_ = _aX_; break;
      default: var _fS_ = _a6_;
    }
    return transform_int_alt(iconv, caml_format_int(_fS_, n));
   }
   function convert_int64(iconv, n){
    switch(iconv){
      ...
      case 14:
       var _fR_ = _ax_; break;
      default: var _fR_ = _aG_;
    }
    return transform_int_alt(iconv, caml_int64_format(_fR_, n));
   }
      ...
      case 5:
       ...
       for(;;){
        if(i$0 === len)
         ...
         var _fO_ = caml_string_get(str, i$0) - 46 | 0, switch$0 = 0;
         if(23 < _fO_ >>> 0){
          if(55 === _fO_) switch$0 = 1;
         }
         else if(21 < _fO_ - 1 >>> 0) switch$0 = 1;
         if(! switch$0){var i$1 = i$0 + 1 | 0, i$0 = i$1; continue;}
         var _fP_ = 1;
        }
        var _fQ_ = _fP_ ? str : symbol(str, _a7_);
        return caml_special_val(_fQ_);
       }
      case 6:
       return hex(0);
      case 7:
       ...
       if(0 === l)
        ...
        var r = caml_create_bytes(l), _fK_ = l - 1 | 0, _fJ_ = 0;
        if(_fK_ >= 0){
         var i = _fJ_;
         for(;;){
          var
           c = caml_bytes_unsafe_get(s, i),
           _fL_ = 25 < c - 97 >>> 0 ? c : c - 32 | 0;
          caml_bytes_unsafe_set(r, i, _fL_);
          var _fM_ = i + 1 | 0;
       ...
       return caml_string_of_bytes(_fN_);
      case 8:
    ...
    for(;;){
     ...
     switch(fmt$0[0]){
       ...
       default:
        ...
        if(counter >= 50)
         return caml_trampoline_return
                 (make_custom$0, [0, k$0, acc$0, rest$23, arity, _fH_]);
        var counter$0 = counter + 1 | 0;
        return make_custom$0(counter$0, k$0, acc$0, rest$23, arity, _fH_);
     }
    }
   }
   ...
   function make_invalid_arg(counter, k, acc, fmt){
    var _fE_ = [8, acc, _be_];
    if(counter >= 50)
     return caml_trampoline_return(make_printf$0, [0, k, _fE_, fmt]);
    var counter$0 = counter + 1 | 0;
    return make_printf$0(counter$0, k, _fE_, fmt);
   }
   function make_custom$0(counter, k, acc, rest, arity, f){
    ...
    var _fD_ = [4, acc, f];
    if(counter >= 50)
     return caml_trampoline_return(make_printf$0, [0, k, _fD_, rest]);
    var counter$0 = counter + 1 | 0;
    return make_printf$0(counter$0, k, _fD_, rest);
   }
   ...
   function fprintf(oc, fmt$0){
    ...
    return make_printf
            (function(acc){output_acc(oc, acc); return 0;}, _fC_, fmt);
   }
   ...
   function field(x, i$1){
    ...
    if(caml_obj_tag(f) !== 253) return _bk_;
    var
   ...
   function other_fields(x, i){
    ...
    return caml_call2(sprintf(_bn_), _fB_, _fA_);
   }
   function to_string(e){
    ...
    for(;;){
     if(param){
      ...
      try{var val = caml_call1(hd, e);}catch(_fz_){switch$0 = 1;}
      var switch$1 = 0;
      if(switch$0 || ! val)
       switch$1 = 1;
      else
     ...
     if(0 === caml_obj_tag(e)){
      ...
      if(2 < match >>> 0)
       var
        _fv_ = other_fields(e, 2),
        _fw_ = field(e, 1),
        _fy_ = caml_call2(sprintf(_bo_), _fw_, _fv_);
      else
       switch(match){
         case 0:
          var _fy_ = _bp_; break;
         case 1:
          var _fy_ = _bq_; break;
         default:
          var _fx_ = field(e, 1), _fy_ = caml_call1(sprintf(_br_), _fx_);
       }
      var match$0 = [0, constructor, [0, _fy_]];
     }
     else
      var match$0 = [0, e[1], 0];
     ...
     for(;;){
       ...
       info$0 =
         function(pos){
          function info(is_raise){
           return is_raise ? 0 === pos ? _bx_ : _by_ : 0 === pos ? _bz_ : _bA_;
          }
          return info;
         },
       info = info$0(pos);
      if(0 === slot[0])
       var
        ...
        _fl_ = slot[4],
        _fm_ = slot[3],
        _fn_ = slot[6] ? _bB_ : _bD_,
        _fo_ = slot[2],
        _fp_ = slot[7],
        _fq_ = info(slot[1]),
        match =
          [0,
           caml_call7(sprintf(_bC_), _fq_, _fp_, _fo_, _fn_, _fm_, _fl_, _fk_)];
      else if(slot[1])
       var match = 0;
      else
       var _fr_ = info(0), match = [0, caml_call1(sprintf(_bE_), _fr_)];
      if(match){var str = match[1]; caml_call1(fprintf(outchan, _bF_), str);}
      var _fu_ = pos + 1 | 0;
      if(_ft_ !== pos){var pos = _fu_; continue;}
      break;
     }
    }
    return 0;
   ...
   var errors = _bG_.slice(), empty_backtrace = [0];
   function handle_uncaught_exception(exn$0, debugger_in_use){
    try{
     try{
      ...
      try{
       var _e__ = to_string(exn$0);
       caml_call1(eprintf(_bH_), _e__);
       print_raw_backtrace(stderr, raw_backtrace);
       var status = caml_ml_debug_info_status(0);
       if(status < 0){
        var _e$_ = abs(status);
        prerr_endline(caml_check_bound(errors, _e$_)[1 + _e$_]);
       }
       var _fa_ = caml_ml_flush(stderr), _fe_ = _fa_;
      }
      catch(exn$1){
       var
        exn = caml_wrap_exception(exn$1),
        raw_backtrace$0 = caml_get_exception_raw_backtrace(0),
        _fc_ = to_string(exn$0);
       caml_call1(eprintf(_bJ_), _fc_);
       print_raw_backtrace(stderr, raw_backtrace);
       var _fd_ = to_string(exn);
       caml_call1(eprintf(_bK_), _fd_);
       print_raw_backtrace(stderr, raw_backtrace$0);
       var _fe_ = caml_ml_flush(stderr);
      }
      var _ff_ = _fe_;
     }
     catch(_fh_){
      var _fb_ = caml_wrap_exception(_fh_);
      if(_fb_ !== Out_of_memory) throw caml_maybe_attach_backtrace(_fb_, 0);
      var _ff_ = prerr_endline(_bI_);
     }
     return _ff_;
    }
    catch(_fg_){return 0;}
   ...
   function mk(i1, i2, i3$0, i4$0){
    ...
    caml_ba_set_1(s, 0, caml_int64_or(i1, _bL_));
    caml_ba_set_1(s, 1, i2);
    var i3 = caml_notequal(i3$0, _bM_) ? i3$0 : _bP_;
    caml_ba_set_1(s, 2, i3);
    var i4 = caml_notequal(i4$0, _bN_) ? i4$0 : _bO_;
   ...
   function mk_default(param){return mk(_bT_, _bS_, _bR_, _bQ_);}
   new_key([0, split], mk_default);
   var
    Error = [248, _bU_, caml_fresh_oo_id(0)],
    exn = [0, Error, [0]],
   ...
   global.Document;
   global.FileReader;
   var onIE = caml_js_on_ie(0) | 0;
   global.document;
   function createElement(doc, name){
    return doc.createElement(caml_jsstring_of_string(name));
   }
   function unsafeCreateElement(doc, name){return createElement(doc, name);}
   function createOption(doc){return unsafeCreateElement(doc, _bV_);}
   function createDiv(doc){return unsafeCreateElement(doc, _bW_);}
   function createBr(doc){return unsafeCreateElement(doc, _bY_);}
   ...
   new regExp("[$]", cst_g);
   var quote_re = regexp(_b1_), Local_exn = [248, _b2_, caml_fresh_oo_id(0)];
   ...
   function urldecode_js_string_string(s$0){
    ...
    var s = s$0.replace(plus_re_js_string, cst$4);
   ...
   if(x !== undefined$0)
    ...
    var
     t42 = function(param, _e9_){return 0;},
     t41 = function(param, _e8_){return 0;},
   ...
   try{caml_int_of_string(caml_string_of_jsbytes(t43.port));}
    ...
    var _b4_ = caml_wrap_exception(_e7_);
   ...
   function aux(i$1){
    try{
     ...
     if(! switch$0) var _e5_ = invalid_arg(_o_);
     var j = _e5_;
    }
    catch(_e6_){
     var _e4_ = caml_wrap_exception(_e6_);
     if(_e4_ !== Not_found) throw caml_maybe_attach_backtrace(_e4_, 0);
     var j = l;
    }
    var word = sub$0(path_string, i$1, j - i$1 | 0);
    return l <= j ? [0, word, 0] : [0, word, aux(j + 1 | 0)];
   }
   var a = aux(0), switch$0 = 0;
   if(a && ! caml_string_notequal(a[1], cst$2)){
    var _b3_ = a[2];
    if(! _b3_ || ! caml_string_notequal(_b3_[1], cst$2) && ! _b3_[2])
     switch$0 = 1;
   }
   var
    s = t43.search.charAt(0) === "?" ? t43.search.slice(1) : t43.search,
    arr = s.split(caml_jsstring_of_string(make$0(1, 38))),
    len = arr.length;
   function aux$0(acc, idx){
    ...
    for(;;){
     ...
     try{
         ...
         function(s){
          function _e2_(param){
           var
            y = param[2],
            x = param[1],
            _e3_ = urldecode_js_string_string(y);
      ...
      var _eV_ = caml_wrap_exception(_eZ_);
      if(_eV_ !== Local_exn) throw caml_maybe_attach_backtrace(_eV_, 0);
   ...
   symbol(s$0, symbol(_cF_, git_version));
   var
    console$0 = caml_js_get_console(0),
    Empty$0 = [248, _b5_, caml_fresh_oo_id(0)];
   ...
   var Canceled = [248, _b7_, caml_fresh_oo_id(0)];
    ...
    switch(_eP_[0]){
      case 1:
       return _eP_[1] === Canceled
               ? 0
               : caml_call1(ksprintf(invalid_arg, _b9_), api_function_name);
      case 2:
       var result$0 = state_of_result(result);
       resolve(_b__, 0, p, result$0);
       return 0;
      default:
       return caml_call1(ksprintf(invalid_arg, _b8_), api_function_name);
    }
   }
   function wakeup(r, v){return wakeup_general(_b$_, r, [0, v]);}
   ...
   function make_into_proxy(outer_promise, user_provided_promise){
    ...
    switch(match[0]){
      case 1:
       return resolve(_cf_, 0, outer_promise, p[1]);
      case 2:
       var
        p_callbacks = match[1],
      ...
      default: return resolve(_ce_, 0, outer_promise, p[1]);
    }
   }
    ...
    function create_result_promise_and_call(param){
     ...
     function callback(p_result){
      if(1 === p_result[0]){
       ...
       resolve(_cg_, 0, p$2, p_result);
       return 0;
      }
      var v = p_result[1];
      current_storage[1] = saved_storage;
      try{var _eO_ = caml_call1(f, v), p$0 = _eO_;}
      catch(exn$0){
       var exn = caml_wrap_exception(exn$0);
    ...
    switch(result[0]){
      ...
      default:
       ...
       return run_callback_or_defer_it
               (_ch_, function(param){return caml_call1(f, v);}, _eN_);
    }
   }
   function catch$0(f, h){
    try{var _eL_ = caml_call1(f, 0), p = _eL_;}
    catch(exn$0){var exn = caml_wrap_exception(exn$0), p = fail(exn);}
    var p$0 = underlying(p);
    function create_result_promise_and_call(param){
     var p = new_pending([0, p$0]), saved_storage = current_storage[1];
     function callback(p_result){
      if(1 !== p_result[0]){
       var p$0 = underlying(p);
       resolve(_ci_, 0, p$0, p_result);
       return 0;
      }
      var exn = p_result[1];
      current_storage[1] = saved_storage;
      try{var _eM_ = caml_call1(h, exn), p$1 = _eM_;}
      catch(exn){
    ...
    switch(match[0]){
      case 1:
       ...
       return run_callback_or_defer_it
               (_cj_, function(param){return caml_call1(h, exn$0);}, _eK_);
      case 2:
       var
        p_callbacks = match[1],
   ...
   var
    pause_hook = [0, function(_eI_){return 0;}],
    paused = create(0),
    _cm_ = [0, 0];
   function wakeup_paused(param){
    if(is_empty(paused)){_cm_[1] = 0; return 0;}
    var tmp = create(0);
    tmp[1][2] = paused[2];
    paused[2][1] = tmp[1];
    tmp[1] = paused[1];
    ...
    for(;;){
     var _eH_ = curr !== tmp ? 1 : 0;
     if(! _eH_) return _eH_;
     if(curr[4]){var r = curr[3]; wakeup(r, 0);}
     var curr$0 = curr[2], curr = curr$0;
    }
   }
   var Wrong_headers = [248, _cn_, caml_fresh_oo_id(0)];
   function sleep(d){
    var match = task(0), w = match[2], t = match[1], d$0 = d * 1000.;
    function callback(_eG_){return wakeup(w, _eG_);}
    var id = [0, 0];
    function loop(d, param){
     ...
     var
      cb =
        remain == 0. ? callback : function(_eF_){return loop(remain, _eF_);};
   ...
   function append_text(e, s){
    return appendChild(e, document.createTextNode(caml_jsstring_of_string(s)));
   }
   function replace_child(t3, n){
    var x = t3.firstChild;
    if(1 - (x == no_handler ? 1 : 0)) removeChild(t3, x);
    return appendChild(t3, n);
   }
   var Death = [248, _ct_, caml_fresh_oo_id(0)];
   function img_assoc(v){
    switch(v){
      case 0:
       return "sprites/empty.png";
      case 1:
       return "sprites/grass.png";
      case 2:
       return "sprites/diamond.png";
      case 3:
       return cst_sprites_boulder_png;
      case 4:
       return "sprites/door.png";
      case 5:
       return cst_sprites_end_png;
      case 6:
       return cst_sprites_guy_png;
      case 7:
       return "sprites/wall.png";
   ...
   function fall(state){
    var changed = [0, 0], _ea_ = state[1].length - 1 - 2 | 0;
    if(_ea_ >= 1){
     var y = _ea_;
     for(;;){
      var
       _ed_ = caml_check_bound(state[1], y)[1 + y].length - 1 - 2 | 0,
       _ec_ = 1;
      if(_ed_ >= 1){
       var x = _ec_;
       for(;;){
        var
         ...
         _eg_ =
           6
            ===
             caml_check_bound(caml_check_bound(state[1], _ef_)[1 + _ef_], x)
              [1 + x]
            ? 1
            : 0,
         sustaining =
        ...
        if(_eh_)
         var
          ...
          _ej_ =
            3
             ===
              caml_check_bound(caml_check_bound(state[1], _ei_)[1 + _ei_], x)
               [1 + x]
             ? 1
             : 0;
        else
        ...
        if(_ek_){
         var
          ...
          _em_ =
            0
             ===
              caml_check_bound(caml_check_bound(state[1], _el_)[1 + _el_], x)
               [1 + x]
             ? 1
             : 0;
         if(_em_){
          var
           ...
           _eo_ =
             3
              ===
               caml_check_bound(caml_check_bound(state[1], y)[1 + y], _en_)
                [1 + _en_]
              ? 1
              : 0;
          if(_eo_)
           var
            ...
            _er_ =
              3
               ===
                caml_check_bound
                  (caml_check_bound(state[1], _eq_)[1 + _eq_], _ep_)
                 [1 + _ep_]
               ? 1
               : 0;
          else
        ...
        if(_es_){
         var
          ...
          _eu_ =
            0
             ===
              caml_check_bound(caml_check_bound(state[1], _et_)[1 + _et_], x)
               [1 + x]
             ? 1
             : 0;
         if(_eu_){
        ...
        if(_eA_)
         var
          ...
          _eC_ =
            6
             ===
              caml_check_bound(caml_check_bound(state[1], _eB_)[1 + _eB_], x)
               [1 + x]
             ? 1
             : 0,
          _eD_ =
         ...
         var _eD_ = _eA_;
        if(_eD_){
         set_cell(state, x, y + 1 | 0, 8);
         throw caml_maybe_attach_backtrace(Death, 1);
        }
        var _eE_ = x + 1 | 0;
      ...
      var _ee_ = y - 1 | 0;
      if(1 !== y){var y = _ee_; continue;}
      break;
     }
    }
    if(! changed[1]) return return$0(0);
    function _eb_(param){return fall(state);}
    return symbol_bind(sleep(0.05), _eb_);
   }
   function build_interaction(state, show_rem, clock){
    ...
    function _di_(param){
     ...
     if(_dm_ >= 0){
      ...
      for(;;){
       var
        _do_ = caml_check_bound(state[1], y$0)[1 + y$0].length - 1 - 1 | 0,
        _dn_ = 0;
       if(_do_ >= 0){
        var x$0 = _dn_;
        for(;;){
         var
          t15 =
            caml_check_bound(caml_check_bound(state[2], y$0)[1 + y$0], x$0)
             [1 + x$0];
         t15.onmouseover = no_handler;
         var
          t17 =
            caml_check_bound(caml_check_bound(state[2], y$0)[1 + y$0], x$0)
             [1 + x$0];
         t17.onmouseout = no_handler;
         var
          t19 =
            caml_check_bound(caml_check_bound(state[2], y$0)[1 + y$0], x$0)
             [1 + x$0];
         t19.onclick = no_handler;
         var _dq_ = x$0 + 1 | 0;
         if(_do_ !== x$0){var x$0 = _dq_; continue;}
         break;
        }
       }
       var _dp_ = y$0 + 1 | 0;
       if(_dm_ !== y$0){var y$0 = _dp_; continue;}
       break;
      }
     }
     function inhibit(f, x){
      if(1 - state[8]){
       state[8] = 1;
       var _d$_ = function(param){state[8] = 0; return return$0(0);};
       symbol_bind(caml_call1(f, 0), _d$_);
      }
      return false$0;
     }
     function set_pending_out(f, out, param){
      function _d__(param){state[9][1] = [0, out]; return return$0(0);}
      return symbol_bind(caml_call1(f, 0), _d__);
     }
      ...
      for(;;){
       var
        ...
        param$1 =
          caml_check_bound(caml_check_bound(state[1], y)[1 + y], x)[1 + x],
        switch$0 = 0;
       if(5 !== param$1 && 3 <= param$1){var _dK_ = 0; switch$0 = 1;}
       ...
       if(_dK_){
        var
            ...
            function click_cont$0(param){
             function _d7_(param){
              ...
              function _d8_(param){
               ...
               return symbol_bind(fall(state), _d9_);
              }
              return symbol_bind(sleep(0.05), _d8_);
             }
             return symbol_bind(caml_call1(click_cont, 0), _d7_);
            }
            return click_cont$0;
           },
             ...
             return symbol_bind
                     (catch$0
                       (function(param){
                         ...
                         return symbol_bind(caml_call1(click_cont, 0), _d6_);
                        },
                        _d5_),
                      _d4_);
            }
         ...
         _dL_ =
           function(over_cont){
             return function(_d3_){return with_pending_out(over_cont, _d3_);};
            }
            (over_cont$1),
         _dM_ =
           function(out_cont, _d1_){
             return function(_d2_){
              return set_pending_out(_d1_, out_cont, _d2_);};
            }
            (out_cont$1, _dL_),
         t25 =
           handler
        ...
        t26.onmouseover = t25;
        var
         _dN_ = function(param){return return$0(0);},
         _dO_ =
           function(_dX_){
             return function(_dY_){return with_pending_out(_dX_, _dY_);};
            }
            (_dN_),
         t27 =
           handler
        ...
        var
         _dP_ =
           function(click){
             return function(_dU_){return with_pending_out(click, _dU_);};
            }
            (click),
         t29 =
           handler
            (function(_dS_){
               return function(_dT_){return inhibit(_dS_, _dT_);};
              }
              (_dP_)),
         t30 =
           caml_check_bound(caml_check_bound(state[2], y)[1 + y], x)[1 + x];
     ...
     function update_push(pos, next, img, img_guy){
      ...
      try{
       ...
       var _dr_ = caml_wrap_exception(_dJ_);
       if(_dr_[1] !== Invalid_argument)
        throw caml_maybe_attach_backtrace(_dr_, 0);
       var _ds_ = 0;
      }
      if(! _ds_) return _ds_;
      function over(param){
       var
        t32 = caml_check_bound(caml_check_bound(state[2], y)[1 + y], x)[1 + x];
       t32.src = img_guy;
       var
        t34 =
          caml_check_bound(caml_check_bound(state[2], y$0)[1 + y$0], x$0)
      ...
      function out(param){
       var
        t36 = caml_check_bound(caml_check_bound(state[2], y)[1 + y], x)[1 + x];
       t36.src = cst_sprites_guy_png;
       var
        t38 =
          caml_check_bound(caml_check_bound(state[2], y$0)[1 + y$0], x$0)
           [1 + x$0];
       return t38.src = cst_sprites_boulder_png;
      }
      function click(param){
       set_cell(state, x, y, 0);
       ...
       function _dH_(param){return build_interaction(state, show_rem, clock);}
       function _dI_(e){
        return e === Death ? (state[6] = 1, return$0(0)) : fail(e);
       }
       return symbol_bind
      ...
      function _dt_(_dG_){return with_pending_out(over, _dG_);}
      function _du_(_dF_){return set_pending_out(_dt_, out, _dF_);}
      var
       t39 = handler(function(_dE_){return inhibit(_du_, _dE_);}),
       t40 =
         caml_check_bound(caml_check_bound(state[2], y$0)[1 + y$0], x$0)
          [1 + x$0];
      t40.onmouseover = t39;
      function _dv_(param){return return$0(0);}
      function _dw_(_dD_){return with_pending_out(_dv_, _dD_);}
      var
       t41 = handler(function(_dC_){return inhibit(_dw_, _dC_);}),
       t42 =
         caml_check_bound(caml_check_bound(state[2], y$0)[1 + y$0], x$0)
          [1 + x$0];
      t42.onmouseout = t41;
      function _dx_(_dB_){return with_pending_out(click, _dB_);}
      var
       t43 = handler(function(_dA_){return inhibit(_dx_, _dA_);}),
       t44 =
         caml_check_bound(caml_check_bound(state[2], y$0)[1 + y$0], x$0)
          [1 + x$0];
      return t44.onclick = t43;
     }
     if(caml_equal(state[3], state[4])){
      ...
      if(0 === state[5]){
       var
        ...
        y = match[2],
        x = match[1],
        t50 = caml_check_bound(caml_check_bound(state[2], y)[1 + y], x)[1 + x];
       t50.src = cst_sprites_end_png;
       caml_check_bound(caml_check_bound(state[1], y)[1 + y], x)[1 + x] = 5;
      }
      var
       r$0 =
         function(param){
      ...
      update
       (d(state[3]),
        ...
        nil_cont,
        nil_cont_async);
      update_push(state[3], r$0, "sprites/bR.png", "sprites/push_r.png");
     ...
     if(m[1])
      if(is_empty(m[2]))
       ...
       var seq = m[2], v = 0;
       if(is_empty(seq)) throw caml_maybe_attach_backtrace(Empty$0, 1);
       var node = seq[2];
       remove(node);
       var r = node[3], result$0 = [0, v], p = underlying(r), _dk_ = p[1];
       switch(_dk_[0]){
         case 1:
          if(_dk_[1] !== Canceled)
           caml_call1(ksprintf(invalid_arg, _cc_), api_function_name);
          break;
         case 2:
          var result = state_of_result(result$0);
          resolve(0, _cd_, p, result);
          break;
         default: caml_call1(ksprintf(invalid_arg, _cb_), api_function_name);
       }
      }
     return return$0(0);
    }
    ...
    if(m[1]){
     var
      sequence = m[2],
      data = new_pending(1),
      node = [0, sequence[1], sequence, data, 1];
     sequence[1][2] = node;
     sequence[1] = node;
     var callbacks = data[1][1];
     callbacks[2] = [2, node];
     var _dj_ = data;
    }
    else{m[1] = 1; var _dj_ = return_unit;}
    return symbol_bind(_dj_, _di_);
   }
   function opt_style(t51, style){
    if(! style) return 0;
    var t52 = style[1], t53 = t51.style;
    return t53.cssText = t52;
   }
   var
    Eos = [248, _cu_, caml_fresh_oo_id(0)],
    t79 =
      handler
       (function(param){
         var parent = document.getElementById("boulderdash");
         if(parent == no_handler)
          throw caml_maybe_attach_backtrace([0, Assert_failure, _cv_], 1);
         var
          board_div = createDiv(document),
          t0 = [0, caml_sys_time(0)],
          div = createDiv(document),
          t9 = div.style;
         t9.cssText = cst_border_1px_black_solid_bac;
         ...
         function update_cb(param){
          ...
          function _dh_(param){return update_cb(0);}
          return symbol_bind(sleep(1.), _dh_);
         }
         update_cb(0);
         function _cG_(param){stopped[1] = 1; return 0;}
         var
          clock =
            [0,
             div,
             function(param){
              t0[1] = caml_sys_time(0);
              stopped[1] = 0;
              return 0;
             },
             _cG_],
         ...
         function load_data(name, process){
          var div = createDiv(document), t6 = div.style;
          t6.cssText =
          ...
          function _c8_(data){
           function _dg_(res){removeChild(parent, div); return return$0(res);}
           return symbol_bind(caml_call1(process, data), _dg_);
          }
          try{var _c7_ = return$0(caml_read_file_content(name)), _c9_ = _c7_;}
          catch(_c__){
           var _c6_ = caml_wrap_exception(_c__);
           if(_c6_ !== Not_found) throw caml_maybe_attach_backtrace(_c6_, 0);
           var
            _c5_ =
              function(r){
               var cod = r[2], msg = r[4];
           ...
           req.open("GET", caml_jsstring_of_string(name), true$0);
           ...
           var
            headers =
              function(s){
               function _de_(v){return [0, caml_string_of_jsstring(v)];}
                 ...
                 switch(req.readyState){
                   ...
                   case 4:
                    ...
                    var
                     ...
                     _da_ = caml_string_of_jsstring,
                     _db_ = function(param){return _co_;},
                     response =
                       [0,
                        name,
                        code,
           ...
           var _c9_ = symbol_bind(res, _c5_);
          }
          return symbol_bind(_c9_, _c8_);
         }
         var div$0 = createDiv(document), t62 = div$0.style;
         t62.cssText = cst_border_1px_black_solid_bac;
         append_text(div$0, _cw_);
         function show_rem(v){
          return replace_child
                  (div$0,
                   document.createTextNode(caml_jsstring_of_string("" + v)));
         }
         function _cH_(levels){
          var t75 = parent.style;
          t75.cssText =
           "font-family: sans-serif; text-align: center; background-color: #e8e8e8;";
          var h1 = unsafeCreateElement(document, _bX_);
          append_text(h1, _cz_);
          ...
          appendChild(div, div$0);
          append_text(div, _cC_);
          var
           select = createElement(document, elt),
           option = createOption(document);
          append_text(option, _cD_);
          appendChild(select, option);
          iter
           (function(param){
             var n = param[2], option = createOption(document);
          ...
          var
           t77 =
             handler
              (function(param$0){
                var i = select.selectedIndex - 1 | 0, _cM_ = 0 <= i ? 1 : 0;
                if(_cM_){
                 ...
                 if(0 <= i){
                  ...
                  for(;;){
                   if(l$0){
                    ...
                    if(0 !== n){
                     var n$0 = n - 1 | 0, l$0 = l$1, n = n$0;
                     continue;
                    }
                    var _cO_ = a;
                   }
                   else
                    var _cO_ = failwith(_j_);
                   break;
                  }
                 }
                 else
                  var _cO_ = invalid_arg(_k_);
                 var file = _cO_[1];
                 load_data
                  (file,
                   function(data){
                    var
                     res = [0, 0],
                     row = [0, 0],
                     _cX_ = caml_ml_string_length(data) - 1 | 0,
                     _cW_ = 0;
                    if(_cX_ >= 0){
                     var i = _cW_;
                     for(;;){
                      var match = caml_string_get(data, i), switch$0 = 0;
                      if(47 <= match){
                       if(83 <= match){
                        if(89 > match){
                         var switch$1 = 0;
                         switch(match - 83 | 0){
                           case 0:
                            row[1] = [0, 6, row[1]]; break;
                           case 4:
                            row[1] = [0, 6, row[1]]; break;
                           case 5:
                            row[1] = [0, 3, row[1]]; break;
                           default: switch$1 = 1;
                         }
                       ...
                       switch(match - 32 | 0){
                         case 0:
                          row[1] = [0, 0, row[1]]; break;
                         case 3:
                          row[1] = [0, 7, row[1]]; break;
                         case 11:
                          row[1] = [0, 2, row[1]]; break;
                         case 14:
                          row[1] = [0, 1, row[1]]; break;
                         default: switch$2 = 1;
                       }
                       if(! switch$2) switch$0 = 1;
                      }
                      if(! switch$0) failwith(_cy_);
                      var _c0_ = i + 1 | 0;
                    ...
                    function _cY_(c){
                     var
                      img = unsafeCreateElement(document, _bZ_),
                      t65 = img_assoc(c);
                     img.src = t65;
                     return img;
                    }
                    var
                     cells =
                       map$0(function(_c4_){return map$0(_cY_, _c4_);}, map$1),
                     gx = [0, 0],
                     gy = [0, 0],
                     ex = [0, 0],
                     ey = [0, 0],
                     ...
                     style$0 = [0, style],
                     table = unsafeCreateElement(document, _b0_);
                    opt_style(table, style$0);
                    var _cR_ = cells.length - 1 - 1 | 0, tr_style = 0, _cQ_ = 0;
                    if(_cR_ >= 0){
                     var y = _cQ_;
                     for(;;){
                      ...
                      var
                       _cT_ = caml_check_bound(cells, y)[1 + y].length - 1 - 1 | 0,
                       _cS_ = 0;
                      if(_cT_ >= 0){
                       var x = _cS_;
                       for(;;){
                        ...
                        var
                         cell =
                           caml_check_bound(caml_check_bound(cells, y)[1 + y], x)
                            [1 + x];
                        switch
                         (caml_check_bound(caml_check_bound(map$1, y)[1 + y], x)
                           [1 + x]){
                          case 2:
                           rem[1]++; break;
                          case 4:
                        ...
                        appendChild(tr, td);
                        var _cV_ = x + 1 | 0;
                        if(_cT_ !== x){var x = _cV_; continue;}
                        break;
                       }
                      }
                      appendChild(table, tr);
                      var _cU_ = y + 1 | 0;
                      if(_cR_ !== y){var y = _cU_; continue;}
                      break;
                     }
                    }
                    ...
                    function _cZ_(param){
                     ...
                     function fade(param){
                      ...
                      function _c3_(param){
                       var
                        t71 =
                          caml_jsstring_of_string(caml_call1(sprintf(_cx_), t - t0)),
                        t72 = table.style;
                       t72.opacity = t71;
                       return fade(0);
                      }
                      return symbol_bind(sleep(0.05), _c3_);
                     }
                     function _c2_(param){clock_start(0); return return$0(0);}
                     return symbol_bind(fade(0), _c2_);
                    }
                    var _cP_ = [0, 0, create(0)];
                    return symbol_bind
                            (build_interaction
                              ([0,
                                map$1,
          ...
          appendChild(div, createBr(document));
          appendChild(div, createBr(document));
            ...
            (_cE_,
             function(txt){
              function find_string(st){
               ...
               for(;;){
                if(sz <= s) throw caml_maybe_attach_backtrace(Eos, 1);
                ...
                for(;;){
                 if(sz <= s$0) throw caml_maybe_attach_backtrace(Eos, 1);
                 if(34 === caml_string_get(txt, e$0))
                  return [0, sub$0(txt, s$0, e$0 - s$0 | 0), e$0 + 1 | 0];
              ...
              for(;;){
               try{
                var
                 match$0 = find_string(st),
                 st$1 = match$0[2],
                 fst = match$0[1],
                 match$1 = find_string(st$1),
                 st$2 = match$1[2],
                 snd = match$1[1],
                 _cK_ = [0, [0, [0, fst, snd], st$2]],
                 _cJ_ = _cK_;
               }
               catch(_cL_){
                var _cI_ = caml_wrap_exception(_cL_);
                if(_cI_ !== Eos) throw caml_maybe_attach_backtrace(_cI_, 0);
                var _cJ_ = 0;
               }
               if(! _cJ_) return return$0(rev(acc));
               var
                match = _cJ_[1],
                st$0 = match[2],
                elt = match[1],
