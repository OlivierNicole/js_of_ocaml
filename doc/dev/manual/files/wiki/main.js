...
(function(globalThis){
   ...
   var
    ...
    _b3_ = [0, 0],
    _b4_ = [0, 0],
    _b0_ = [0, [11, cst_Lwt, [2, 0, 0]], cst_Lwt_s],
    _b1_ = [0, [11, cst_Lwt, [2, 0, 0]], cst_Lwt_s],
    _b2_ = [0, 0],
    _bY_ = cst_Fatal_error_exception,
    _bZ_ = "Lwt.Resolution_loop.Canceled",
    _b__ = "Exception during Lwt.async: ",
    _cc_ = [0, cst_examples_wiki_wikicreole_m, 207, 32],
    _cd_ = [0, cst_examples_wiki_wikicreole_m, 216, 6],
    _ce_ = [0, cst_examples_wiki_wikicreole_m, 231, 6],
    _cg_ = [0, cst_examples_wiki_wikicreole_m, 285, 6],
    _ch_ = "*",
    _cf_ = [5, 0],
    _cb_ = [0, cst_examples_wiki_wikicreole_m, 158, 6],
    _b$_ = "//",
    _ca_ = "**",
    _cA_ = "http://youtube.com/embed/",
    _cq_ = "ul",
    _co_ = "ol",
    _ck_ = "th",
    _cl_ = "td",
    _cH_ = [0, "examples/wiki/main.ml", 33, 70],
    _cI_ = cst$0;
   ...
   function flush_all(param){
    ...
    for(;;){
     ...
     try{caml_ml_flush(a);}
      ...
      var _fm_ = caml_wrap_exception(_fn_);
      if(_fm_[1] !== Sys_error) throw caml_maybe_attach_backtrace(_fm_, 0);
     }
     var param$0 = l;
    }
   }
   ...
   function engine(tbl, state, buf){
    var
     ...
     _fj_ = 0 <= result ? 1 : 0,
     _fk_ = _fj_ ? buf[12] !== dummy_pos ? 1 : 0 : _fj_;
    if(_fk_){
     buf[11] = buf[12];
     var _fl_ = buf[12];
     buf[12] = [0, _fl_[1], _fl_[2], _fl_[3], buf[4] + buf[6] | 0];
    }
    return result;
   }
   ...
   var at_exit_key = new_key(0, function(param, _fi_){return 0;});
     ...
     switch(param[0]){
       case 0:
        var
         ...
         af = match[2],
         fa = match[1],
         _eX_ = function(param){af(0); return 0;};
        return [0, function(param){fa(0); return 0;}, _eX_, ed, de];
       case 1:
        var
         rest$0 = param[1],
         ...
         af$0 = match$0[2],
         fa$0 = match$0[1],
         _eY_ = function(param){af$0(0); return 0;};
        return [0, function(param){fa$0(0); return 0;}, _eY_, ed$0, de$0];
       case 2:
        var
         rest$1 = param[1],
         ...
         af$1 = match$1[2],
         fa$1 = match$1[1],
         _eZ_ = function(param){af$1(0); return 0;};
        return [0, function(param){fa$1(0); return 0;}, _eZ_, ed$1, de$1];
       case 3:
        var
         rest$2 = param[1],
         ...
         af$2 = match$2[2],
         fa$2 = match$2[1],
         _e0_ = function(param){af$2(0); return 0;};
        return [0, function(param){fa$2(0); return 0;}, _e0_, ed$2, de$2];
       case 4:
        var
         rest$3 = param[1],
         ...
         af$3 = match$3[2],
         fa$3 = match$3[1],
         _e1_ = function(param){af$3(0); return 0;};
        return [0, function(param){fa$3(0); return 0;}, _e1_, ed$3, de$3];
       case 5:
        var
         rest$4 = param[1],
         ...
         af$4 = match$4[2],
         fa$4 = match$4[1],
         _e2_ = function(param){af$4(0); return 0;};
        return [0, function(param){fa$4(0); return 0;}, _e2_, ed$4, de$4];
       case 6:
        var
         rest$5 = param[1],
         ...
         af$5 = match$5[2],
         fa$5 = match$5[1],
         _e3_ = function(param){af$5(0); return 0;};
        return [0, function(param){fa$5(0); return 0;}, _e3_, ed$5, de$5];
       case 7:
        var
         rest$6 = param[1],
         ...
         af$6 = match$6[2],
         fa$6 = match$6[1],
         _e4_ = function(param){af$6(0); return 0;};
        return [0, function(param){fa$6(0); return 0;}, _e4_, ed$6, de$6];
       case 8:
        var
         rest$7 = param[2],
         ...
         af$7 = match$7[2],
         fa$7 = match$7[1],
         _e5_ = function(param){af$7(0); return 0;};
        return [0, function(param){fa$7(0); return 0;}, _e5_, ed$7, de$7];
       case 9:
        var
         rest$8 = param[3],
         ty2 = param[2],
         ...
         ga = match$9[2],
         ag = match$9[1],
         _e6_ = function(param){jd(0); de$8(0); return 0;},
         _e7_ = function(param){ed$8(0); dj(0); return 0;},
         _e8_ = function(param){ga(0); af$8(0); return 0;};
        return [0,
       ...
       case 10:
        var
         ...
         af$9 = match$10[2],
         fa$9 = match$10[1],
         _e9_ = function(param){af$9(0); return 0;};
        return [0, function(param){fa$9(0); return 0;}, _e9_, ed$9, de$9];
       case 11:
        var
         rest$10 = param[1],
         ...
         af$10 = match$11[2],
         fa$10 = match$11[1],
         _e__ = function(param){af$10(0); return 0;};
        return [0, function(param){fa$10(0); return 0;}, _e__, ed$10, de$10];
       case 12:
        var
         rest$11 = param[1],
         ...
         af$11 = match$12[2],
         fa$11 = match$12[1],
         _e$_ = function(param){af$11(0); return 0;};
        return [0, function(param){fa$11(0); return 0;}, _e$_, ed$11, de$11];
       case 13:
        var
         rest$12 = param[1],
         ...
         af$12 = match$13[2],
         fa$12 = match$13[1],
         _fa_ = function(param){de$12(0); return 0;},
         _fb_ = function(param){ed$12(0); return 0;},
         _fc_ = function(param){af$12(0); return 0;};
        return [0, function(param){fa$12(0); return 0;}, _fc_, _fb_, _fa_];
       default:
        var
         rest$13 = param[1],
         ...
         af$13 = match$14[2],
         fa$13 = match$14[1],
         _fd_ = function(param){de$13(0); return 0;},
         _fe_ = function(param){ed$13(0); return 0;},
         _ff_ = function(param){af$13(0); return 0;};
        return [0, function(param){fa$13(0); return 0;}, _ff_, _fe_, _fd_];
     }
    function _eU_(param){return 0;}
    function _eV_(param){return 0;}
    function _eW_(param){return 0;}
    return [0, function(param){return 0;}, _eW_, _eV_, _eU_];
   }
         ...
         switch(ty2[0]){
           case 8:
            var
             rest2$7 = ty2[2],
             ty2$0 = ty2[1],
             _eT_ = trans(rest1$7, rest2$7);
            return [8, trans(ty1$0, ty2$0), _eT_];
           case 10: break;
           case 11:
            switch$0 = 1; break;
           case 12:
      ...
      case 14:
       if(typeof fmtty0 !== "number" && 9 === fmtty0[0]){
        var
         ...
         sub_fmtty$1 = fmt[2],
         pad_opt$0 = fmt[1],
         _eR_ = [0, erase_rel(sub_fmtty1)];
        if(caml_notequal([0, erase_rel(sub_fmtty$1)], _eR_))
         throw caml_maybe_attach_backtrace(Type_mismatch, 1);
        var
        ...
        switch(ign[0]){
          ...
          case 9:
           var
            sub_fmtty$3 = ign[2],
            pad_opt$2 = ign[1],
            _eS_ = type_ignored_format_substituti(sub_fmtty$3, rest, fmtty0),
            match$43 = _eS_[2],
            fmtty$21 = match$43[2],
            fmt$22 = match$43[1],
            sub_fmtty$4 = _eS_[1];
      ...
      case 9:
       if(typeof fmtty !== "number" && 9 === fmtty[0]){
        var
         ...
         _eP_ = [0, erase_rel(sub1_fmtty)];
        if(caml_notequal([0, erase_rel(sub1_fmtty$0)], _eP_))
         throw caml_maybe_attach_backtrace(Type_mismatch, 1);
        var _eQ_ = [0, erase_rel(sub2_fmtty$1)];
        if(caml_notequal([0, erase_rel(sub2_fmtty$2)], _eQ_))
         throw caml_maybe_attach_backtrace(Type_mismatch, 1);
        var
   ...
   function fix_padding(padty, width, str){
    ...
    var _eO_ = 2 === padty$0 ? 48 : 32, res = make(width$0, _eO_);
    switch(padty$0){
      case 0:
   ...
   function string_to_caml_string(str$0){
    var
     ...
     n = [0, 0],
     _eG_ = caml_ml_bytes_length(b) - 1 | 0,
     _eF_ = 0;
    if(_eG_ >= 0){
     var i$0 = _eF_;
     for(;;){
      ...
      if(32 <= match){
       var _eK_ = match - 34 | 0, switch$1 = 0;
       if(58 < _eK_ >>> 0){
        if(93 > _eK_) switch$1 = 1;
       }
       else if(56 < _eK_ - 1 >>> 0) switch$0 = 1; else switch$1 = 1;
       if(switch$1){var _eL_ = 1; switch$0 = 2;}
      }
      else
       if(11 <= match){
      ...
      n[1] = n[1] + _eL_ | 0;
      var _eM_ = i$0 + 1 | 0;
      if(_eG_ !== i$0){var i$0 = _eM_; continue;}
      break;
     }
    }
    if(n[1] === caml_ml_bytes_length(b))
     ...
     n[1] = 0;
     var _eI_ = caml_ml_bytes_length(b) - 1 | 0, _eH_ = 0;
     if(_eI_ >= 0){
      var i = _eH_;
      for(;;){
   ...
   function transform_int_alt(iconv, s){
    ...
    var n = [0, 0], _eA_ = caml_ml_string_length(s) - 1 | 0, _ez_ = 0;
    if(_eA_ >= 0){
     var i$0 = _ez_;
     for(;;){
      if(9 >= caml_string_unsafe_get(s, i$0) - 48 >>> 0) n[1]++;
      var _eE_ = i$0 + 1 | 0;
      if(_eA_ !== i$0){var i$0 = _eE_; continue;}
      break;
     }
    }
    var
    ...
    var
     ...
     _eC_ = caml_ml_string_length(s) - 1 | 0,
     _eB_ = 0;
    if(_eC_ >= 0){
     var i = _eB_;
     for(;;){
   ...
   function convert_int(iconv, n){
    switch(iconv){
      ...
      case 14:
       var _ey_ = _ai_; break;
      default: var _ey_ = _ar_;
    }
    return transform_int_alt(iconv, caml_format_int(_ey_, n));
   }
   ...
   function convert_int64(iconv, n){
    switch(iconv){
      ...
      case 14:
       var _ev_ = _av_; break;
      default: var _ev_ = _aE_;
    }
    return transform_int_alt(iconv, caml_int64_format(_ev_, n));
   }
      ...
      case 5:
       ...
       for(;;){
        if(i$0 === len)
         ...
         var _es_ = caml_string_get(str, i$0) - 46 | 0, switch$0 = 0;
         if(23 < _es_ >>> 0){
          if(55 === _es_) switch$0 = 1;
         }
         else if(21 < _es_ - 1 >>> 0) switch$0 = 1;
         if(! switch$0){var i$1 = i$0 + 1 | 0, i$0 = i$1; continue;}
         var _et_ = 1;
        }
        var _eu_ = _et_ ? str : symbol(str, _a5_);
        return caml_special_val(_eu_);
       }
      case 6:
       return hex(0);
      case 7:
       ...
       if(0 === l)
        ...
        var r = caml_create_bytes(l), _eo_ = l - 1 | 0, _en_ = 0;
        if(_eo_ >= 0){
         var i = _en_;
         for(;;){
          var
           c = caml_bytes_unsafe_get(s, i),
           _ep_ = 25 < c - 97 >>> 0 ? c : c - 32 | 0;
          caml_bytes_unsafe_set(r, i, _ep_);
          var _eq_ = i + 1 | 0;
          if(_eo_ !== i){var i = _eq_; continue;}
          break;
         }
        }
        var _er_ = r;
    ...
    for(;;){
     ...
     switch(fmt$0[0]){
       ...
       case 14:
        ...
        return function(param){
         var
          ...
          _em_ = type_format_gen(fmt$0, fmtty$0);
       ...
       default:
        ...
        if(counter >= 50)
         return caml_trampoline_return
                 (make_custom$0, [0, k$0, acc$0, rest$23, arity, _el_]);
        var counter$0 = counter + 1 | 0;
        return make_custom$0(counter$0, k$0, acc$0, rest$23, arity, _el_);
     }
    }
   }
   ...
   function make_invalid_arg(counter, k, acc, fmt){
    var _ei_ = [8, acc, _bc_];
    if(counter >= 50)
     return caml_trampoline_return(make_printf$0, [0, k, _ei_, fmt]);
    var counter$0 = counter + 1 | 0;
    return make_printf$0(counter$0, k, _ei_, fmt);
   }
   function make_custom$0(counter, k, acc, rest, arity, f){
    ...
    var _eh_ = [4, acc, f];
    if(counter >= 50)
     return caml_trampoline_return(make_printf$0, [0, k, _eh_, rest]);
    var counter$0 = counter + 1 | 0;
    return make_printf$0(counter$0, k, _eh_, rest);
   }
   ...
   function fprintf(oc, fmt$0){
    ...
    return make_printf
            (function(acc){output_acc(oc, acc); return 0;}, _eg_, fmt);
   }
   ...
   function other_fields(x, i){
    ...
    return caml_call2(sprintf(_bl_), _ef_, _ee_);
   }
   function to_string(e){
    ...
    for(;;){
     if(param){
      ...
      try{var val = caml_call1(hd, e);}catch(_ed_){switch$0 = 1;}
      var switch$1 = 0;
      if(switch$0 || ! val)
       switch$1 = 1;
      else
     ...
     if(0 === caml_obj_tag(e)){
      ...
      if(2 < match >>> 0)
       var
        ...
        _ea_ = field(e, 1),
        _ec_ = caml_call2(sprintf(_bm_), _ea_, _d$_);
      else
       switch(match){
         case 0:
          var _ec_ = _bn_; break;
         case 1:
          var _ec_ = _bo_; break;
         default:
          var _eb_ = field(e, 1), _ec_ = caml_call1(sprintf(_bp_), _eb_);
       }
      var match$0 = [0, constructor, [0, _ec_]];
     }
     else
      var match$0 = [0, e[1], 0];
     ...
     for(;;){
      ...
      if(0 === slot[0])
       var
        ...
        _d1_ = slot[4],
        _d2_ = slot[3],
        _d3_ = slot[6] ? _bz_ : _bB_,
        _d4_ = slot[2],
        _d5_ = slot[7],
        _d6_ = info(slot[1]),
        match =
          [0,
           caml_call7(sprintf(_bA_), _d6_, _d5_, _d4_, _d3_, _d2_, _d1_, _d0_)];
      else if(slot[1])
       var match = 0;
      else
       var _d7_ = info(0), match = [0, caml_call1(sprintf(_bC_), _d7_)];
      if(match){var str = match[1]; caml_call1(fprintf(outchan, _bD_), str);}
      var _d__ = pos + 1 | 0;
      if(_d9_ !== pos){var pos = _d__; continue;}
      break;
     }
    }
    return 0;
   ...
   function handle_uncaught_exception(exn$0, debugger_in_use){
    try{
     try{
      ...
      try{do_at_exit(0);}catch(_dY_){}
      try{
       var _dO_ = to_string(exn$0);
       caml_call1(eprintf(_bF_), _dO_);
       print_raw_backtrace(stderr, raw_backtrace);
       var status = caml_ml_debug_info_status(0);
       if(status < 0){
        var _dP_ = abs(status);
        prerr_endline(caml_check_bound(errors, _dP_)[1 + _dP_]);
       }
       var _dQ_ = caml_ml_flush(stderr), _dU_ = _dQ_;
      }
      catch(exn$1){
       var
        exn = caml_wrap_exception(exn$1),
        raw_backtrace$0 = caml_get_exception_raw_backtrace(0),
        _dS_ = to_string(exn$0);
       caml_call1(eprintf(_bH_), _dS_);
       print_raw_backtrace(stderr, raw_backtrace);
       var _dT_ = to_string(exn);
       caml_call1(eprintf(_bI_), _dT_);
       print_raw_backtrace(stderr, raw_backtrace$0);
       var _dU_ = caml_ml_flush(stderr);
      }
      var _dV_ = _dU_;
     }
     catch(_dX_){
      var _dR_ = caml_wrap_exception(_dX_);
      if(_dR_ !== Out_of_memory) throw caml_maybe_attach_backtrace(_dR_, 0);
      var _dV_ = prerr_endline(_bG_);
     }
     return _dV_;
    }
    catch(_dW_){return 0;}
   ...
   function mk(i1, i2, i3$0, i4$0){
    ...
    var i3 = caml_notequal(i3$0, _bK_) ? i3$0 : _bN_;
    caml_ba_set_1(s, 2, i3);
    var i4 = caml_notequal(i4$0, _bL_) ? i4$0 : _bM_;
   ...
   function createDiv(doc){return unsafeCreateElement(doc, _bT_);}
   ...
   function handle_with_async_exception_ho(f, v){
    try{var _dN_ = caml_call1(f, v); return _dN_;}
    catch(exn$0){
   ...
   function run_callbacks(callbacks, result){
    if(1 === result[0])
     var _dM_ = result[1] === Canceled ? 1 : 0, is_canceled = _dM_;
    else
     var is_canceled = 0;
    if(is_canceled){
     var
    ...
    if(1 === current_callback_nesting_depth[1])
     for(;;){
      if(0 !== deferred_callbacks[1]){
       ...
       if(! _dL_) throw caml_maybe_attach_backtrace(Empty, 1);
       var content = _dL_[1];
       if(_dL_[2]){
        var next = _dL_[2];
   ...
   function wakeup(r, exn){
    ...
    switch(_dK_[0]){
      ...
      case 2:
       var result = [0, exn]; resolve(_b2_, 0, p, result); return 0;
      default:
   ...
   var
    pause_hook = [0, function(_dJ_){return 0;}],
    paused = create(0),
    _b9_ = [0, 0];
   function wakeup_paused(param){
    if(paused[2] === paused){_b9_[1] = 0; return 0;}
    var tmp = create(0);
    tmp[1][2] = paused[2];
    paused[2][1] = tmp[1];
    tmp[1] = paused[1];
   ...
   function count(c, s){
    var n = [0, 0], _dG_ = caml_ml_string_length(s) - 1 | 0, _dF_ = 0;
    if(_dG_ >= 0){
     var i = _dF_;
     for(;;){
   ...
   function push(c, v){
    var _dD_ = c[12];
    if(typeof _dD_ !== "number" && 1 === _dD_[0]){c[8] = [0, v, c[8]]; return 0;}
    var _dE_ = c[7];
    c[7] = [0, caml_call1(c[1][21], v), _dE_];
    return 0;
   }
   ...
   function style_change(c, style){
    ...
    return style ? push_string(c, _b$_) : push_string(c, _ca_);
   }
   function pop_link(c, addr, stack){
    c[12] = stack;
    var _dA_ = c[7], _dB_ = rev(c[8]);
    c[7] = [0, caml_call2(c[1][7], addr, _dB_), _dA_];
    c[8] = 0;
    c[5] = 0;
    return 0;
   }
     ...
     switch(_dy_[0]){
       ...
       case 7:
        ...
        if(typeof match !== "number" && 6 === match[0]){
         var stack = match[2], entries = match[1], heading = _dy_[1];
     ...
     switch(_dx_[0]){
       ...
       case 6:
        ...
        if(typeof match !== "number" && 5 === match[0]){
         var rows = match[1], entries = _dx_[1];
   ...
   function end_paragraph(c, lev){
    for(;;){
     ...
     if(typeof match === "number"){
      if(0 !== c[7]){
       var _do_ = c[11], _dp_ = rev(c[7]);
       c[11] = [0, caml_call1(c[1][9], _dp_), _do_];
       c[7] = 0;
      }
      c[12] = 0;
      return 0;
     ...
     switch(match[0]){
       ...
       case 2:
        ...
        var _dq_ = c[11];
        c[11] = [0, caml_call1(f, rev(c[7])), _dq_];
        c[7] = 0;
        c[4] = 0;
        c[12] = 0;
        return 0;
       case 3:
        var stack$1 = match[1], _dr_ = c[10];
        c[10] = [0, [0, rev(c[7]), 0], _dr_];
        c[12] = stack$1;
        c[7] = 0;
        continue;
       case 4:
        ...
        continue;
       case 5:
        var rows = match[1], _du_ = c[11], _dv_ = rev(rows);
        c[11] = [0, caml_call1(c[1][20], _dv_), _du_];
        c[12] = 0;
        return 0;
       case 6:
        throw caml_maybe_attach_backtrace([0, Assert_failure, _cd_], 1);
       default: close_row(c); continue;
     }
    }
   }
   function start_list_item(c, kind, lev){
    var _dl_ = lev === (c[6] + 1 | 0) ? 1 : 0, switch$0 = 0;
    if(_dl_)
     var _dm_ = _dl_;
    else{
     var _dn_ = lev <= c[6] ? 1 : 0;
     if(_dn_){
       ...
       if(typeof stack === "number")
        ...
        switch(stack[0]){
          ...
          case 4:
           ...
           if(0 !== n){
            var n$0 = n - 1 | 0, stack = stack$2, n = n$0;
            continue;
           }
   ...
   function start_table_row(c, heading){
    if(1 - close_row(c)){end_paragraph(c, 0); c[12] = _cf_;}
     ...
     for(;;){
      ...
      switch(ocaml_lex_state$0){
        ...
        case 4:
         end_paragraph(c, 0);
         var _dg_ = c[11];
         c[11] = [0, caml_call1(c[1][19], 0), _dg_];
         continue a;
        case 5:
         end_paragraph(c, 0);
         b:
         for(;;){
          ...
          for(;;){
           ...
           switch(ocaml_lex_state$2){
             case 0:
              var s$0 = lexeme(lexbuf), _dh_ = c[9];
              c[9] =
               [0, sub$0(s$0, 1, caml_ml_string_length(s$0) - 1 | 0), _dh_];
              continue b;
             case 1:
              var _di_ = c[11], _dj_ = rev(c[9]);
              c[11] = [0, caml_call1(c[1][10], _dj_), _di_];
              c[9] = 0;
              if(counter >= 50)
             ...
             default:
              var _dk_ = c[9]; c[9] = [0, lexeme(lexbuf), _dk_]; continue b;
           }
          }
         }
        case 6:
   ...
   function parse_rem(counter, c, lexbuf){
    ...
    if(counter >= 50)
     return caml_trampoline_return
             (ocaml_lex_parse_rem_rec, [0, c, lexbuf, _dc_]);
    var counter$0 = counter + 1 | 0;
    return ocaml_lex_parse_rem_rec(counter$0, c, lexbuf, _dc_);
   }
     ...
     switch(ocaml_lex_state$1){
       ...
       case 4:
        ...
        var
         ...
         _c6_ = c[7],
         _c7_ = [0, caml_call1(c[1][1], addr), 0];
        c[7] = [0, caml_call2(c[1][7], addr, _c7_), _c6_];
        if(counter >= 50)
         return caml_trampoline_return(parse_rem, [0, c, lexbuf]);
        var counter$2 = counter + 1 | 0;
        return parse_rem(counter$2, c, lexbuf);
       case 5:
        ...
        var
         ...
         _c8_ = c[7],
         _c9_ = [0, caml_call1(c[1][1], addr$0), 0];
        c[7] = [0, caml_call2(c[1][8], addr$0, _c9_), _c8_];
        if(counter >= 50)
         return caml_trampoline_return(parse_rem, [0, c, lexbuf]);
        var counter$3 = counter + 1 | 0;
        return parse_rem(counter$3, c, lexbuf);
       ...
       case 8:
        ...
        var
         ...
         _c__ = c[7],
         _c$_ = [0, caml_call1(c[1][1], addr$3), 0];
        c[7] = [0, caml_call2(c[1][7], addr$3, _c$_), _c__];
        if(counter >= 50)
         return caml_trampoline_return(parse_rem, [0, c, lexbuf]);
        var counter$6 = counter + 1 | 0;
       ...
       case 10:
        ...
        for(;;){
         ...
         if(caml_string_unsafe_get(s$2, i) !== 124){var i$0 = i + 1 | 0, i = i$0; continue;}
         var
       ...
       case 11:
        var
         ...
         _da_ = caml_call1(c[1][1], txt),
         _db_ = [0, caml_call1(c[1][21], _da_), 0];
        push(c, caml_call1(c[1][6], _db_));
        if(counter >= 50)
         return caml_trampoline_return(parse_rem, [0, c, lexbuf]);
        var counter$8 = counter + 1 | 0;
     ...
     _c3_ =
       map
        (function(param){
          ...
          if(l) var v = l[1], _c4_ = [0, v, 0]; else var _c4_ = 0;
          var _c5_ = symbol$0(c, _c4_);
          return symbol$1(d.createElement("li"), _c5_);
         },
         c);
    return symbol$1(d.createElement(caml_jsstring_of_string(tag)), _c3_);
   }
   function _ci_(x){return x;}
   function _cj_(rows){
    var
     rows$0 =
       map
        (function(entries){
          var
           _c2_ =
             map
              (function(param){
                var c = param[2], h = param[1], kind = h ? _ck_ : _cl_;
                return symbol$1
                        (document.createElement(caml_jsstring_of_string(kind)), c);
               },
               entries);
          return symbol$1(document.createElement("tr"), _c2_);
         },
         rows),
     _c1_ = [0, symbol$1(document.createElement("tbody"), rows$0), 0];
    return symbol$1(document.createElement("table"), _c1_);
   }
   function _cm_(param){return document.createElement("hr");}
   function _cn_(s){return list_builder(document, _co_, s);}
   function _cp_(s){return list_builder(document, _cq_, s);}
   function _cr_(s){return symbol$1(document.createElement("h6"), s);}
   function _cs_(s){return symbol$1(document.createElement("h5"), s);}
   function _ct_(s){return symbol$1(document.createElement("h4"), s);}
   function _cu_(s){return symbol$1(document.createElement("h3"), s);}
   function _cv_(s){return symbol$1(document.createElement("h2"), s);}
   function _cw_(s){return symbol$1(document.createElement("h1"), s);}
   function _cx_(s){
    ...
    if(s){
     ...
     for(;;){
      if(param){
       ...
       var _cZ_ = acc;
      var dst = caml_create_bytes(_cZ_), pos = pos$1, param$0 = s;
      for(;;){
       if(param$0){
        var hd$0 = param$0[1];
        if(param$0[2]){
         ...
         caml_blit_string
          (cst$0, 0, dst, pos + caml_ml_string_length(hd$0) | 0, 0);
         var
          pos$0 = pos + caml_ml_string_length(hd$0) | 0 | 0,
          pos = pos$0,
          param$0 = tl$0;
         continue;
        }
       ...
       var _c0_ = caml_string_of_bytes(dst);
       break;
      }
      break;
     }
     ...
     var _c0_ = _n_;
    appendChild(p, document.createTextNode(caml_jsstring_of_string(_c0_)));
    return p;
   }
   function _cy_(s){return symbol$1(document.createElement("p"), s);}
   function _cz_(addr, s){
    var t13 = unsafeCreateElement(document, _bX_);
    t13.width = "480";
    t13.height = "360";
    var
     s$0 = caml_jsstring_of_string(addr),
     video_link = symbol(_cA_, caml_string_of_jsstring(global.encodeURI(s$0))),
     t16 = caml_jsstring_of_string(video_link);
    t13.src = t16;
    t13.frameBorder = "0";
    return t13;
   }
   function _cB_(addr, s){
    var
     t11 = unsafeCreateElement(document, _bV_),
     t10 = caml_jsstring_of_string(addr);
    t11.href = t10;
    return symbol$1(t11, s);
   }
   function _cC_(s){return symbol$1(document.createElement("tt"), s);}
   function _cD_(addr, alt){
    var
     t23 = unsafeCreateElement(document, _bW_),
   ...
   function _cE_(param){return document.createElement(cst_br);}
   function _cF_(s){return symbol$1(document.createElement("em"), s);}
   function _cG_(s){return symbol$1(document.createElement("strong"), s);}
   var
    builder =
      [0,
       function(s){
        return document.createTextNode(caml_jsstring_of_string(s));
       },
       _cG_,
       _cF_,
       _cE_,
   ...
   function onload(param){
    ...
    if(body == no_handler)
     throw caml_maybe_attach_backtrace([0, Assert_failure, _cH_], 1);
    ...
    var preview = createDiv(document), t11 = preview.style;
    t11.border = "1px black dashed";
    var t14 = preview.style;
    t14.padding = "5px";
    appendChild(body, textbox);
    appendChild(body, unsafeCreateElement(document, _bU_));
     ...
     if(caml_string_notequal(text, old_text)){
      try{
       ...
       var
        ...
        _cO_ = 0,
        _cP_ = 0,
        _cQ_ = caml_ml_string_length(text),
        lexbuf =
          [0,
       ...
       var
        _cT_ = rev(c[11]),
        rendered = symbol$1(createDiv(document), _cT_),
        x = preview.firstChild;
       if(1 - (x == no_handler ? 1 : 0)) preview.removeChild(x);
      ...
      var
       y = n - 1 | 0,
       x$0 = 0,
       _cU_ = caml_greaterequal(0, y) ? x$0 : y,
       n$0 = _cU_;
     function f$0(param){return dyn_preview(text, n$0);}
     var d$0 = 0 === n$0 ? 0.5 : 0.1, p = new_pending(1), d = d$0 * 1000.;
     function callback$0(_cX_){return wakeup(p, _cX_);}
     var id = [0, 0];
     function loop(d, param){
      ...
      var
       cb =
         remain == 0.
          ? callback$0
          : function(_cW_){return loop(remain, _cW_);};
     ...
     function create_result_promise_and_call(param){
      ...
      function callback(p_result){
       if(1 === p_result[0]){
        ...
        resolve(_b5_, 0, p$1, p_result);
        return 0;
       }
       var v = p_result[1];
       current_storage[1] = saved_storage;
       try{var _cV_ = f$0(v), user_provided_promise = _cV_;}
       catch(exn$0){
        var exn = caml_wrap_exception(exn$0);
       ...
       if(p$0 !== outer_promise){
        ...
        switch(match[0]){
          case 1:
           resolve(_b4_, 0, outer_promise, p$0[1]); break;
          case 2:
           var
            p_callbacks = match[1],
           ...
           break;
          default: resolve(_b3_, 0, outer_promise, p$0[1]);
        }
       }
       return 0;
      }
     ...
     switch(result[0]){
       ...
       default:
        ...
        return run_callback_or_defer_it
                (_b6_, function(param){return f$0(v);}, _cR_);
     }
    }
    dyn_preview(_cI_, 0);
    return false$0;
