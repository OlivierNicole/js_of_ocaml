...
//# buildInfo:effects=false, kind=exe, use-js-string=true, version=5.1.0~alpha+git-7f80554
(function
  (Object){
...
(function(globalThis){
     ...
     switch(param[0]){
       case 0:
        var
         ...
         af = match[2],
         fa = match[1],
         _f6_ = function(param){caml_call1(af, 0); return 0;};
        return [0,
       ...
       case 1:
        var
         ...
         af$0 = match$0[2],
         fa$0 = match$0[1],
         _f7_ = function(param){caml_call1(af$0, 0); return 0;};
        return [0,
       ...
       case 2:
        var
         ...
         af$1 = match$1[2],
         fa$1 = match$1[1],
         _f8_ = function(param){caml_call1(af$1, 0); return 0;};
        return [0,
       ...
       case 3:
        var
         ...
         af$2 = match$2[2],
         fa$2 = match$2[1],
         _f9_ = function(param){caml_call1(af$2, 0); return 0;};
        return [0,
       ...
       case 4:
        var
         ...
         af$3 = match$3[2],
         fa$3 = match$3[1],
         _f__ = function(param){caml_call1(af$3, 0); return 0;};
        return [0,
       ...
       case 5:
        var
         ...
         af$4 = match$4[2],
         fa$4 = match$4[1],
         _f$_ = function(param){caml_call1(af$4, 0); return 0;};
        return [0,
   ...
   if(_b8_ >= 0){
    ...
    for(;;){
     ...
     try{var _b4_ = caml_call2(Meths[28], name$0, table$0[3]), _cc_ = _b4_;}
     catch(_dX_){
      var _b3_ = caml_wrap_exception(_dX_);
      if(_b3_ !== Not_found) throw caml_maybe_attach_backtrace(_b3_, 0);
      var label = new_method(table$0);
      table$0[3] = caml_call3(Meths[4], name$0, label, table$0[3]);
      table$0[4] = caml_call3(Labs[4], label, 1, table$0[4]);
      var _cc_ = label;
     }
   ...
   if(_b__ >= 0){
    ...
    for(;;){
     ...
     try{var _b6_ = caml_call2(Vars[28], name, table$0[7]), _b$_ = _b6_;}
     catch(_dW_){
      ...
      if(caml_string_notequal(name, cst$2))
       table$0[7] = caml_call3(Vars[4], name, index, table$0[7]);
      var _b$_ = index;
     }
   ...
   for(;;){
    if(i$2[1] < len){
     ...
     if(typeof clo === "number")
      ...
      var element = clo;
     method_count[1]++;
     if(caml_call2(Labs[28], label$0, table$0[4])){
        ...
        handler
         (function(param$0){
           ...
           function _dh_(s){
            ...
            var
             hadj = caml_call6(_ce_(0, 0), 0, 0, 0, 0, 0, 0),
             vadj = caml_call6(_ce_(0, 0), 0, 0, 0, 0, 0, 0),
             sadj = caml_call6(_ce_(0, 0), 0, _da_, _c$_, _c__, _c9_, 0);
