...
//# buildInfo:effects=false, kind=exe, use-js-string=true, version=5.4.0+git-e2e1f3d
(function
  (Object){
...
(function(globalThis){
   ...
   var
    ...
    _m_ = "String.index_from / Bytes.index_from",
    _n_ = "Array.blit",
    ...
    _Z_ = "%r",
    ___ = "%_r",
    _$_ = [0, cst_camlinternalFormat_ml, 850, 23],
    _ak_ = [0, cst_camlinternalFormat_ml, 814, 21],
    _ac_ = [0, cst_camlinternalFormat_ml, 815, 21],
    _al_ = [0, cst_camlinternalFormat_ml, 818, 21],
    _ad_ = [0, cst_camlinternalFormat_ml, 819, 21],
    _am_ = [0, cst_camlinternalFormat_ml, 822, 19],
    _ae_ = [0, cst_camlinternalFormat_ml, 823, 19],
    _an_ = [0, cst_camlinternalFormat_ml, 826, 22],
    _af_ = [0, cst_camlinternalFormat_ml, 827, 22],
    _ao_ = [0, cst_camlinternalFormat_ml, 831, 30],
    _ag_ = [0, cst_camlinternalFormat_ml, 832, 30],
    _ai_ = [0, cst_camlinternalFormat_ml, 836, 26],
    _aa_ = [0, cst_camlinternalFormat_ml, 837, 26],
    _aj_ = [0, cst_camlinternalFormat_ml, 846, 28],
    _ab_ = [0, cst_camlinternalFormat_ml, 847, 28],
    _ah_ = [0, cst_camlinternalFormat_ml, 851, 23],
    ...
    _H_ = "@%",
    _I_ = "@",
    _ap_ = "CamlinternalFormat.Type_mismatch",
    _bv_ = cst$2,
    ...
    _bN_ = [0, [2, 0, [11, " unknown location", 0]], "%s unknown location"],
    _bB_ = "Out of memory",
    _bC_ = "Stack overflow",
    ...
    _cg_ = "Jsoo_runtime.Error.Exn",
    _ck_ = "canvas",
    _ci_ = "p",
    _ch_ = "div",
    _cj_ = "Js_of_ocaml__Dom_html.Canvas_not_available",
    _cl_ = "[\\][()\\\\|+*.?{}^$]",
    _cm_ = "Js_of_ocaml__Url.Local_exn",
    _dc_ = cst$3,
    _cA_ = [0, 0],
    _cB_ = [0, 1],
    _cy_ = [0, 0],
    ...
    _cv_ = "wakeup_exn",
    _cu_ = "wakeup",
    _cr_ = [0, [11, cst_Lwt, [2, 0, 0]], cst_Lwt_s],
    _cs_ = [0, [11, cst_Lwt, [2, 0, 0]], cst_Lwt_s],
    _ct_ = [0, 0],
    _cp_ = cst_Fatal_error_exception,
    _cq_ = "Lwt.Resolution_loop.Canceled",
    _cE_ = cst$2,
    _cD_ = "Js_of_ocaml_lwt__Lwt_xmlHttpRequest.Wrong_headers",
    _cF_ = "Exception during Lwt.async: ",
    _cI_ = [0, 0, 0],
    _cL_ = [0, cst_examples_graph_viewer_view, 299, 10],
    _cM_ = [0, cst_examples_graph_viewer_view, 302, 10],
    _cJ_ = [0, cst_examples_graph_viewer_view, 306, 8],
    _cK_ = [0, cst_examples_graph_viewer_view, 309, 8],
    _cG_ = [0, cst_examples_graph_viewer_view, 157, 14],
    _db_ = [0, [4, 0, 0, 0, [11, "px", 0]], "%dpx"],
    _c9_ = [0, 0.],
    _c__ = [0, 0.],
    _c$_ = [0, 1.],
    _da_ = [0, 20.],
    _cN_ = [0, "examples/graph_viewer/viewer_js.ml", 147, 26];
   ...
   function flush_all(param){
    ...
    for(;;){
     ...
     try{caml_ml_flush(a);}
      ...
      var _g3_ = caml_wrap_exception(_g4_);
      if(_g3_[1] !== Sys_error) throw caml_maybe_attach_backtrace(_g3_, 0);
     }
     var param$0 = l;
    }
   }
   ...
   function iteri(f, a){
    var _g1_ = a.length - 1 - 1 | 0, _g0_ = 0;
    if(_g1_ >= 0){
     var i = _g0_;
     for(;;){
   ...
   function _z_(Ord){
    ...
    function find_first(f, param$0){
     var param$1 = param$0;
     for(;;){
      if(! param$1) throw caml_maybe_attach_backtrace(Not_found, 1);
      var
       r$0 = param$1[4],
       d0$1 = param$1[3],
       v0$1 = param$1[2],
      ...
      for(;;){
       ...
       if(caml_call1(f, v0$0)){var v0 = v0$0, d0 = d0$0, param = l; continue;}
       var param = r;
      }
     }
    }
    ...
    function find_last(f, param$0){
     ...
     for(;;){
      ...
      for(;;){
       if(! param) return [0, v0, d0];
       var r = param[4], d0$0 = param[3], v0$0 = param[2], l = param[1];
       if(caml_call1(f, v0$0)){var v0 = v0$0, d0 = d0$0, param = r; continue;}
       var param = l;
      }
     }
    }
    ...
    function for_all(p, param){
     ...
     for(;;){
      ...
      var
       ...
       v = param$0[2],
       l = param$0[1],
       _gQ_ = caml_call2(p, v, d);
      if(_gQ_){
       var _gR_ = for_all(p, l);
       if(_gR_){var param$0 = r; continue;}
       var _gS_ = _gR_;
      }
      else
       var _gS_ = _gQ_;
    ...
    function exists(p, param){
     ...
     for(;;){
      ...
      if(_gN_)
       ...
       var _gP_ = exists(p, l);
       if(! _gP_){var param$0 = r; continue;}
       var _gO_ = _gP_;
      }
      return _gO_;
     }
    ...
    function merge(f, s1, s2){
     if(s1){
      ...
      if(height(s2) <= h1){
       var
        ...
        l2 = match[1],
        _gJ_ = merge(f, r1, r2),
        _gK_ = caml_call3(f, v1, [0, d1], d2);
       return concat_or_join(merge(f, l1, l2), v1, _gK_, _gJ_);
      }
     }
     else if(! s2) return 0;
     ...
     var
      ...
      d1$0 = match$0[2],
      l1$0 = match$0[1],
      _gL_ = merge(f, r1$0, r2$0),
      _gM_ = caml_call3(f, v2, d1$0, [0, d2$0]);
     return concat_or_join(merge(f, l1$0, l2$0), v2, _gM_, _gL_);
    }
    ...
    function partition(p, param){
     ...
     var
      ...
      rf = match$0[2],
      rt = match$0[1];
     if(pvd){var _gH_ = concat(lf, rf); return [0, join(lt, v, d, rt), _gH_];}
     var _gI_ = join(lf, v, d, rf);
     return [0, concat(lt, rt), _gI_];
    }
    ...
    function equal(cmp, m1, m2){
     ...
     for(;;){
      ...
      var
       ...
       d1 = e1[2],
       v1 = e1[1],
       _gE_ = 0 === caml_call2(Ord[1], v1, v2) ? 1 : 0;
      if(_gE_){
       var _gF_ = caml_call2(cmp, d1, d2);
       if(_gF_){
        var
         e2$1 = cons_enum(r2, e2$0),
         e1$1 = cons_enum(r1, e1$0),
    ...
    function cardinal(param){
     if(! param) return 0;
     var r = param[4], l = param[1], _gD_ = cardinal(r);
     return (cardinal(l) + 1 | 0) + _gD_ | 0;
    }
    ...
    function add_seq(seq$0, acc$0){
     var acc = acc$0, seq = seq$0;
     for(;;){
    ...
    function seq_of_enum(c, param){
     if(! c) return 0;
     var rest = c[4], t = c[3], v = c[2], k = c[1], _gB_ = cons_enum(t, rest);
     return [0, [0, k, v], function(_gC_){return seq_of_enum(_gB_, _gC_);}];
    }
    function to_seq(m){
     var _gz_ = cons_enum(m, 0);
     return function(_gA_){return seq_of_enum(_gz_, _gA_);};
    }
    ...
    function rev_seq_of_enum(c, param){
     if(! c) return 0;
     var rest = c[4], t = c[3], v = c[2], k = c[1], _gx_ = snoc_enum(t, rest);
     return [0,
             [0, k, v],
             function(_gy_){return rev_seq_of_enum(_gx_, _gy_);}];
    }
    function to_rev_seq(c){
     var _gv_ = snoc_enum(c, 0);
     return function(_gw_){return rev_seq_of_enum(_gv_, _gw_);};
    }
    function to_seq_from(low, m){
     ...
     for(;;){
      if(m$0){
       ...
       var _gt_ = c;
      return function(_gu_){return seq_of_enum(_gt_, _gu_);};
     }
    }
    return [0,
            empty,
   ...
   var at_exit_key = new_key(0, function(param, _gr_){return 0;});
     ...
     switch(param[0]){
       case 0:
        var
         ...
         af = match[2],
         fa = match[1],
         _f6_ = function(param){af(0); return 0;};
        return [0, function(param){fa(0); return 0;}, _f6_, ed, de];
       case 1:
        var
         rest$0 = param[1],
         ...
         af$0 = match$0[2],
         fa$0 = match$0[1],
         _f7_ = function(param){af$0(0); return 0;};
        return [0, function(param){fa$0(0); return 0;}, _f7_, ed$0, de$0];
       case 2:
        var
         rest$1 = param[1],
         ...
         af$1 = match$1[2],
         fa$1 = match$1[1],
         _f8_ = function(param){af$1(0); return 0;};
        return [0, function(param){fa$1(0); return 0;}, _f8_, ed$1, de$1];
       case 3:
        var
         rest$2 = param[1],
         ...
         af$2 = match$2[2],
         fa$2 = match$2[1],
         _f9_ = function(param){af$2(0); return 0;};
        return [0, function(param){fa$2(0); return 0;}, _f9_, ed$2, de$2];
       case 4:
        var
         rest$3 = param[1],
         ...
         af$3 = match$3[2],
         fa$3 = match$3[1],
         _f__ = function(param){af$3(0); return 0;};
        return [0, function(param){fa$3(0); return 0;}, _f__, ed$3, de$3];
       case 5:
        var
         rest$4 = param[1],
         ...
         af$4 = match$4[2],
         fa$4 = match$4[1],
         _f$_ = function(param){af$4(0); return 0;};
        return [0, function(param){fa$4(0); return 0;}, _f$_, ed$4, de$4];
       case 6:
        var
         rest$5 = param[1],
         ...
         af$5 = match$5[2],
         fa$5 = match$5[1],
         _ga_ = function(param){af$5(0); return 0;};
        return [0, function(param){fa$5(0); return 0;}, _ga_, ed$5, de$5];
       case 7:
        var
         rest$6 = param[1],
         ...
         af$6 = match$6[2],
         fa$6 = match$6[1],
         _gb_ = function(param){af$6(0); return 0;};
        return [0, function(param){fa$6(0); return 0;}, _gb_, ed$6, de$6];
       case 8:
        var
         rest$7 = param[2],
         ...
         af$7 = match$7[2],
         fa$7 = match$7[1],
         _gc_ = function(param){af$7(0); return 0;};
        return [0, function(param){fa$7(0); return 0;}, _gc_, ed$7, de$7];
       case 9:
        var
         rest$8 = param[3],
         ty2 = param[2],
         ...
         ga = match$9[2],
         ag = match$9[1],
         _gd_ = function(param){jd(0); de$8(0); return 0;},
         _ge_ = function(param){ed$8(0); dj(0); return 0;},
         _gf_ = function(param){ga(0); af$8(0); return 0;};
        return [0,
       ...
       case 10:
        var
         ...
         af$9 = match$10[2],
         fa$9 = match$10[1],
         _gg_ = function(param){af$9(0); return 0;};
        return [0, function(param){fa$9(0); return 0;}, _gg_, ed$9, de$9];
       case 11:
        var
         rest$10 = param[1],
         ...
         af$10 = match$11[2],
         fa$10 = match$11[1],
         _gh_ = function(param){af$10(0); return 0;};
        return [0, function(param){fa$10(0); return 0;}, _gh_, ed$10, de$10];
       case 12:
        var
         rest$11 = param[1],
         ...
         af$11 = match$12[2],
         fa$11 = match$12[1],
         _gi_ = function(param){af$11(0); return 0;};
        return [0, function(param){fa$11(0); return 0;}, _gi_, ed$11, de$11];
       case 13:
        var
         rest$12 = param[1],
         ...
         af$12 = match$13[2],
         fa$12 = match$13[1],
         _gj_ = function(param){de$12(0); return 0;},
         _gk_ = function(param){ed$12(0); return 0;},
         _gl_ = function(param){af$12(0); return 0;};
        return [0, function(param){fa$12(0); return 0;}, _gl_, _gk_, _gj_];
       default:
        var
         rest$13 = param[1],
         ...
         af$13 = match$14[2],
         fa$13 = match$14[1],
         _gm_ = function(param){de$13(0); return 0;},
         _gn_ = function(param){ed$13(0); return 0;},
         _go_ = function(param){af$13(0); return 0;};
        return [0, function(param){fa$13(0); return 0;}, _go_, _gn_, _gm_];
     }
    function _f3_(param){return 0;}
    function _f4_(param){return 0;}
    function _f5_(param){return 0;}
    return [0, function(param){return 0;}, _f5_, _f4_, _f3_];
   }
         ...
         switch(ty2[0]){
           case 8:
            var
             rest2$7 = ty2[2],
             ty2$0 = ty2[1],
             _f2_ = trans(rest1$7, rest2$7);
            return [8, trans(ty1$0, ty2$0), _f2_];
           case 10: break;
           case 11:
            switch$0 = 1; break;
           case 12:
      ...
      case 14:
       if(typeof fmtty0 !== "number" && 9 === fmtty0[0]){
        var
         ...
         sub_fmtty$1 = fmt[2],
         pad_opt$0 = fmt[1],
         _f0_ = [0, erase_rel(sub_fmtty1)];
        if(caml_notequal([0, erase_rel(sub_fmtty$1)], _f0_))
         throw caml_maybe_attach_backtrace(Type_mismatch, 1);
        var
        ...
        switch(ign[0]){
          ...
          case 9:
           var
            sub_fmtty$3 = ign[2],
            pad_opt$2 = ign[1],
            _f1_ = type_ignored_format_substituti(sub_fmtty$3, rest, fmtty0),
            match$43 = _f1_[2],
            fmtty$21 = match$43[2],
            fmt$22 = match$43[1],
            sub_fmtty$4 = _f1_[1];
      ...
      case 9:
       if(typeof fmtty !== "number" && 9 === fmtty[0]){
        var
         ...
         _fY_ = [0, erase_rel(sub1_fmtty)];
        if(caml_notequal([0, erase_rel(sub1_fmtty$0)], _fY_))
         throw caml_maybe_attach_backtrace(Type_mismatch, 1);
        var _fZ_ = [0, erase_rel(sub2_fmtty$1)];
        if(caml_notequal([0, erase_rel(sub2_fmtty$2)], _fZ_))
         throw caml_maybe_attach_backtrace(Type_mismatch, 1);
        var
   ...
   function fix_padding(padty, width, str){
    ...
    var _fX_ = 2 === padty$0 ? 48 : 32, res = make(width$0, _fX_);
    switch(padty$0){
      case 0:
   ...
   function string_to_caml_string(str$0){
    var
     ...
     n = [0, 0],
     _fP_ = caml_ml_bytes_length(b) - 1 | 0,
     _fO_ = 0;
    if(_fP_ >= 0){
     var i$0 = _fO_;
     for(;;){
      ...
      if(32 <= match){
       var _fT_ = match - 34 | 0, switch$1 = 0;
       if(58 < _fT_ >>> 0){
        if(93 > _fT_) switch$1 = 1;
       }
       else if(56 < _fT_ - 1 >>> 0) switch$0 = 1; else switch$1 = 1;
       if(switch$1){var _fU_ = 1; switch$0 = 2;}
      }
      else
       if(11 <= match){
    ...
    if(n[1] === caml_ml_bytes_length(b))
     ...
     n[1] = 0;
     var _fR_ = caml_ml_bytes_length(b) - 1 | 0, _fQ_ = 0;
     if(_fR_ >= 0){
      var i = _fQ_;
      for(;;){
   ...
   function transform_int_alt(iconv, s){
    ...
    var n = [0, 0], _fJ_ = caml_ml_string_length(s) - 1 | 0, _fI_ = 0;
    if(_fJ_ >= 0){
     var i$0 = _fI_;
     for(;;){
      if(9 >= caml_string_unsafe_get(s, i$0) - 48 >>> 0) n[1]++;
      var _fN_ = i$0 + 1 | 0;
      if(_fJ_ !== i$0){var i$0 = _fN_; continue;}
      break;
     }
    }
    var
    ...
    var
     ...
     _fL_ = caml_ml_string_length(s) - 1 | 0,
     _fK_ = 0;
    if(_fL_ >= 0){
     var i = _fK_;
     for(;;){
   ...
   function convert_int(iconv, n){
    switch(iconv){
      ...
      case 14:
       var _fH_ = _at_; break;
      default: var _fH_ = _aC_;
    }
    return transform_int_alt(iconv, caml_format_int(_fH_, n));
   }
   function convert_int32(iconv, n){
    switch(iconv){
      ...
      case 14:
       var _fG_ = _aT_; break;
      default: var _fG_ = _a2_;
    }
    return transform_int_alt(iconv, caml_format_int(_fG_, n));
   }
   function convert_nativeint(iconv, n){
    switch(iconv){
      ...
      case 14:
       var _fF_ = _a6_; break;
      default: var _fF_ = _bd_;
    }
    return transform_int_alt(iconv, caml_format_int(_fF_, n));
   }
   function convert_int64(iconv, n){
    switch(iconv){
      ...
      case 14:
       var _fE_ = _aG_; break;
      default: var _fE_ = _aP_;
    }
    return transform_int_alt(iconv, caml_int64_format(_fE_, n));
   }
      ...
      case 5:
       ...
       for(;;){
        if(i$0 === len)
         ...
         var _fB_ = caml_string_get(str, i$0) - 46 | 0, switch$0 = 0;
         if(23 < _fB_ >>> 0){
          if(55 === _fB_) switch$0 = 1;
         }
         else if(21 < _fB_ - 1 >>> 0) switch$0 = 1;
         if(! switch$0){var i$1 = i$0 + 1 | 0, i$0 = i$1; continue;}
         var _fC_ = 1;
        }
        var _fD_ = _fC_ ? str : symbol(str, _be_);
        return caml_special_val(_fD_);
       }
      case 6:
       return hex(0);
      case 7:
       ...
       if(0 === l)
        ...
        var r = caml_create_bytes(l), _fx_ = l - 1 | 0, _fw_ = 0;
        if(_fx_ >= 0){
         var i = _fw_;
         for(;;){
          var
           c = caml_bytes_unsafe_get(s, i),
           _fy_ = 25 < c - 97 >>> 0 ? c : c - 32 | 0;
          caml_bytes_unsafe_set(r, i, _fy_);
          var _fz_ = i + 1 | 0;
          if(_fx_ !== i){var i = _fz_; continue;}
          break;
         }
        }
        var _fA_ = r;
       }
       return caml_string_of_bytes(_fA_);
      case 8:
    ...
    for(;;){
     ...
     switch(fmt$0[0]){
       ...
       case 14:
        ...
        return function(param){
         var
          ...
          _fv_ = type_format_gen(fmt$0, fmtty$0);
         if(typeof _fv_[2] !== "number")
          throw caml_maybe_attach_backtrace(Type_mismatch, 1);
         var fmt = _fv_[1];
       ...
       default:
        ...
        if(counter >= 50)
         return caml_trampoline_return
                 (make_custom$0, [0, k$0, acc$0, rest$23, arity, _fu_]);
        var counter$0 = counter + 1 | 0;
        return make_custom$0(counter$0, k$0, acc$0, rest$23, arity, _fu_);
     }
    }
   }
   ...
   function fprintf(oc, fmt$0){
    ...
    return make_printf
            (function(acc){output_acc(oc, acc); return 0;}, _fp_, fmt);
   }
   ...
   function other_fields(x, i){
    ...
    return caml_call2(sprintf(_bw_), _fo_, _fn_);
   }
   function to_string(e){
    ...
    for(;;){
     if(param){
      ...
      try{var val = caml_call1(hd, e);}catch(_fm_){switch$0 = 1;}
      var switch$1 = 0;
      if(switch$0 || ! val)
       switch$1 = 1;
      else
     ...
     if(0 === caml_obj_tag(e)){
      ...
      if(2 < match >>> 0)
       var
        ...
        _fj_ = field(e, 1),
        _fl_ = caml_call2(sprintf(_bx_), _fj_, _fi_);
      else
       switch(match){
         case 0:
          var _fl_ = _by_; break;
         case 1:
          var _fl_ = _bz_; break;
         default:
          var _fk_ = field(e, 1), _fl_ = caml_call1(sprintf(_bA_), _fk_);
       }
      var match$0 = [0, constructor, [0, _fl_]];
     }
     else
      var match$0 = [0, e[1], 0];
     ...
     for(;;){
       ...
       info$0 =
         function(pos){
          function info(is_raise){
           return is_raise ? 0 === pos ? _bG_ : _bH_ : 0 === pos ? _bI_ : _bJ_;
          }
          return info;
         },
       info = info$0(pos);
      if(0 === slot[0])
       var
        ...
        _e__ = slot[4],
        _e$_ = slot[3],
        _fa_ = slot[6] ? _bK_ : _bM_,
        _fb_ = slot[2],
        _fc_ = slot[7],
        _fd_ = info(slot[1]),
        match =
          [0,
           caml_call7(sprintf(_bL_), _fd_, _fc_, _fb_, _fa_, _e$_, _e__, _e9_)];
      else if(slot[1])
       var match = 0;
      else
      ...
      var _fh_ = pos + 1 | 0;
      if(_fg_ !== pos){var pos = _fh_; continue;}
      break;
     }
    }
    return 0;
   ...
   var errors = _bP_.slice(), empty_backtrace = [0];
   function handle_uncaught_exception(exn$0, debugger_in_use){
    try{
     try{
      ...
      try{do_at_exit(0);}catch(_e7_){}
      try{
       var _eX_ = to_string(exn$0);
       caml_call1(eprintf(_bQ_), _eX_);
       print_raw_backtrace(stderr, raw_backtrace);
       var status = caml_ml_debug_info_status(0);
       if(status < 0){
        var _eY_ = abs(status);
        prerr_endline(caml_check_bound(errors, _eY_)[1 + _eY_]);
       }
       var _eZ_ = caml_ml_flush(stderr), _e3_ = _eZ_;
      }
      catch(exn$1){
       var
        exn = caml_wrap_exception(exn$1),
        raw_backtrace$0 = caml_get_exception_raw_backtrace(0),
        _e1_ = to_string(exn$0);
       caml_call1(eprintf(_bS_), _e1_);
       print_raw_backtrace(stderr, raw_backtrace);
       var _e2_ = to_string(exn);
       caml_call1(eprintf(_bT_), _e2_);
       print_raw_backtrace(stderr, raw_backtrace$0);
       var _e3_ = caml_ml_flush(stderr);
      }
      var _e4_ = _e3_;
     }
     catch(_e6_){
      var _e0_ = caml_wrap_exception(_e6_);
      if(_e0_ !== Out_of_memory) throw caml_maybe_attach_backtrace(_e0_, 0);
      var _e4_ = prerr_endline(_bR_);
     }
     return _e4_;
    }
    catch(_e5_){return 0;}
   ...
   function mk(i1, i2, i3$0, i4$0){
    ...
    var i3 = caml_notequal(i3$0, _bV_) ? i3$0 : _bY_;
    caml_ba_set_1(s, 2, i3);
    var i4 = caml_notequal(i4$0, _bW_) ? i4$0 : _bX_;
   ...
   function public_method_label(s){
    var accu = [0, 0], _eU_ = caml_ml_string_length(s) - 1 | 0, _eT_ = 0;
    if(_eU_ >= 0){
     var i = _eT_;
     for(;;){
      var _eV_ = caml_string_get(s, i);
      accu[1] = (223 * accu[1] | 0) + _eV_ | 0;
      var _eW_ = i + 1 | 0;
   ...
   function new_table(pub_labels){
    ...
    var _eN_ = ((fit_size(len) * 32 | 0) / 8 | 0) - 1 | 0;
    caml_check_bound(methods, 1)[2] = _eN_;
    var _eP_ = len - 1 | 0, _eO_ = 0;
    if(_eP_ >= 0){
     var i = _eO_;
     for(;;){
      var
       _eR_ = (i * 2 | 0) + 3 | 0,
       _eQ_ = caml_check_bound(pub_labels, i)[1 + i];
      caml_check_bound(methods, _eR_)[1 + _eR_] = _eQ_;
      var _eS_ = i + 1 | 0;
      if(_eP_ !== i){var i = _eS_; continue;}
      break;
     }
    }
    return [0,
   ...
   function resize$0(array, new_size){
    var old_size = array[2].length - 1, _eL_ = old_size < new_size ? 1 : 0;
    if(_eL_){
   ...
   function new_cache(table){
    ...
    if
     (0 !== (n % 2 | 0)
      && (2 + ((caml_check_bound(table[2], 1)[2] * 16 | 0) / 32 | 0) | 0) >= n){var n$0 = new_method(table); switch$0 = 1;}
    if(! switch$0) var n$0 = n;
    caml_check_bound(table[2], n$0)[1 + n$0] = 0;
    return n$0;
   }
   var
    Error = [248, _cg_, caml_fresh_oo_id(0)],
    exn = [0, Error, [0]],
    ...
    if(t28.addEventListener === undefined$0){
     var
      ...
      callback =
        function(e){
         var _eI_ = [0, h, e, [0]];
         return function(_eJ_, _eK_){return caml_js_call(_eI_, _eJ_, _eK_);};
        };
   ...
   function createDiv(doc){return unsafeCreateElement(doc, _ch_);}
   var Canvas_not_available = [248, _cj_, caml_fresh_oo_id(0)];
   function createCanvas(doc){
    var t52 = unsafeCreateElement(doc, _ck_);
   ...
   new regExp("[$]", cst_g);
   var quote_re = regexp(_cl_), Local_exn = [248, _cm_, caml_fresh_oo_id(0)];
   ...
   var x$10 = global.location;
   if(x$10 !== undefined$0)
    var t43 = global.location;
   else
    var
     t42 = function(param, _eH_){return 0;},
     t41 = function(param, _eG_){return 0;},
   ...
   try{caml_int_of_string(caml_string_of_jsbytes(t43.port));}
    ...
    var _co_ = caml_wrap_exception(_eF_);
    if(_co_[1] !== Failure) throw caml_maybe_attach_backtrace(_co_, 0);
   }
   var
   ...
   function aux(ofs){
    try{
     var lim = caml_ml_string_length(path_string), switch$0 = 0, c = 47;
     if(0 <= ofs && lim >= ofs){
      var i = ofs;
      for(;;){
       if(lim <= i) throw caml_maybe_attach_backtrace(Not_found, 1);
       if(caml_string_unsafe_get(path_string, i) !== c){var i$0 = i + 1 | 0, i = i$0; continue;}
       var _eD_ = i;
       switch$0 = 1;
       break;
      }
     }
     if(! switch$0) var _eD_ = invalid_arg(_m_);
     var j = _eD_;
    }
    catch(_eE_){
     var _eC_ = caml_wrap_exception(_eE_);
     if(_eC_ !== Not_found) throw caml_maybe_attach_backtrace(_eC_, 0);
     var j = l$0;
    }
    var
     len = j - ofs | 0,
   ...
   if(a$0 && ! caml_string_notequal(a$0[1], cst$2)){
    var _cn_ = a$0[2];
    if(! _cn_ || ! caml_string_notequal(_cn_[1], cst$2) && ! _cn_[2])
     switch$0 = 1;
   }
   var
         ...
         function(s){
          function _eA_(param){
           var
            y = param[2],
            x = param[1],
            _eB_ = urldecode_js_string_string(y);
           return [0, urldecode_js_string_string(x), _eB_];
          }
          var index = s.indexOf(caml_jsstring_of_string(make$0(1, 61)));
          if(0 <= index)
           var
            _ey_ = s.slice(index + 1 | 0),
            _ez_ = [0, s.slice(0, index), _ey_];
          else
           var _ez_ = undefined$0;
          return case$1(_ez_, interrupt, _eA_);
         },
       _ew_ = aux$0([0, case$1(arr[idx$0], interrupt, _ev_), acc], _eu_);
      return _ew_;
     }
     catch(_ex_){
      var _et_ = caml_wrap_exception(_ex_);
      if(_et_ !== Local_exn) throw caml_maybe_attach_backtrace(_et_, 0);
   ...
   symbol(s$1, symbol(_dc_, git_version));
   ...
   function handle_with_async_exception_ho(f, v){
    try{var _es_ = caml_call1(f, v); return _es_;}
    catch(exn$0){
     var exn = caml_wrap_exception(exn$0);
     return caml_call1(async_exception_hook[1], exn);
    }
   }
   var Canceled = [248, _cq_, caml_fresh_oo_id(0)];
   function run_callbacks(callbacks, result){
    if(1 === result[0])
     var _er_ = result[1] === Canceled ? 1 : 0, is_canceled = _er_;
    else
     var is_canceled = 0;
    if(is_canceled){
     var
    ...
    if(1 === current_callback_nesting_depth[1])
     for(;;){
      if(0 !== deferred_callbacks[1]){
       ...
       if(! _eq_) throw caml_maybe_attach_backtrace(Empty, 1);
       var content = _eq_[1];
       if(_eq_[2]){
        var next = _eq_[2];
   ...
   function wakeup_general(api_function_name, r, result){
    var p = underlying(r), _ep_ = p[1];
    switch(_ep_[0]){
      case 1:
       return _ep_[1] === Canceled
               ? 0
               : caml_call1(ksprintf(invalid_arg, _cs_), api_function_name);
      case 2:
       if(0 === result[0])
        var x = result[1], result$0 = [0, x];
       else
        var exn = result[1], result$0 = [1, exn];
       resolve(_ct_, 0, p, result$0);
       return 0;
      default:
       return caml_call1(ksprintf(invalid_arg, _cr_), api_function_name);
    }
   }
   function wakeup(r, v){return wakeup_general(_cu_, r, [0, v]);}
    ...
    function create_result_promise_and_call(param){
     ...
     function callback(p_result){
      if(1 === p_result[0]){
       ...
       resolve(_cy_, 0, p$1, p_result);
       return 0;
      }
      var v = p_result[1];
      current_storage[1] = saved_storage;
      try{var _eo_ = caml_call1(f, v), user_provided_promise = _eo_;}
      catch(exn$0){
       var exn = caml_wrap_exception(exn$0);
      ...
      if(p$0 !== outer_promise){
       ...
       switch(match[0]){
         case 1:
          resolve(_cx_, 0, outer_promise, p$0[1]); break;
         case 2:
          var
           p_callbacks = match[1],
          ...
          break;
         default: resolve(_cw_, 0, outer_promise, p$0[1]);
       }
      }
      return 0;
     }
    ...
    switch(result[0]){
      ...
      default:
       ...
       return run_callback_or_defer_it
               (_cz_, function(param){return caml_call1(f, v);}, _en_);
    }
   }
   ...
   var
    pause_hook = [0, function(_el_){return 0;}],
    paused = create(0),
    _cC_ = [0, 0];
   function wakeup_paused(param){
    if(paused[2] === paused){_cC_[1] = 0; return 0;}
    var tmp = create(0);
    tmp[1][2] = paused[2];
    paused[2][1] = tmp[1];
    tmp[1] = paused[1];
   ...
   function put_pixmap(param, x, y, xsrc, ysrc, width, height, _ej_){
   ...
   function get_pixmap(pm){
    var match = pm[1];
    if(! match)
     throw caml_maybe_attach_backtrace([0, Assert_failure, _cG_], 1);
    var p = match[1];
    return p;
   }
   ...
   function _cH_(st, scale, x$2, y$2, x$1, y$1, w, h){
    var ctx = get_pixmap(st[8])[2];
    ctx.save();
    var
     _ee_ = 0 === st[1].length - 1 ? 1 : 0,
     _ef_ = _ee_ ? 0 < st[2].length - 1 ? 1 : 0 : _ee_;
    if(_ef_) throw caml_maybe_attach_backtrace([0, Assert_failure, _cN_], 1);
    ctx.beginPath();
    ...
    if(_eh_ >= 0){
     ...
     for(;;){
      var
       ...
       _ea_ = x1$0 <= x4 ? 1 : 0;
      if(_ea_){
       var _eb_ = y1$0 <= y4 ? 1 : 0;
       if(_eb_)
        var
         _ec_ = x3$0 <= x2$0 ? 1 : 0,
         _ed_ = _ec_ ? y3$0 <= y2$0 ? 1 : 0 : _ec_;
       else
        var _ed_ = _eb_;
      }
      else
      ...
      var _ei_ = i$0 + 1 | 0;
      if(_eh_ !== i$0){var i$0 = _ei_; continue;}
      break;
     }
    }
    return ctx.restore();
   ...
   function redraw(st, scale, x0, y0, window, a, x, y, width$0, height$0){
    ...
    if(switch$0)
     ...
     var switch$2 = 0;
     if(0 < dy && (pm[4][4] + dy | 0) < a[4]) switch$1 = 1; else switch$2 = 1;
     if(switch$2){
      var
       r$1 = pm[4],
       _dY_ = 0 === r$1[3] ? 1 : 0,
       _dZ_ = _dY_ || (0 === r$1[4] ? 1 : 0);
      if(1 - _dZ_){
       var
        p = get_pixmap(pm),
        r$2 = pm[4],
        _d7_ = 0 !== dx ? 1 : 0,
        _d8_ = _d7_ || (0 !== dy ? 1 : 0);
       if(_d8_) put_pixmap(p, dx, dy, 0, 0, r$2[3], r$2[4], p);
       var
        offset =
          function(p, l, d, m){
           return 0 < ((p + d | 0) + l | 0)
       ...
       if(0 < height$2)
        if(0 < x$0){
         ...
         _cH_(st, scale, x0$2, y0$2, 0, y$0, x$0, height$2);
        }
        else{
         if(0 !== x$0)
         ...
         if(width$2 < a[3])
          _cH_
           (st, scale, x0$2, y0$2, width$2, y$0, a[3] - width$2 | 0, height$2);
        }
       if(0 < y$0){
        if(a[4] > (y$0 + height$2 | 0))
         throw caml_maybe_attach_backtrace([0, Assert_failure, _cJ_], 1);
        _cH_(st, scale, x0$2, y0$2, 0, 0, a[3], y$0);
       }
       else{
        if(0 !== y$0)
         throw caml_maybe_attach_backtrace([0, Assert_failure, _cK_], 1);
        if(height$2 < a[4])
         _cH_(st, scale, x0$2, y0$2, 0, height$2, a[3], a[4] - height$2 | 0);
       }
    ...
    if(_d2_)
     ...
     if(_d5_)
      ...
      var
       _d6_ = r$0[3] < (x + width$0 | 0) ? 1 : 0,
       _d3_ = _d6_ || (r$0[4] < (y + height$0 | 0) ? 1 : 0);
    }
    if(_d3_){
     _cH_(st, scale, x0$2, y0$2, 0, 0, a[3], a[4]);
     pm[4] = [0, x0$2, y0$2, a[3], a[4]];
    }
    var _d4_ = get_pixmap(pm);
    return put_pixmap
            (get_drawable(window), x, y, x, y, width$0, height$0, _d4_);
   }
   var json = JSON;
   if(0 === public_methods)
   ...
   if(_b8_ >= 0){
    var i$1 = _b7_;
    for(;;){
     var name$0 = caml_check_bound(meths, i$1)[1 + i$1];
     try{var _b4_ = Meths[28].call(null, name$0, table$0[3]), _cc_ = _b4_;}
     catch(_dX_){
      var _b3_ = caml_wrap_exception(_dX_);
      if(_b3_ !== Not_found) throw caml_maybe_attach_backtrace(_b3_, 0);
      var label = new_method(table$0);
      table$0[3] = Meths[4].call(null, name$0, label, table$0[3]);
      table$0[4] = Labs[4].call(null, label, 1, table$0[4]);
      var _cc_ = label;
     }
     caml_check_bound(res, i$1)[1 + i$1] = _cc_;
     var _cd_ = i$1 + 1 | 0;
     if(_b8_ !== i$1){var i$1 = _cd_; continue;}
     break;
    }
   }
   var _b__ = nvals - 1 | 0, _b9_ = 0;
   if(_b__ >= 0){
    var i$0 = _b9_;
    for(;;){
     var name = caml_check_bound(vals, i$0)[1 + i$0];
     try{var _b6_ = Vars[28].call(null, name, table$0[7]), _b$_ = _b6_;}
     catch(_dW_){
      var _b5_ = caml_wrap_exception(_dW_);
      if(_b5_ !== Not_found) throw caml_maybe_attach_backtrace(_b5_, 0);
      var index = table$0[1];
      table$0[1] = index + 1 | 0;
      if(caml_string_notequal(name, cst$2))
       table$0[7] = Vars[4].call(null, name, index, table$0[7]);
      var _b$_ = index;
     }
     var _ca_ = i$0 + nmeths | 0;
     caml_check_bound(res, _ca_)[1 + _ca_] = _b$_;
     var _cb_ = i$0 + 1 | 0;
     if(_b__ !== i$0){var i$0 = _cb_; continue;}
     break;
    }
   }
   var
    ...
    _cU_ = res[7],
    _cV_ = res[8];
   function _c2_(self_1, lower, upper, step_incr, page_incr, page_size, param){
    if(lower){var v = lower[1]; self_1[1 + _cX_] = v;}
    if(upper){var v$0 = upper[1]; self_1[1 + _cY_] = v$0;}
    if(step_incr){var v$1 = step_incr[1]; self_1[1 + _cZ_] = v$1;}
    if(page_incr){var v$2 = page_incr[1]; self_1[1 + _c0_] = v$2;}
    if(! page_size) return 0;
    var v$3 = page_size[1];
    self_1[1 + _c1_] = v$3;
    return 0;
   }
   function _c3_(self_1, v){self_1[1 + _cW_] = v; return 0;}
   function _c4_(self_1){return self_1[1 + _c1_];}
   function _c5_(self_1){return self_1[1 + _c0_];}
   function _c6_(self_1){return self_1[1 + _cZ_];}
   function _c7_(self_1){return self_1[1 + _cY_];}
   function _c8_(self_1){return self_1[1 + _cX_];}
   var
    methods =
      [0,
       _cO_,
       function(self_1){return self_1[1 + _cW_];},
       _cV_,
       _c8_,
       _cP_,
       _c7_,
   ...
   for(;;){
    if(i$2[1] < len){
     var
      _cf_ = i$2[1],
      label$0 = caml_check_bound(methods, _cf_)[1 + _cf_],
      next =
        function(param){
         i$2[1]++;
         var _dV_ = i$2[1];
         return caml_check_bound(methods, _dV_)[1 + _dV_];
        },
      clo = next(0);
     if(typeof clo === "number")
      switch(clo){
        case 0:
         var
          x = next(0),
          element = function(x){return function(obj){return x;};}(x);
         break;
        case 1:
         var
          n = next(0),
          element = function(n){return function(obj){return obj[1 + n];};}(n);
         break;
        case 2:
         var
          e = next(0),
        ...
        case 19:
         var
          ...
          element =
            function(n, m){
              return function(obj){
               var _dT_ = caml_call1(obj[1][1 + m], obj);
               return caml_call2(obj[1][1 + n], obj, _dT_);};
             }
             (n$15, m$1);
         break;
        case 20:
        ...
        case 22:
         ...
         var
          element =
            function(m, e, n){
              return function(obj){
               var _dR_ = obj[1 + e][1 + n];
               return caml_call1(caml_get_public_method(_dR_, m, 0), _dR_);};
             }
             (m$4, e$4, n$17);
         break;
        default:
         ...
         var
          element =
            function(m, n){
              return function(obj){
               var _dU_ = caml_call1(obj[1][1 + n], obj);
               return caml_call1(caml_get_public_method(_dU_, m, 0), _dU_);};
             }
             (m$5, n$18);
      }
     else
      var element = clo;
     method_count[1]++;
     if(Labs[28].call(null, label$0, table$0[4])){
      resize$0(table$0, label$0 + 1 | 0);
      caml_check_bound(table$0[2], label$0)[1 + label$0] = element;
     }
     else
      table$0[6] = [0, [0, label$0, element], table$0[6]];
     i$2[1]++;
     continue;
    }
    inst_var_count[1] = (inst_var_count[1] + table$0[1] | 0) - 1 | 0;
    var l1$1 = table$0[8], l1 = l1$1, l2 = 0;
    for(;;){
     if(l1){
     ...
     var
           ...
           return function(opt){
            ...
            return function(opt){
             ...
             return function(opt){
              ...
              return function(_dP_){
               if(obj_0)
                var _dQ_ = obj_0;
               else{
                var obj = caml_obj_block(248, table$0[1]);
                obj[1] = table$0[2];
                var _dQ_ = caml_set_oo_id(obj);
               }
               _dQ_[1 + _cW_] = sth$0;
               _dQ_[1 + _cX_] = sth$1;
               _dQ_[1 + _cY_] = sth$2;
      ...
      handle_drag =
        function(element, f){
         ...
         return element.onmousedown = t94;
        },
      t185 =
        handler
         (function(param$0){
           ...
           t107.margin = cst_0px;
           var started = [0, 0], t109 = unsafeCreateElement(document, _ci_);
           ...
           var match$0 = task(0), w$0 = match$0[2], t = match$0[1], d = 500.;
           function callback(_dO_){return wakeup(w$0, _dO_);}
           var id = [0, 0];
           function loop(d, param){
            ...
            var
             cb =
               remain == 0.
                ? callback
                : function(_dN_){return loop(remain, _dN_);};
           ...
           function _dh_(s){
            var
             _dr_ = json.parse(caml_jsstring_of_string(s)),
             scene = _dr_[3],
             bboxes = _dr_[2],
             match = _dr_[1],
             y2 = match[4],
            ...
            function allocation(param){
             return [0, 0, 0, canvas.width, canvas.height];
            }
            var
             hadj = caml_call5(_ce_(0, 0)(0), 0, 0, 0, 0, 0),
             vadj = caml_call5(_ce_(0, 0)(0), 0, 0, 0, 0, 0),
             sadj = caml_call5(_ce_(0, 0)(0), _da_, _c$_, _c__, _c9_, 0);
            function get_scale(param){
             var _dM_ = st[3];
             return Math.pow
                     (2.,
                      caml_call1
                       (caml_get_public_method(sadj, 834174833, 370), sadj)
                      / 8.)
                    / _dM_;
            }
                    ...
                    (caml_js_wrap_callback
                      (function(param){
                        ...
                        var
                         v =
                           caml_call1
                            (caml_get_public_method(vadj, 834174833, 384), vadj),
                         h =
                           caml_call1
                            (caml_get_public_method(hadj, 834174833, 385), hadj),
                         s = get_scale(0),
                         width = canvas.width,
            ...
            var
             ...
             count =
               Math.ceil(Math.log(zoom_factor) / 0.6931471805599453 * 8.),
            ...
            function points(d){
             return caml_jsstring_of_string(caml_call1(sprintf(_db_), d));
            }
            var
             size_px = points(size),
             pos = [0, height],
             thumb = createDiv(document),
             style = thumb.style;
            ...
            var slider = createDiv(document), style$0 = slider.style;
             ...
             t162 =
               handler
                (function(t161){
                  var
                   ey = t161.clientY,
                   sy = elementClientPosition(slider)[2];
                  set_slider_position
             ...
             (canvas,
              function(dx, dy){
               ...
               function offset(a, d){
                var
                 _dB_ =
                   caml_call1(caml_get_public_method(a, 307110897, 425), a),
                 _dC_ =
            ...
            function bump_scale(x, y, v){
             var
              ...
              _dz_ =
                 ...
                 *
                  caml_call1
                   (caml_get_public_method(sadj, -292814788, 430), sadj),
              _dA_ =
                max
                 (caml_call1
              ...
              vl =
                min
                 (caml_call1
                   (caml_get_public_method(sadj, 675223906, 432), sadj),
                  _dA_);
             if(vl != prev){
              caml_call2
              ...
              var
               _dy_ =
                 caml_call1
                  (caml_get_public_method(sadj, 675223906, 415), sadj),
               pos$0 =
                 284
                 -
                  (caml_call1
                   (caml_get_public_method(sadj, 834174833, 416), sadj)
                  * 284
                  / _dy_
                  + 0.5
                  | 0)
              ...
              pos[1] = pos$0;
              var switch$0 = 0;
              if(0. <= x$0 && x$0 <= 1. && 0. <= y$0 && y$0 <= 1.){rescale(x$0, y$0); switch$0 = 1;}
              if(! switch$0) rescale(0.5, 0.5);
             }
             return false$0;
            }
            var capture = [0, true$0], passive = 0, once = 0;
             ...
             (canvas,
              ...
              handler
               (function(t176){
                 ...
                 get(t176.wheelDeltaX, _dw_);
                 function _dx_(param){return t176.wheelDelta;}
                 var
                  dy = (- get(t176.wheelDeltaY, _dx_) | 0) / 40 | 0,
             ...
             switch(switcher){
               case 0:
                var
                 _ds_ =
                   caml_call1
                    (caml_get_public_method(hadj, -292814788, 437), hadj);
                caml_call2
                 (caml_get_public_method(hadj, -659372076, 439),
                  hadj,
                  caml_call1
                   (caml_get_public_method(hadj, 834174833, 438), hadj)
                  - _ds_);
                update_view(0);
                return false$0;
               case 1:
                var
                 _dt_ =
                   caml_call1
                    (caml_get_public_method(vadj, -292814788, 440), vadj);
                caml_call2
                 (caml_get_public_method(vadj, -659372076, 442),
                  vadj,
                  caml_call1
                   (caml_get_public_method(vadj, 834174833, 441), vadj)
                  - _dt_);
                update_view(0);
                return false$0;
               case 2:
                var
                 _du_ =
                   caml_call1
                    (caml_get_public_method(hadj, -292814788, 443), hadj);
                caml_call2
                 (caml_get_public_method(hadj, -659372076, 445),
                  hadj,
                  caml_call1
                   (caml_get_public_method(hadj, 834174833, 444), hadj)
                  + _du_);
                update_view(0);
                return false$0;
               default:
                var
                 _dv_ =
                   caml_call1
                    (caml_get_public_method(vadj, -292814788, 446), vadj);
                caml_call2
                 (caml_get_public_method(vadj, -659372076, 448),
                  vadj,
                  caml_call1
                   (caml_get_public_method(vadj, 834174833, 447), vadj)
                  + _dv_);
                update_view(0);
                return false$0;
             }
           ...
           try{
            var
             _df_ = return$0(caml_read_file_content(cst_scene_json)),
             _di_ = _df_;
           }
           catch(_dj_){
            var _de_ = caml_wrap_exception(_dj_);
            if(_de_ !== Not_found) throw caml_maybe_attach_backtrace(_de_, 0);
            var
             _dd_ =
               function(param){
            ...
            req.open("GET", cst_scene_json, true$0);
            req.responseType = cst$2;
            var content_type = 0, headers$0 = 0, param = headers$0;
            for(;;){
             if(param){
             ...
             var
              headers =
                function(s){
                 function _dp_(v){return [0, caml_string_of_jsstring(v)];}
                 function _dq_(param){return 0;}
                 return case$0
                      ...
                      var
                       ...
                       _dk_ =
                         function(param){
                          ...
                          function _do_(x){return [0, x];}
                          var match = case$0(x, function(param){return 0;}, _do_);
                          if(! match) return 0;
                          var doc = match[1];
                          return doc.documentElement === no_handler ? 0 : [0, doc];
                         },
                       _dl_ = caml_string_of_jsstring,
                       _dm_ = function(param){return _cE_;},
                       response =
                         [0,
                          url,
                          code,
                          headers,
                          case$0(req.responseText, _dm_, _dl_),
                          _dk_];
             ...
             var _di_ = symbol_bind(res, _dd_);
             break;
            }
           }
           symbol_bind(_di_, _dh_);
           return false$0;
          });
     global.onload = t185;
     do_at_exit(0);
