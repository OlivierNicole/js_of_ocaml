...
(function(globalThis){
   ...
   var
    ...
    cst_examples_wysiwyg_main_ml = "examples/wysiwyg/main.ml",
    cst_false = "false",
    cst_formatblock = "formatblock",
    cst_h1 = "h1",
    cst_h2 = "h2",
    cst_h3 = "h3",
    cst_input = "input",
    cst_inserthtml = "inserthtml",
    cst_p = "p",
    cst_true = "true";
   ...
   var
    ...
    _b1_ = [0, 0],
    _bX_ = cst_Fatal_error_exception,
    _bY_ = "Lwt.Resolution_loop.Canceled",
    _b9_ = "Exception during Lwt.async: ",
    _cs_ = "^error_in_anchor^",
    _cj_ = [0, cst_examples_wysiwyg_main_ml, 85, 77],
    _cl_ = [0, cst$4, 0],
    _cm_ = cst$5,
    _cn_ = cst$1,
    _co_ = [0, cst$4, 0],
    ...
    _cq_ = cst$5,
    _cr_ = cst$1,
    _ck_ = "^error2_in_anchor^",
    _ci_ = [0, cst_examples_wysiwyg_main_ml, 79, 44],
    _cg_ = cst$0,
    _ch_ = [0, "**"],
    _cc_ = cst$6,
    _cd_ = [0, "//"],
    ...
    _cP_ = "Enter a link",
    _cQ_ = "desc",
    _cR_ = "Enter description",
    _cS_ = [0, cst_a, 0],
    _cT_ = '" wysitype="global">',
    _cU_ = cst_a_href,
    _cV_ = cst$1,
    _cu_ = "inserthorizontalrule",
    _cv_ = "hr",
    _cw_ = "removeformat",
    _cx_ = "remove format",
    _cy_ = "bold",
    ...
    _cA_ = "italic",
    _cB_ = cst_I,
    _cC_ = cst_formatblock,
    _cD_ = cst_p,
    _cE_ = [0, [0, cst_p]],
    _cF_ = cst_formatblock,
    _cG_ = cst_h1,
    _cH_ = [0, [0, cst_h1]],
    _cI_ = cst_formatblock,
    _cJ_ = cst_h2,
    _cK_ = [0, [0, cst_h2]],
    _cL_ = cst_formatblock,
    _cM_ = cst_h3,
    _cN_ = [0, [0, cst_h3]],
    _cW_ = cst_inserthtml,
    _cX_ = "link",
    ...
    _c5_ = "link2wiki",
    _c6_ = cst$1,
    _ct_ = [0, cst_examples_wysiwyg_main_ml, 108, 70],
    _b__ = "Dune__exe__Main.Break";
   ...
   function flush_all(param){
    ...
    for(;;){
     ...
     try{caml_ml_flush(a);}
      ...
      var _fg_ = caml_wrap_exception(_fh_);
      if(_fg_[1] !== Sys_error) throw caml_maybe_attach_backtrace(_fg_, 0);
     }
     var param$0 = l;
    }
   }
   ...
   function sub_string(b, ofs, len){
    ...
    if(! switch$0) var _ff_ = invalid_arg(_j_);
    return caml_string_of_bytes(_ff_);
   }
   ...
   function concat(sep, l){
    ...
    for(;;){
     if(param){
      ...
      var _fe_ = caml_ml_string_length(hd) + acc | 0;
     }
     else
      var _fe_ = acc;
     var dst = caml_create_bytes(_fe_), pos = pos$1, param$0 = l;
     for(;;){
      if(param$0){
       var hd$0 = param$0[1];
       if(param$0[2]){
   ...
   var at_exit_key = new_key(0, function(param, _fd_){return 0;});
     ...
     switch(param[0]){
       ...
       case 8:
        var
         ...
         af$7 = match$7[2],
         fa$7 = match$7[1],
         _e0_ = function(param){af$7(0); return 0;};
        return [0, function(param){fa$7(0); return 0;}, _e0_, ed$7, de$7];
       case 9:
        var
         rest$8 = param[3],
         ty2 = param[2],
         ...
         ga = match$9[2],
         ag = match$9[1],
         _e1_ = function(param){jd(0); de$8(0); return 0;},
         _e2_ = function(param){ed$8(0); dj(0); return 0;},
         _e3_ = function(param){ga(0); af$8(0); return 0;};
        return [0,
       ...
       case 10:
        var
         ...
         af$9 = match$10[2],
         fa$9 = match$10[1],
         _e4_ = function(param){af$9(0); return 0;};
        return [0, function(param){fa$9(0); return 0;}, _e4_, ed$9, de$9];
       case 11:
        var
         rest$10 = param[1],
         ...
         af$10 = match$11[2],
         fa$10 = match$11[1],
         _e5_ = function(param){af$10(0); return 0;};
        return [0, function(param){fa$10(0); return 0;}, _e5_, ed$10, de$10];
       case 12:
        var
         rest$11 = param[1],
         ...
         af$11 = match$12[2],
         fa$11 = match$12[1],
         _e6_ = function(param){af$11(0); return 0;};
        return [0, function(param){fa$11(0); return 0;}, _e6_, ed$11, de$11];
       case 13:
        var
         rest$12 = param[1],
         ...
         af$12 = match$13[2],
         fa$12 = match$13[1],
         _e7_ = function(param){de$12(0); return 0;},
         _e8_ = function(param){ed$12(0); return 0;},
         _e9_ = function(param){af$12(0); return 0;};
        return [0, function(param){fa$12(0); return 0;}, _e9_, _e8_, _e7_];
       default:
        var
         rest$13 = param[1],
         ...
         af$13 = match$14[2],
         fa$13 = match$14[1],
         _e__ = function(param){de$13(0); return 0;},
         _e$_ = function(param){ed$13(0); return 0;},
         _fa_ = function(param){af$13(0); return 0;};
        return [0, function(param){fa$13(0); return 0;}, _fa_, _e$_, _e__];
     }
   ...
   function transform_int_alt(iconv, s){
    ...
    var n = [0, 0], _ev_ = caml_ml_string_length(s) - 1 | 0, _eu_ = 0;
    if(_ev_ >= 0){
     var i$0 = _eu_;
     for(;;){
      if(9 >= caml_string_unsafe_get(s, i$0) - 48 >>> 0) n[1]++;
      var _ez_ = i$0 + 1 | 0;
      if(_ev_ !== i$0){var i$0 = _ez_; continue;}
      break;
     }
    }
    var
    ...
    var
     ...
     _ex_ = caml_ml_string_length(s) - 1 | 0,
     _ew_ = 0;
    if(_ex_ >= 0){
     var i = _ew_;
     for(;;){
   ...
   function convert_int64(iconv, n){
    switch(iconv){
      ...
      case 14:
       var _eq_ = _av_; break;
      default: var _eq_ = _aE_;
    }
    return transform_int_alt(iconv, caml_int64_format(_eq_, n));
   }
      ...
      case 5:
       ...
       for(;;){
        if(i$0 === len)
         ...
         var _en_ = caml_string_get(str, i$0) - 46 | 0, switch$0 = 0;
         if(23 < _en_ >>> 0){
          if(55 === _en_) switch$0 = 1;
         }
         else if(21 < _en_ - 1 >>> 0) switch$0 = 1;
         if(! switch$0){var i$1 = i$0 + 1 | 0, i$0 = i$1; continue;}
         var _eo_ = 1;
        }
        var _ep_ = _eo_ ? str : symbol(str, _a5_);
        return caml_special_val(_ep_);
       }
      case 6:
       return hex(0);
      case 7:
    ...
    for(;;){
     ...
     switch(fmt$0[0]){
       ...
       case 14:
        ...
        return function(param){
         var
          ...
          _eh_ = type_format_gen(fmt$0, fmtty$0);
         if(typeof _eh_[2] !== "number")
          throw caml_maybe_attach_backtrace(Type_mismatch, 1);
         var fmt = _eh_[1];
       ...
       default:
        ...
        if(counter >= 50)
         return caml_trampoline_return
                 (make_custom$0, [0, k$0, acc$0, rest$23, arity, _eg_]);
        var counter$0 = counter + 1 | 0;
        return make_custom$0(counter$0, k$0, acc$0, rest$23, arity, _eg_);
     }
    }
   }
   ...
   function make_invalid_arg(counter, k, acc, fmt){
    var _ed_ = [8, acc, _bc_];
    if(counter >= 50)
     return caml_trampoline_return(make_printf$0, [0, k, _ed_, fmt]);
    var counter$0 = counter + 1 | 0;
    return make_printf$0(counter$0, k, _ed_, fmt);
   }
   function make_custom$0(counter, k, acc, rest, arity, f){
    ...
    var _ec_ = [4, acc, f];
    if(counter >= 50)
     return caml_trampoline_return(make_printf$0, [0, k, _ec_, rest]);
    var counter$0 = counter + 1 | 0;
    return make_printf$0(counter$0, k, _ec_, rest);
   }
   ...
   function fprintf(oc, fmt$0){
    ...
    return make_printf
            (function(acc){output_acc(oc, acc); return 0;}, _eb_, fmt);
   }
   ...
   function other_fields(x, i){
    ...
    var _d$_ = other_fields(x, i + 1 | 0), _ea_ = field(x, i);
    return caml_call2(sprintf(_bl_), _ea_, _d$_);
   }
   function to_string(e){
    ...
    for(;;){
     if(param){
      ...
      try{var val = caml_call1(hd, e);}catch(_d__){switch$0 = 1;}
      var switch$1 = 0;
      if(switch$0 || ! val)
       switch$1 = 1;
      else
     ...
     if(0 === caml_obj_tag(e)){
      ...
      if(2 < match >>> 0)
       var
        _d6_ = other_fields(e, 2),
        _d7_ = field(e, 1),
        _d9_ = caml_call2(sprintf(_bm_), _d7_, _d6_);
      else
       switch(match){
         case 0:
          var _d9_ = _bn_; break;
         case 1:
          var _d9_ = _bo_; break;
         default:
          var _d8_ = field(e, 1), _d9_ = caml_call1(sprintf(_bp_), _d8_);
       }
      var match$0 = [0, constructor, [0, _d9_]];
     }
     else
      var match$0 = [0, e[1], 0];
     ...
     for(;;){
      ...
      if(0 === slot[0])
       var
        ...
        _dW_ = slot[4],
        _dX_ = slot[3],
        _dY_ = slot[6] ? _bz_ : _bB_,
        _dZ_ = slot[2],
        _d0_ = slot[7],
        _d1_ = info(slot[1]),
        match =
          [0,
           caml_call7(sprintf(_bA_), _d1_, _d0_, _dZ_, _dY_, _dX_, _dW_, _dV_)];
      else if(slot[1])
       var match = 0;
      else
       var _d2_ = info(0), match = [0, caml_call1(sprintf(_bC_), _d2_)];
      if(match){var str = match[1]; caml_call1(fprintf(outchan, _bD_), str);}
      var _d5_ = pos + 1 | 0;
      if(_d4_ !== pos){var pos = _d5_; continue;}
      break;
     }
    }
    return 0;
    ...
    try{
     try{
      ...
      try{
       ...
       caml_call1(eprintf(_bH_), _dN_);
       print_raw_backtrace(stderr, raw_backtrace);
       var _dO_ = to_string(exn);
       caml_call1(eprintf(_bI_), _dO_);
   ...
   function iter(x, f){
    var _dI_ = 1 - (x == no_handler ? 1 : 0);
    return _dI_ ? caml_call1(f, x) : _dI_;
   }
   ...
   function unsafeCreateElementEx(type, name, doc, elt){
    for(;;){
     ...
     var _dC_ = createElementSyntax[1];
     if(785140586 === _dC_){
      try{
       var
        t49 = document.createElement('<input name="x">'),
        _dF_ = t49.tagName.toLowerCase() === cst_input ? 1 : 0,
        _dG_ = _dF_ ? t49.name === "x" ? 1 : 0 : _dF_,
        _dD_ = _dG_;
      }
      catch(_dH_){var _dD_ = 0;}
      var _dE_ = _dD_ ? 982028505 : -1003883683;
      createElementSyntax[1] = _dE_;
      continue;
     }
     if(982028505 <= _dC_){
      ...
      opt_iter
       (type,
        function(t){
         a.push(' type="', caml_js_html_escape(t), cst$8);
         return 0;
        });
      opt_iter
       (name,
        function(n){
         a.push(' name="', caml_js_html_escape(n), cst$8);
         return 0;
        });
      a.push(">");
      return doc.createElement(a.join(cst$1));
     }
   ...
   function handle_with_async_exception_ho(f, v){
    try{var _dB_ = caml_call1(f, v); return _dB_;}
    catch(exn$0){
   ...
   function run_callbacks(callbacks, result){
    if(1 === result[0])
     var _dA_ = result[1] === Canceled ? 1 : 0, is_canceled = _dA_;
    else
     var is_canceled = 0;
    if(is_canceled){
     var
    ...
    if(1 === current_callback_nesting_depth[1])
     for(;;){
      if(0 !== deferred_callbacks[1]){
       var _dz_ = deferred_callbacks[2];
       if(! _dz_) throw caml_maybe_attach_backtrace(Empty, 1);
       var content = _dz_[1];
       if(_dz_[2]){
        var next = _dz_[2];
   ...
   function wakeup(r, exn){
    var p = underlying(r), _dy_ = p[1];
    switch(_dy_[0]){
      case 1:
       return _dy_[1] === Canceled
               ? 0
               : caml_call1(ksprintf(invalid_arg, _b0_), api_function_name);
      case 2:
       var result = [0, exn]; resolve(_b1_, 0, p, result); return 0;
      default:
   ...
   var
    pause_hook = [0, function(_dx_){return 0;}],
    paused = create$0(0),
    _b8_ = [0, 0];
   function wakeup_paused(param){
    if(paused[2] === paused){_b8_[1] = 0; return 0;}
    var tmp = create$0(0);
    tmp[1][2] = paused[2];
    paused[2][1] = tmp[1];
    tmp[1] = paused[1];
   ...
   var Break = [248, _b__, caml_fresh_oo_id(0)];
   function html2wiki(body){
    var ans = create(10);
    function add_str(opt, s){
     if(opt) var sth = opt[1], surr = sth; else var surr = _b$_;
       ...
       if(len > i){
        if
         (92 === caml_string_get(s, i)
          && i < (len - 1 | 0) && 92 === caml_string_get(s, i + 1 | 0)){var i$0 = i + 2 | 0, i = i$0; continue;}
        if(10 !== caml_string_get(s, i))
         throw caml_maybe_attach_backtrace([0, Break, 1], 1);
        var i$1 = i + 1 | 0, i = i$1;
        continue;
       }
       var _du_ = 0, _dv_ = _du_;
       break;
      }
     }
     catch(exn$0){
      var exn = caml_wrap_exception(exn$0);
      if(exn[1] !== Break) throw caml_maybe_attach_backtrace(exn, 0);
      var b = exn[2], _dv_ = b;
     }
     return _dv_ ? add_string(ans, symbol(surr, symbol(s, surr))) : 0;
    }
    var
     childNodes = body.childNodes,
     _dk_ = childNodes.length - 1 | 0,
     _dj_ = 0;
    if(_dk_ >= 0){
     var i = _dj_;
     for(;;){
       ...
       _dl_ =
         function(node){
          var
           ...
           switch$0 = caml_string_compare(hh, "H1");
          if(0 <= switch$0){
           var switch$1 = 0;
           if
            (0 < switch$0
             &&
              caml_string_notequal(hh, "H2") && caml_string_notequal(hh, "H3")){
            if(! caml_string_notequal(hh, "HR")) return add_string(ans, _ce_);
            if(! caml_string_notequal(hh, cst_I)){
             var inner$0 = html2wiki(node);
             return add_str(_cd_, inner$0);
            }
            if(! caml_string_notequal(hh, "P")){
             var inner = html2wiki(node);
             return add_str(0, symbol(inner, _cc_));
            }
            switch$1 = 1;
           }
           if(! switch$1){
            ...
            return add_string(ans, symbol(prefix, symbol(inner$1, _cf_)));
           }
          }
          else{
           if(! caml_string_notequal(hh, "#text")){
            var
             x = node.nodeValue,
            ...
            var
             ...
             _do_ =
               function(s){
                ...
                function _dr_(param){
                 throw caml_maybe_attach_backtrace
                        ([0, Assert_failure, _cj_], 1);
                }
                var
                 url = symbol$0(get(el.getAttribute("href"), _dr_), _dq_),
                 match = caml_string_of_jsstring(s);
                if(! caml_string_notequal(match, "global")){
                 var desc = html2wiki(node);
                 return add_string
                         (ans,
                          concat
                           (_cr_, [0, _cq_, [0, url, [0, _cp_, [0, desc, _co_]]]]));
                }
                if(caml_string_notequal(match, "wiki"))
                 return add_string(ans, _ck_);
                function _ds_(_dt_){return add_string(ans, _dt_);}
                return symbol$0(concat(_cn_, [0, _cm_, [0, url, _cl_]]), _ds_);
               },
             _dp_ = function(param){return add_string(ans, _cs_);};
            return case$0(el.getAttribute("wysitype"), _dp_, _do_);
           }
           if(! caml_string_notequal(hh, cst_B)){
            var inner$3 = html2wiki(node);
            return add_str(_ch_, inner$3);
           }
           if(! caml_string_notequal(hh, "BR")) return add_string(ans, _cg_);
           if(! caml_string_notequal(hh, "DIV")){
            var inner$2 = html2wiki(node);
            return add_string(ans, inner$2);
           }
          }
          return add_string(ans, symbol(_cb_, symbol(hh, _ca_)));
         };
   ...
   function onload(param){
    ...
    var
     body = get(document.getElementById("wiki_demo"), _c7_),
     iframe = unsafeCreateElement(document, _bW_),
     t14 = iframe.style;
    ...
    function _c8_(iDoc){
     ...
     appendChild(body, createBr(document));
     function createButton(opt, _dh_, title, action){
      ...
      var
       type = [0, "submit"],
       but = unsafeCreateElementEx(type, 0, document, _bT_),
     ...
     var
      t45 =
        handler
         (function(param){
           var
            link = prompt(_cP_, _cO_),
            desc = prompt(_cR_, _cQ_),
            link$0 =
              concat(_cV_, [0, _cU_, [0, link, [0, _cT_, [0, desc, _cS_]]]]);
           iWin.alert(caml_jsstring_of_string(link$0));
           iDoc.execCommand
            (cst_inserthtml, false$0, caml_jsstring_of_string(link$0));
           return true$0;
          }),
      t46 = createButton(0, 0, _cX_, _cW_);
     t46.onclick = t45;
     var
      t53 =
        handler
         (function(param){
           var
            link = prompt(_cZ_, _cY_),
            link$0 =
              symbol$0
               ([0, _c3_, [0, link, [0, _c2_, [0, link, _c1_]]]],
                function(_de_){return concat(_c0_, _de_);});
           iWin.alert(caml_jsstring_of_string(link$0));
           iDoc.execCommand
            (cst_inserthtml, false$0, caml_jsstring_of_string(link$0));
           return true$0;
          }),
      t54 = createButton(0, 0, _c5_, _c4_);
     t54.onclick = t53;
     appendChild(body, createBr(document));
     var preview = createTextarea(0, 0, document);
     preview.readOnly = true$0;
     preview.cols = 34;
     preview.rows = 10;
     var t63 = preview.style;
     t63.border = "1px black solid";
     var t66 = preview.style;
     t66.padding = cst_5px;
     appendChild(body, preview);
     var wikiFrame = createTextarea(0, 0, document);
     wikiFrame.id = "wikiFrame";
     wikiFrame.readOnly = true$0;
     wikiFrame.cols = 34;
     wikiFrame.rows = 10;
     var t77 = preview.style;
     t77.border = "2px blue solid";
     var t80 = preview.style;
     t80.padding = cst_5px;
     appendChild(body, wikiFrame);
     function dyn_preview(old_text, n){
      var t82 = iDoc.body, text = caml_string_of_jsstring(t82.innerHTML);
      if(caml_string_notequal(text, old_text)){
       try{
        var t83 = caml_jsstring_of_string(text);
        preview.value = t83;
        var t86 = caml_jsstring_of_string(html2wiki(iDoc.body));
        wikiFrame.value = t86;
       }
       catch(_dd_){}
       var n$0 = 20;
      ...
      function create_result_promise_and_call(param){
       ...
       function callback(p_result){
        if(1 === p_result[0]){
         ...
         resolve(_b4_, 0, p$1, p_result);
         return 0;
        }
        var v = p_result[1];
        current_storage[1] = saved_storage;
        try{var _da_ = f$0(v), user_provided_promise = _da_;}
        catch(exn$0){
         var exn = caml_wrap_exception(exn$0);
        ...
        if(p$0 !== outer_promise){
         ...
         switch(match[0]){
           case 1:
            resolve(_b3_, 0, outer_promise, p$0[1]); break;
           case 2:
            var
             p_callbacks = match[1],
            ...
            break;
           default: resolve(_b2_, 0, outer_promise, p$0[1]);
         }
        }
        return 0;
       }
      ...
      switch(result[0]){
        ...
        default:
         ...
         return run_callback_or_defer_it
                 (_b5_, function(param){return f$0(v);}, _c9_);
      }
     }
     dyn_preview(_c6_, 0);
     return 0;
    }
    iter(iframe.contentDocument, _c8_);
    return false$0;
   }
