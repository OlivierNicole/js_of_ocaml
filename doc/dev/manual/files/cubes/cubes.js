...
(function(globalThis){
   ...
   var
    ...
    _M_ = "%r",
    _N_ = "%_r",
    _O_ = [0, cst_camlinternalFormat_ml, 850, 23],
    ___ = [0, cst_camlinternalFormat_ml, 814, 21],
    _R_ = [0, cst_camlinternalFormat_ml, 815, 21],
    _$_ = [0, cst_camlinternalFormat_ml, 818, 21],
    _S_ = [0, cst_camlinternalFormat_ml, 819, 21],
    _aa_ = [0, cst_camlinternalFormat_ml, 822, 19],
    _U_ = [0, cst_camlinternalFormat_ml, 823, 19],
    _ab_ = [0, cst_camlinternalFormat_ml, 826, 22],
    _V_ = [0, cst_camlinternalFormat_ml, 827, 22],
    _ac_ = [0, cst_camlinternalFormat_ml, 831, 30],
    _W_ = [0, cst_camlinternalFormat_ml, 832, 30],
    _Y_ = [0, cst_camlinternalFormat_ml, 836, 26],
    _P_ = [0, cst_camlinternalFormat_ml, 837, 26],
    _Z_ = [0, cst_camlinternalFormat_ml, 846, 28],
    _Q_ = [0, cst_camlinternalFormat_ml, 847, 28],
    _X_ = [0, cst_camlinternalFormat_ml, 851, 23],
    ...
    _v_ = "@%",
    _w_ = "@",
    _ad_ = "CamlinternalFormat.Type_mismatch",
    _bj_ = cst$2,
    ...
    _bB_ = [0, [2, 0, [11, " unknown location", 0]], "%s unknown location"],
    _bp_ = "Out of memory",
    _bq_ = "Stack overflow",
    ...
    _bU_ = caml_int64_create_lo_mi_hi(14371852, 15349651, 22696),
    _bV_ = caml_int64_create_lo_mi_hi(12230193, 11438743, 35013),
    _bW_ = caml_int64_create_lo_mi_hi(1424933, 15549263, 2083),
    _bX_ = caml_int64_create_lo_mi_hi(9492471, 4696708, 43520),
    _bT_ = "Random.int",
    ...
    _bY_ = "Jsoo_runtime.Error.Exn",
    _bZ_ = "Js_of_ocaml__Dom_html.Canvas_not_available",
    _b9_ = [0, 0],
    _b__ = [0, 1],
    _b7_ = [0, 0],
    _b8_ = [0, 1],
    _b5_ = [0, 0],
    _b6_ = [0, 0],
    _b2_ = [0, [11, cst_Lwt, [2, 0, 0]], cst_Lwt_s],
    _b3_ = [0, [11, cst_Lwt, [2, 0, 0]], cst_Lwt_s],
    _b4_ = [0, 0],
    _b0_ = cst_Fatal_error_exception,
    _b1_ = "Lwt.Resolution_loop.Canceled",
    _ca_ = "Exception during Lwt.async: ";
   ...
   function flush_all(param){
    ...
    for(;;){
     ...
     try{caml_ml_flush(a);}
      ...
      var _ee_ = caml_wrap_exception(_ef_);
      if(_ee_[1] !== Sys_error) throw caml_maybe_attach_backtrace(_ee_, 0);
     }
     var param$0 = l;
    }
   }
   ...
   function sub_string(b, ofs, len){
    ...
    if(! switch$0) var _ed_ = invalid_arg(_j_);
    return caml_string_of_bytes(_ed_);
   }
   ...
   function init(l, f){
    if(0 === l) return [0];
    if(0 > l) return invalid_arg(_m_);
    var res = caml_make_vect(l, caml_call1(f, 0)), _eb_ = l - 1 | 0, _ea_ = 1;
    if(_eb_ >= 1){
     var i = _ea_;
     for(;;){
   ...
   var at_exit_key = new_key(0, function(param, _d$_){return 0;});
     ...
     switch(param[0]){
       case 0:
        var
         ...
         af = match[2],
         fa = match[1],
         _dO_ = function(param){af(0); return 0;};
        return [0, function(param){fa(0); return 0;}, _dO_, ed, de];
       case 1:
        var
         rest$0 = param[1],
         ...
         af$0 = match$0[2],
         fa$0 = match$0[1],
         _dP_ = function(param){af$0(0); return 0;};
        return [0, function(param){fa$0(0); return 0;}, _dP_, ed$0, de$0];
       case 2:
        var
         rest$1 = param[1],
         ...
         af$1 = match$1[2],
         fa$1 = match$1[1],
         _dQ_ = function(param){af$1(0); return 0;};
        return [0, function(param){fa$1(0); return 0;}, _dQ_, ed$1, de$1];
       case 3:
        var
         rest$2 = param[1],
         ...
         af$2 = match$2[2],
         fa$2 = match$2[1],
         _dR_ = function(param){af$2(0); return 0;};
        return [0, function(param){fa$2(0); return 0;}, _dR_, ed$2, de$2];
       case 4:
        var
         rest$3 = param[1],
         ...
         af$3 = match$3[2],
         fa$3 = match$3[1],
         _dS_ = function(param){af$3(0); return 0;};
        return [0, function(param){fa$3(0); return 0;}, _dS_, ed$3, de$3];
       case 5:
        var
         rest$4 = param[1],
         ...
         af$4 = match$4[2],
         fa$4 = match$4[1],
         _dT_ = function(param){af$4(0); return 0;};
        return [0, function(param){fa$4(0); return 0;}, _dT_, ed$4, de$4];
       case 6:
        var
         rest$5 = param[1],
         ...
         af$5 = match$5[2],
         fa$5 = match$5[1],
         _dU_ = function(param){af$5(0); return 0;};
        return [0, function(param){fa$5(0); return 0;}, _dU_, ed$5, de$5];
       case 7:
        var
         rest$6 = param[1],
         ...
         af$6 = match$6[2],
         fa$6 = match$6[1],
         _dV_ = function(param){af$6(0); return 0;};
        return [0, function(param){fa$6(0); return 0;}, _dV_, ed$6, de$6];
       case 8:
        var
         rest$7 = param[2],
         ...
         af$7 = match$7[2],
         fa$7 = match$7[1],
         _dW_ = function(param){af$7(0); return 0;};
        return [0, function(param){fa$7(0); return 0;}, _dW_, ed$7, de$7];
       case 9:
        var
         rest$8 = param[3],
         ty2 = param[2],
         ...
         ga = match$9[2],
         ag = match$9[1],
         _dX_ = function(param){jd(0); de$8(0); return 0;},
         _dY_ = function(param){ed$8(0); dj(0); return 0;},
         _dZ_ = function(param){ga(0); af$8(0); return 0;};
        return [0,
       ...
       case 10:
        var
         ...
         af$9 = match$10[2],
         fa$9 = match$10[1],
         _d0_ = function(param){af$9(0); return 0;};
        return [0, function(param){fa$9(0); return 0;}, _d0_, ed$9, de$9];
       case 11:
        var
         rest$10 = param[1],
         ...
         af$10 = match$11[2],
         fa$10 = match$11[1],
         _d1_ = function(param){af$10(0); return 0;};
        return [0, function(param){fa$10(0); return 0;}, _d1_, ed$10, de$10];
       case 12:
        var
         rest$11 = param[1],
         ...
         af$11 = match$12[2],
         fa$11 = match$12[1],
         _d2_ = function(param){af$11(0); return 0;};
        return [0, function(param){fa$11(0); return 0;}, _d2_, ed$11, de$11];
       case 13:
        var
         rest$12 = param[1],
         ...
         af$12 = match$13[2],
         fa$12 = match$13[1],
         _d3_ = function(param){de$12(0); return 0;},
         _d4_ = function(param){ed$12(0); return 0;},
         _d5_ = function(param){af$12(0); return 0;};
        return [0, function(param){fa$12(0); return 0;}, _d5_, _d4_, _d3_];
       default:
        var
         rest$13 = param[1],
         ...
         af$13 = match$14[2],
         fa$13 = match$14[1],
         _d6_ = function(param){de$13(0); return 0;},
         _d7_ = function(param){ed$13(0); return 0;},
         _d8_ = function(param){af$13(0); return 0;};
        return [0, function(param){fa$13(0); return 0;}, _d8_, _d7_, _d6_];
     }
    function _dL_(param){return 0;}
    function _dM_(param){return 0;}
    function _dN_(param){return 0;}
    return [0, function(param){return 0;}, _dN_, _dM_, _dL_];
   }
   function trans(ty1, ty2){
         ...
         switch(ty2[0]){
           case 8:
            var
             rest2$7 = ty2[2],
             ty2$0 = ty2[1],
             _dK_ = trans(rest1$7, rest2$7);
            return [8, trans(ty1$0, ty2$0), _dK_];
           case 10: break;
           case 11:
            switch$0 = 1; break;
           case 12:
    ...
    switch(switch$0){
      ...
      default: throw caml_maybe_attach_backtrace([0, Assert_failure, _X_], 1);
    }
   }
      ...
      case 14:
       if(typeof fmtty0 !== "number" && 9 === fmtty0[0]){
        var
         ...
         sub_fmtty$1 = fmt[2],
         pad_opt$0 = fmt[1],
         _dI_ = [0, erase_rel(sub_fmtty1)];
        if(caml_notequal([0, erase_rel(sub_fmtty$1)], _dI_))
         throw caml_maybe_attach_backtrace(Type_mismatch, 1);
        var
        ...
        switch(ign[0]){
          ...
          case 9:
           var
            sub_fmtty$3 = ign[2],
            pad_opt$2 = ign[1],
            _dJ_ = type_ignored_format_substituti(sub_fmtty$3, rest, fmtty0),
            match$43 = _dJ_[2],
            fmtty$21 = match$43[2],
            fmt$22 = match$43[1],
            sub_fmtty$4 = _dJ_[1];
      ...
      case 9:
       if(typeof fmtty !== "number" && 9 === fmtty[0]){
        var
         ...
         _dG_ = [0, erase_rel(sub1_fmtty)];
        if(caml_notequal([0, erase_rel(sub1_fmtty$0)], _dG_))
         throw caml_maybe_attach_backtrace(Type_mismatch, 1);
        var _dH_ = [0, erase_rel(sub2_fmtty$1)];
        if(caml_notequal([0, erase_rel(sub2_fmtty$2)], _dH_))
         throw caml_maybe_attach_backtrace(Type_mismatch, 1);
        var
   ...
   function fix_padding(padty, width, str){
    ...
    var _dF_ = 2 === padty$0 ? 48 : 32, res = make(width$0, _dF_);
    switch(padty$0){
      case 0:
   ...
   function string_to_caml_string(str$0){
    var
     ...
     n = [0, 0],
     _dx_ = caml_ml_bytes_length(b) - 1 | 0,
     _dw_ = 0;
    if(_dx_ >= 0){
     var i$0 = _dw_;
     for(;;){
      ...
      if(32 <= match){
       var _dB_ = match - 34 | 0, switch$1 = 0;
       if(58 < _dB_ >>> 0){
        if(93 > _dB_) switch$1 = 1;
       }
       else if(56 < _dB_ - 1 >>> 0) switch$0 = 1; else switch$1 = 1;
       if(switch$1){var _dC_ = 1; switch$0 = 2;}
      }
      else
       if(11 <= match){
      ...
      n[1] = n[1] + _dC_ | 0;
      var _dD_ = i$0 + 1 | 0;
      if(_dx_ !== i$0){var i$0 = _dD_; continue;}
      break;
     }
    }
    if(n[1] === caml_ml_bytes_length(b))
     ...
     n[1] = 0;
     var _dz_ = caml_ml_bytes_length(b) - 1 | 0, _dy_ = 0;
     if(_dz_ >= 0){
      var i = _dy_;
      for(;;){
   ...
   function transform_int_alt(iconv, s){
    ...
    var n = [0, 0], _dr_ = caml_ml_string_length(s) - 1 | 0, _dq_ = 0;
    if(_dr_ >= 0){
     var i$0 = _dq_;
     for(;;){
      if(9 >= caml_string_unsafe_get(s, i$0) - 48 >>> 0) n[1]++;
      var _dv_ = i$0 + 1 | 0;
      if(_dr_ !== i$0){var i$0 = _dv_; continue;}
      break;
     }
    }
    var
    ...
    var
     ...
     _dt_ = caml_ml_string_length(s) - 1 | 0,
     _ds_ = 0;
    if(_dt_ >= 0){
     var i = _ds_;
     for(;;){
   ...
   function convert_int(iconv, n){
    switch(iconv){
      ...
      case 14:
       var _dp_ = _ah_; break;
      default: var _dp_ = _aq_;
    }
    return transform_int_alt(iconv, caml_format_int(_dp_, n));
   }
   ...
   function convert_int64(iconv, n){
    switch(iconv){
      ...
      case 14:
       var _dm_ = _au_; break;
      default: var _dm_ = _aD_;
    }
    return transform_int_alt(iconv, caml_int64_format(_dm_, n));
   }
      ...
      case 5:
       ...
       for(;;){
        if(i$0 === len)
         ...
         var _dj_ = caml_string_get(str, i$0) - 46 | 0, switch$0 = 0;
         if(23 < _dj_ >>> 0){
          if(55 === _dj_) switch$0 = 1;
         }
         else if(21 < _dj_ - 1 >>> 0) switch$0 = 1;
         if(! switch$0){var i$1 = i$0 + 1 | 0, i$0 = i$1; continue;}
         var _dk_ = 1;
        }
        var _dl_ = _dk_ ? str : symbol(str, _a4_);
        return caml_special_val(_dl_);
       }
      case 6:
       return hex(0);
      case 7:
       ...
       if(0 === l)
        ...
        var r = caml_create_bytes(l), _df_ = l - 1 | 0, _de_ = 0;
        if(_df_ >= 0){
         var i = _de_;
         for(;;){
          var
           c = caml_bytes_unsafe_get(s, i),
           _dg_ = 25 < c - 97 >>> 0 ? c : c - 32 | 0;
          caml_bytes_unsafe_set(r, i, _dg_);
          var _dh_ = i + 1 | 0;
       ...
       return caml_string_of_bytes(_di_);
      case 8:
    ...
    for(;;){
     ...
     switch(fmt$0[0]){
       ...
       case 14:
        ...
        return function(param){
         var
          ...
          _dd_ = type_format_gen(fmt$0, fmtty$0);
         if(typeof _dd_[2] !== "number")
          throw caml_maybe_attach_backtrace(Type_mismatch, 1);
         var fmt = _dd_[1];
       ...
       default:
        ...
        if(counter >= 50)
         return caml_trampoline_return
                 (make_custom$0, [0, k$0, acc$0, rest$23, arity, _dc_]);
        var counter$0 = counter + 1 | 0;
        return make_custom$0(counter$0, k$0, acc$0, rest$23, arity, _dc_);
     }
    }
   }
   ...
   function make_invalid_arg(counter, k, acc, fmt){
    var _c$_ = [8, acc, _bb_];
    if(counter >= 50)
     return caml_trampoline_return(make_printf$0, [0, k, _c$_, fmt]);
    var counter$0 = counter + 1 | 0;
    return make_printf$0(counter$0, k, _c$_, fmt);
   }
   function make_custom$0(counter, k, acc, rest, arity, f){
    ...
    var _c__ = [4, acc, f];
    if(counter >= 50)
     return caml_trampoline_return(make_printf$0, [0, k, _c__, rest]);
    var counter$0 = counter + 1 | 0;
    return make_printf$0(counter$0, k, _c__, rest);
   }
   ...
   function fprintf(oc, fmt$0){
    var fmt = fmt$0[1], _c9_ = 0;
    return make_printf
            (function(acc){output_acc(oc, acc); return 0;}, _c9_, fmt);
   }
   ...
   function other_fields(x, i){
    ...
    var _c7_ = other_fields(x, i + 1 | 0), _c8_ = field(x, i);
    return caml_call2(sprintf(_bk_), _c8_, _c7_);
   }
   function to_string(e){
    ...
    for(;;){
     if(param){
      ...
      try{var val = caml_call1(hd, e);}catch(_c6_){switch$0 = 1;}
      var switch$1 = 0;
      if(switch$0 || ! val)
       switch$1 = 1;
      else
     ...
     if(0 === caml_obj_tag(e)){
      ...
      if(2 < match >>> 0)
       var
        _c2_ = other_fields(e, 2),
        _c3_ = field(e, 1),
        _c5_ = caml_call2(sprintf(_bl_), _c3_, _c2_);
      else
       switch(match){
         case 0:
          var _c5_ = _bm_; break;
         case 1:
          var _c5_ = _bn_; break;
         default:
          var _c4_ = field(e, 1), _c5_ = caml_call1(sprintf(_bo_), _c4_);
       }
      var match$0 = [0, constructor, [0, _c5_]];
     }
     else
      var match$0 = [0, e[1], 0];
     ...
     for(;;){
       ...
       info$0 =
         function(pos){
          function info(is_raise){
           return is_raise ? 0 === pos ? _bu_ : _bv_ : 0 === pos ? _bw_ : _bx_;
          }
          return info;
         },
       info = info$0(pos);
      if(0 === slot[0])
       var
        ...
        _cS_ = slot[4],
        _cT_ = slot[3],
        _cU_ = slot[6] ? _by_ : _bA_,
        _cV_ = slot[2],
        _cW_ = slot[7],
        _cX_ = info(slot[1]),
        match =
          [0,
           caml_call7(sprintf(_bz_), _cX_, _cW_, _cV_, _cU_, _cT_, _cS_, _cR_)];
      else if(slot[1])
       var match = 0;
      else
       var _cY_ = info(0), match = [0, caml_call1(sprintf(_bB_), _cY_)];
      if(match){var str = match[1]; caml_call1(fprintf(outchan, _bC_), str);}
      var _c1_ = pos + 1 | 0;
      if(_c0_ !== pos){var pos = _c1_; continue;}
      break;
     }
    }
    return 0;
   ...
   var errors = _bD_.slice(), empty_backtrace = [0];
   function handle_uncaught_exception(exn$0, debugger_in_use){
    try{
     try{
      ...
      try{do_at_exit(0);}catch(_cP_){}
      try{
       var _cF_ = to_string(exn$0);
       caml_call1(eprintf(_bE_), _cF_);
       print_raw_backtrace(stderr, raw_backtrace);
       var status = caml_ml_debug_info_status(0);
       if(status < 0){
        var _cG_ = abs(status);
        prerr_endline(caml_check_bound(errors, _cG_)[1 + _cG_]);
       }
       var _cH_ = caml_ml_flush(stderr), _cL_ = _cH_;
      }
      catch(exn$1){
       var
        exn = caml_wrap_exception(exn$1),
        raw_backtrace$0 = caml_get_exception_raw_backtrace(0),
        _cJ_ = to_string(exn$0);
       caml_call1(eprintf(_bG_), _cJ_);
       print_raw_backtrace(stderr, raw_backtrace);
       var _cK_ = to_string(exn);
       caml_call1(eprintf(_bH_), _cK_);
      ...
      var _cI_ = caml_wrap_exception(_cO_);
      if(_cI_ !== Out_of_memory) throw caml_maybe_attach_backtrace(_cI_, 0);
      var _cM_ = prerr_endline(_bF_);
     }
     return _cM_;
    }
    catch(_cN_){return 0;}
   ...
   function mk_default(param){return mk(_bX_, _bW_, _bV_, _bU_);}
   var random_key = new_key([0, split], mk_default);
   ...
   function handle_with_async_exception_ho(f, v){
    try{var _cE_ = caml_call1(f, v); return _cE_;}
    catch(exn$0){
   ...
   function run_callbacks(callbacks, result){
    if(1 === result[0])
     var _cD_ = result[1] === Canceled ? 1 : 0, is_canceled = _cD_;
    else
     var is_canceled = 0;
    if(is_canceled){
     var
    ...
    if(1 === current_callback_nesting_depth[1])
     for(;;){
      if(0 !== deferred_callbacks[1]){
       var _cC_ = deferred_callbacks[2];
       if(! _cC_) throw caml_maybe_attach_backtrace(Empty, 1);
       var content = _cC_[1];
       if(_cC_[2]){
        var next = _cC_[2];
   ...
   function wakeup(r, exn){
    var p = underlying(r), _cB_ = p[1];
    switch(_cB_[0]){
      case 1:
       return _cB_[1] === Canceled
               ? 0
               : caml_call1(ksprintf(invalid_arg, _b3_), api_function_name);
      case 2:
       var result = [0, exn]; resolve(_b4_, 0, p, result); return 0;
      default:
   ...
   var
    pause_hook = [0, function(_cA_){return 0;}],
    paused = create(0),
    _b$_ = [0, 0];
   function wakeup_paused(param){
    if(paused[2] === paused){_b$_[1] = 0; return 0;}
    var tmp = create(0);
    tmp[1][2] = paused[2];
    paused[2][1] = tmp[1];
    tmp[1] = paused[1];
   ...
   var
    d2 = bytes(b),
    _bP_ = get_int64_le(d2, 8),
    _bQ_ = get_int64_le(d2, 0),
    _bR_ = get_int64_le(d1, 8);
   set(s$0, get_int64_le(d1, 0), _bR_, _bQ_, _bP_);
   function get$0(a, i, j, k){
    var _cs_ = i < 0 ? 1 : 0;
    if(_cs_)
     var _ct_ = _cs_;
    else{
      ...
      for(;;){
       if(0 <= j$1[1]){
        ...
        if
         (!
          caml_check_bound
            (caml_check_bound(caml_check_bound(a, i$1)[1 + i$1], _cq_)
              [1 + _cq_],
             k$1)
           [1 + k$1]){
         j$1[1] += -1;
       ...
       var _cr_ = k$1 + 1 | 0;
       if(11 !== k$1){var k$1 = _cr_; continue b;}
       var _cp_ = i$1 + 1 | 0;
       if(11 !== i$1){var i$1 = _cp_; continue a;}
       var j$0 = 0;
       c:
       for(;;){
        var i$0 = [0, 11], k$0 = 0;
         ...
         for(;;){
          if(0 <= i$0[1]){
           ...
           if
            (!
             caml_check_bound
               (caml_check_bound(caml_check_bound(a, _cn_)[1 + _cn_], j$0)
                 [1 + j$0],
                k$0)
              [1 + k$0]){
            i$0[1] += -1;
          ...
          var _co_ = k$0 + 1 | 0;
          if(11 !== k$0){var k$0 = _co_; continue d;}
          var _cm_ = j$0 + 1 | 0;
          if(11 !== j$0){var j$0 = _cm_; continue c;}
          var i = 0;
          e:
          for(;;){
           var k = [0, 11], j = 0;
   ...
   function create_canvas(param){
    var doc = global.document, t102 = doc.createElement("canvas");
    if(1 - test(t102.getContext))
     throw caml_maybe_attach_backtrace(Canvas_not_available, 1);
    t102.width = 409;
    t102.height = 481;
    return t102;
   }
   function redraw(ctx, canvas, a){
    var t129 = canvas.getContext(cst_2d);
    t129.setTransform(1., 0., 0., 1., 0., 0.);
    t129.clearRect(0., 0., canvas.width, canvas.height);
    t129.setTransform(1., 0., 0., 1., 0.5, 0.5);
    t129.globalCompositeOperation = "lighter";
    tile(t129, a, [0, draw_top, draw_right, draw_left]);
    t129.globalCompositeOperation = "source-over";
    tile(t129, a, [0, top_edges, right_edges, left_edges]);
    t129.beginPath();
    t129.moveTo(0., 360.);
    t129.lineTo(204., 480.);
    t129.lineTo(408., 360.);
   ...
   function loop(c$0, c, a){
    function f$0(param){
     ...
     for(;;){
      var i = int$0(n$0), j = int$0(n$0), k = int$0(n$0);
      if
       (caml_check_bound
          (caml_check_bound(caml_check_bound(a, i)[1 + i], j)[1 + j], k)
         [1 + k]){
       ...
       if
        (get$0(a, i + 1 | 0, j, k)
         || get$0(a, i, j + 1 | 0, k) || get$0(a, i, j, k + 1 | 0))
        switch$0 = 1;
       else{
        caml_check_bound
          (caml_check_bound(caml_check_bound(a, i)[1 + i], j)[1 + j], k)
       ...
       if(! switch$1) var _cg_ = 0;
      }
      var _ch_ = _cg_ || need_redraw[1];
      need_redraw[1] = _ch_;
      var _ci_ = i$0 + 1 | 0;
      if(99 !== i$0){var i$0 = _ci_; continue;}
      if(need_redraw[1]) redraw(c$0, c, a);
      return loop(c$0, c, a);
     }
    }
    var p = new_pending(1), d = 200.;
    function callback$0(_cf_){return wakeup(p, _cf_);}
    var id = [0, 0];
    function loop$0(d, param){
     ...
     var
      cb =
        remain == 0.
         ? callback$0
         : function(_ce_){return loop$0(remain, _ce_);};
    ...
    function create_result_promise_and_call(param){
     ...
     function callback(p_result){
      if(1 === p_result[0]){
       ...
       resolve(_b7_, 0, p$1, p_result);
       return 0;
      }
      var v = p_result[1];
      current_storage[1] = saved_storage;
      try{var _cd_ = f$0(v), user_provided_promise = _cd_;}
      catch(exn$0){
       var exn = caml_wrap_exception(exn$0);
      ...
      if(p$0 !== outer_promise){
       ...
       switch(match[0]){
         case 1:
          resolve(_b6_, 0, outer_promise, p$0[1]); break;
         case 2:
          var
           p_callbacks = match[1],
          ...
          break;
         default: resolve(_b5_, 0, outer_promise, p$0[1]);
       }
      }
      return 0;
     }
    ...
    switch(result[0]){
      ...
      default:
       ...
       return run_callback_or_defer_it
               (_b8_, function(param){return f$0(v);}, _cb_);
    }
   }
   function start(param){
    var
     c = create_canvas(0),
     c$0 = create_canvas(0),
     t137 = global.document,
     p = t137.body;
    p.appendChild(c);
    var t141 = c.getContext(cst_2d);
    ...
    var
     a =
       init
        (n$0,
         function(param){
          return init(n$0, function(param){return caml_make_vect(12, 1);});
         });
    redraw(t141, c$0, a);
    loop(t141, c$0, a);
    return false$0;
