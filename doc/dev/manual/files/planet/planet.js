...
(function(globalThis){
   ...
   var
    ...
    _m_ = "String.contains_from / Bytes.contains_from",
    _o_ = "Array.blit",
    ...
    _N_ = "%r",
    _O_ = "%_r",
    _P_ = [0, cst_camlinternalFormat_ml, 850, 23],
    _$_ = [0, cst_camlinternalFormat_ml, 814, 21],
    _S_ = [0, cst_camlinternalFormat_ml, 815, 21],
    _aa_ = [0, cst_camlinternalFormat_ml, 818, 21],
    _U_ = [0, cst_camlinternalFormat_ml, 819, 21],
    _ab_ = [0, cst_camlinternalFormat_ml, 822, 19],
    _V_ = [0, cst_camlinternalFormat_ml, 823, 19],
    _ac_ = [0, cst_camlinternalFormat_ml, 826, 22],
    _W_ = [0, cst_camlinternalFormat_ml, 827, 22],
    _ad_ = [0, cst_camlinternalFormat_ml, 831, 30],
    _X_ = [0, cst_camlinternalFormat_ml, 832, 30],
    _Z_ = [0, cst_camlinternalFormat_ml, 836, 26],
    _Q_ = [0, cst_camlinternalFormat_ml, 837, 26],
    ___ = [0, cst_camlinternalFormat_ml, 846, 28],
    _R_ = [0, cst_camlinternalFormat_ml, 847, 28],
    _Y_ = [0, cst_camlinternalFormat_ml, 851, 23],
    ...
    _w_ = "@%",
    _x_ = "@",
    _ae_ = "CamlinternalFormat.Type_mismatch",
    _bk_ = cst$2,
    ...
    _bC_ = [0, [2, 0, [11, " unknown location", 0]], "%s unknown location"],
    _bq_ = "Out of memory",
    _br_ = "Stack overflow",
    ...
    _bY_ = "select",
    _bX_ = "option",
    _b5_ = "Js_of_ocaml__Dom_html.Canvas_not_available",
    _ce_ = [0, 0],
    _cf_ = [0, 1],
    _cc_ = [0, 0],
    _cd_ = [0, 1],
    ...
    _b__ = [0, [11, cst_Lwt, [2, 0, 0]], cst_Lwt_s],
    _b$_ = [0, 0],
    _b7_ = cst_Fatal_error_exception,
    _b8_ = "Lwt.Resolution_loop.Canceled",
    _ch_ = "Exception during Lwt.async: ",
    _cy_ = [0, [8, [0, 0, 0], 0, [0, 2], 0], "%.2f"],
    _cs_ = "Resume",
    _ct_ = "Pause",
    _cu_ = "Fixed position",
    _cv_ = "Follow rotation",
    param = [0, "December solstice", [0, "Equinox", [0, "June solstice", 0]]],
    _cw_ = "Lighting",
    _cx_ = "Clip",
    _cr_ = [0, cst_examples_planet_planet_ml, 428, 2],
    _cq_ = [0, cst_examples_planet_planet_ml, 429, 2],
    _cp_ = [0, cst_examples_planet_planet_ml, 430, 2],
    _co_ = [0, cst_examples_planet_planet_ml, 431, 2];
   ...
   function flush_all(param){
    ...
    for(;;){
     ...
     try{caml_ml_flush(a);}
      ...
      var _e0_ = caml_wrap_exception(_e1_);
      if(_e0_[1] !== Sys_error) throw caml_maybe_attach_backtrace(_e0_, 0);
     }
     var param$0 = l;
    }
   }
   ...
   function sub_string(b, ofs, len){
    ...
    if(! switch$0) var _eZ_ = invalid_arg(_j_);
   ...
   var at_exit_key = new_key(0, function(param, _eV_){return 0;});
     ...
     switch(param[0]){
       case 0:
        var
         ...
         af = match[2],
         fa = match[1],
         _ey_ = function(param){af(0); return 0;};
        return [0, function(param){fa(0); return 0;}, _ey_, ed, de];
       case 1:
        var
         rest$0 = param[1],
         ...
         af$0 = match$0[2],
         fa$0 = match$0[1],
         _ez_ = function(param){af$0(0); return 0;};
        return [0, function(param){fa$0(0); return 0;}, _ez_, ed$0, de$0];
       case 2:
        var
         rest$1 = param[1],
         ...
         af$1 = match$1[2],
         fa$1 = match$1[1],
         _eA_ = function(param){af$1(0); return 0;};
        return [0, function(param){fa$1(0); return 0;}, _eA_, ed$1, de$1];
       case 3:
        var
         rest$2 = param[1],
         ...
         af$2 = match$2[2],
         fa$2 = match$2[1],
         _eB_ = function(param){af$2(0); return 0;};
        return [0, function(param){fa$2(0); return 0;}, _eB_, ed$2, de$2];
       case 4:
        var
         rest$3 = param[1],
         ...
         af$3 = match$3[2],
         fa$3 = match$3[1],
         _eC_ = function(param){af$3(0); return 0;};
        return [0, function(param){fa$3(0); return 0;}, _eC_, ed$3, de$3];
       case 5:
        var
         rest$4 = param[1],
         ...
         af$4 = match$4[2],
         fa$4 = match$4[1],
         _eD_ = function(param){af$4(0); return 0;};
        return [0, function(param){fa$4(0); return 0;}, _eD_, ed$4, de$4];
       case 6:
        var
         rest$5 = param[1],
         ...
         af$5 = match$5[2],
         fa$5 = match$5[1],
         _eE_ = function(param){af$5(0); return 0;};
        return [0, function(param){fa$5(0); return 0;}, _eE_, ed$5, de$5];
       case 7:
        var
         rest$6 = param[1],
         ...
         af$6 = match$6[2],
         fa$6 = match$6[1],
         _eF_ = function(param){af$6(0); return 0;};
        return [0, function(param){fa$6(0); return 0;}, _eF_, ed$6, de$6];
       case 8:
        var
         rest$7 = param[2],
         ...
         af$7 = match$7[2],
         fa$7 = match$7[1],
         _eG_ = function(param){af$7(0); return 0;};
        return [0, function(param){fa$7(0); return 0;}, _eG_, ed$7, de$7];
       case 9:
        var
         rest$8 = param[3],
         ty2 = param[2],
         ...
         ga = match$9[2],
         ag = match$9[1],
         _eH_ = function(param){jd(0); de$8(0); return 0;},
         _eI_ = function(param){ed$8(0); dj(0); return 0;},
         _eJ_ = function(param){ga(0); af$8(0); return 0;};
        return [0,
       ...
       case 10:
        var
         ...
         af$9 = match$10[2],
         fa$9 = match$10[1],
         _eK_ = function(param){af$9(0); return 0;};
        return [0, function(param){fa$9(0); return 0;}, _eK_, ed$9, de$9];
       case 11:
        var
         rest$10 = param[1],
         ...
         af$10 = match$11[2],
         fa$10 = match$11[1],
         _eL_ = function(param){af$10(0); return 0;};
        return [0, function(param){fa$10(0); return 0;}, _eL_, ed$10, de$10];
       case 12:
        var
         rest$11 = param[1],
         ...
         af$11 = match$12[2],
         fa$11 = match$12[1],
         _eM_ = function(param){af$11(0); return 0;};
        return [0, function(param){fa$11(0); return 0;}, _eM_, ed$11, de$11];
       case 13:
        var
         rest$12 = param[1],
         ...
         af$12 = match$13[2],
         fa$12 = match$13[1],
         _eN_ = function(param){de$12(0); return 0;},
         _eO_ = function(param){ed$12(0); return 0;},
         _eP_ = function(param){af$12(0); return 0;};
        return [0, function(param){fa$12(0); return 0;}, _eP_, _eO_, _eN_];
       default:
        var
         rest$13 = param[1],
         ...
         af$13 = match$14[2],
         fa$13 = match$14[1],
         _eQ_ = function(param){de$13(0); return 0;},
         _eR_ = function(param){ed$13(0); return 0;},
         _eS_ = function(param){af$13(0); return 0;};
        return [0, function(param){fa$13(0); return 0;}, _eS_, _eR_, _eQ_];
     }
    function _ev_(param){return 0;}
    function _ew_(param){return 0;}
    function _ex_(param){return 0;}
    return [0, function(param){return 0;}, _ex_, _ew_, _ev_];
   }
   function trans(ty1, ty2){
         ...
         switch(ty2[0]){
           case 8:
            var
             rest2$7 = ty2[2],
             ty2$0 = ty2[1],
             _eu_ = trans(rest1$7, rest2$7);
            return [8, trans(ty1$0, ty2$0), _eu_];
           case 10: break;
           case 11:
            switch$0 = 1; break;
           case 12:
    ...
    switch(switch$0){
      ...
      default: throw caml_maybe_attach_backtrace([0, Assert_failure, _Y_], 1);
    }
   }
      ...
      case 14:
       if(typeof fmtty0 !== "number" && 9 === fmtty0[0]){
        var
         ...
         sub_fmtty$1 = fmt[2],
         pad_opt$0 = fmt[1],
         _es_ = [0, erase_rel(sub_fmtty1)];
        if(caml_notequal([0, erase_rel(sub_fmtty$1)], _es_))
         throw caml_maybe_attach_backtrace(Type_mismatch, 1);
        var
        ...
        switch(ign[0]){
          ...
          case 9:
           var
            sub_fmtty$3 = ign[2],
            pad_opt$2 = ign[1],
            _et_ = type_ignored_format_substituti(sub_fmtty$3, rest, fmtty0),
            match$43 = _et_[2],
            fmtty$21 = match$43[2],
            fmt$22 = match$43[1],
            sub_fmtty$4 = _et_[1];
      ...
      case 9:
       if(typeof fmtty !== "number" && 9 === fmtty[0]){
        var
         ...
         _eq_ = [0, erase_rel(sub1_fmtty)];
        if(caml_notequal([0, erase_rel(sub1_fmtty$0)], _eq_))
         throw caml_maybe_attach_backtrace(Type_mismatch, 1);
        var _er_ = [0, erase_rel(sub2_fmtty$1)];
        if(caml_notequal([0, erase_rel(sub2_fmtty$2)], _er_))
         throw caml_maybe_attach_backtrace(Type_mismatch, 1);
        var
   ...
   function fix_padding(padty, width, str){
    ...
    var _ep_ = 2 === padty$0 ? 48 : 32, res = make(width$0, _ep_);
    switch(padty$0){
      case 0:
   ...
   function string_to_caml_string(str$0){
    var
     ...
     n = [0, 0],
     _eh_ = caml_ml_bytes_length(b) - 1 | 0,
     _eg_ = 0;
    if(_eh_ >= 0){
     var i$0 = _eg_;
     for(;;){
      ...
      if(32 <= match){
       var _el_ = match - 34 | 0, switch$1 = 0;
       if(58 < _el_ >>> 0){
        if(93 > _el_) switch$1 = 1;
       }
       else if(56 < _el_ - 1 >>> 0) switch$0 = 1; else switch$1 = 1;
       if(switch$1){var _em_ = 1; switch$0 = 2;}
      }
      else
       if(11 <= match){
    ...
    if(n[1] === caml_ml_bytes_length(b))
     ...
     n[1] = 0;
     var _ej_ = caml_ml_bytes_length(b) - 1 | 0, _ei_ = 0;
     if(_ej_ >= 0){
      var i = _ei_;
      for(;;){
   ...
   function transform_int_alt(iconv, s){
    ...
    var n = [0, 0], _eb_ = caml_ml_string_length(s) - 1 | 0, _ea_ = 0;
    if(_eb_ >= 0){
     var i$0 = _ea_;
     for(;;){
      if(9 >= caml_string_unsafe_get(s, i$0) - 48 >>> 0) n[1]++;
      var _ef_ = i$0 + 1 | 0;
      if(_eb_ !== i$0){var i$0 = _ef_; continue;}
      break;
     }
    }
    var
    ...
    var
     ...
     _ed_ = caml_ml_string_length(s) - 1 | 0,
     _ec_ = 0;
    if(_ed_ >= 0){
     var i = _ec_;
     for(;;){
   ...
   function convert_int32(iconv, n){
    switch(iconv){
      ...
      case 14:
       var _d__ = _aI_; break;
      default: var _d__ = _aR_;
    }
    return transform_int_alt(iconv, caml_format_int(_d__, n));
   }
   ...
   function convert_int64(iconv, n){
    switch(iconv){
      ...
      case 14:
       var _d8_ = _av_; break;
      default: var _d8_ = _aE_;
    }
    return transform_int_alt(iconv, caml_int64_format(_d8_, n));
   }
      ...
      case 5:
       ...
       for(;;){
        if(i$0 === len)
         ...
         var _d5_ = caml_string_get(str, i$0) - 46 | 0, switch$0 = 0;
         if(23 < _d5_ >>> 0){
          if(55 === _d5_) switch$0 = 1;
         }
         else if(21 < _d5_ - 1 >>> 0) switch$0 = 1;
         if(! switch$0){var i$1 = i$0 + 1 | 0, i$0 = i$1; continue;}
         var _d6_ = 1;
        }
        var _d7_ = _d6_ ? str : symbol(str, _a5_);
        return caml_special_val(_d7_);
       }
      case 6:
       return hex(0);
      case 7:
       ...
       if(0 === l)
        ...
        var r = caml_create_bytes(l), _d1_ = l - 1 | 0, _d0_ = 0;
        if(_d1_ >= 0){
         var i = _d0_;
         for(;;){
          var
           c = caml_bytes_unsafe_get(s, i),
           _d2_ = 25 < c - 97 >>> 0 ? c : c - 32 | 0;
          caml_bytes_unsafe_set(r, i, _d2_);
          var _d3_ = i + 1 | 0;
          if(_d1_ !== i){var i = _d3_; continue;}
          break;
         }
        }
        var _d4_ = r;
       }
       return caml_string_of_bytes(_d4_);
      case 8:
    ...
    for(;;){
     ...
     switch(fmt$0[0]){
       ...
       case 14:
        ...
        return function(param){
         var
          ...
          _dZ_ = type_format_gen(fmt$0, fmtty$0);
         if(typeof _dZ_[2] !== "number")
          throw caml_maybe_attach_backtrace(Type_mismatch, 1);
         var fmt = _dZ_[1];
       ...
       default:
        ...
        if(counter >= 50)
         return caml_trampoline_return
                 (make_custom$0, [0, k$0, acc$0, rest$23, arity, _dY_]);
        var counter$0 = counter + 1 | 0;
        return make_custom$0(counter$0, k$0, acc$0, rest$23, arity, _dY_);
     }
    }
   }
   ...
   function make_invalid_arg(counter, k, acc, fmt){
    var _dV_ = [8, acc, _bc_];
    if(counter >= 50)
     return caml_trampoline_return(make_printf$0, [0, k, _dV_, fmt]);
    var counter$0 = counter + 1 | 0;
    return make_printf$0(counter$0, k, _dV_, fmt);
   }
   function make_custom$0(counter, k, acc, rest, arity, f){
    ...
    var _dU_ = [4, acc, f];
    if(counter >= 50)
     return caml_trampoline_return(make_printf$0, [0, k, _dU_, rest]);
    var counter$0 = counter + 1 | 0;
    return make_printf$0(counter$0, k, _dU_, rest);
   }
   ...
   function fprintf(oc, fmt$0){
    var fmt = fmt$0[1], _dT_ = 0;
    return make_printf
            (function(acc){output_acc(oc, acc); return 0;}, _dT_, fmt);
   }
   ...
   function other_fields(x, i){
    ...
    var _dR_ = other_fields(x, i + 1 | 0), _dS_ = field(x, i);
    return caml_call2(sprintf(_bl_), _dS_, _dR_);
   }
   function to_string(e){
    ...
    for(;;){
     if(param){
      ...
      try{var val = caml_call1(hd, e);}catch(_dQ_){switch$0 = 1;}
      var switch$1 = 0;
      if(switch$0 || ! val)
       switch$1 = 1;
      else
     ...
     if(0 === caml_obj_tag(e)){
      ...
      if(2 < match >>> 0)
       var
        _dM_ = other_fields(e, 2),
        _dN_ = field(e, 1),
        _dP_ = caml_call2(sprintf(_bm_), _dN_, _dM_);
      else
       switch(match){
         case 0:
          var _dP_ = _bn_; break;
         case 1:
          var _dP_ = _bo_; break;
         default:
          var _dO_ = field(e, 1), _dP_ = caml_call1(sprintf(_bp_), _dO_);
       }
      var match$0 = [0, constructor, [0, _dP_]];
     }
     else
      var match$0 = [0, e[1], 0];
     ...
     for(;;){
       ...
       info$0 =
         function(pos){
          function info(is_raise){
           return is_raise ? 0 === pos ? _bv_ : _bw_ : 0 === pos ? _bx_ : _by_;
          }
          return info;
         },
       info = info$0(pos);
      if(0 === slot[0])
       var
        ...
        _dC_ = slot[4],
        _dD_ = slot[3],
        _dE_ = slot[6] ? _bz_ : _bB_,
        _dF_ = slot[2],
        _dG_ = slot[7],
        _dH_ = info(slot[1]),
        match =
          [0,
           caml_call7(sprintf(_bA_), _dH_, _dG_, _dF_, _dE_, _dD_, _dC_, _dB_)];
      else if(slot[1])
       var match = 0;
      else
       var _dI_ = info(0), match = [0, caml_call1(sprintf(_bC_), _dI_)];
      if(match){var str = match[1]; caml_call1(fprintf(outchan, _bD_), str);}
      var _dL_ = pos + 1 | 0;
      if(_dK_ !== pos){var pos = _dL_; continue;}
      break;
     }
    }
    return 0;
   ...
   var errors = _bE_.slice(), empty_backtrace = [0];
   function handle_uncaught_exception(exn$0, debugger_in_use){
    try{
     try{
      ...
      try{do_at_exit(0);}catch(_dz_){}
      try{
       var _dp_ = to_string(exn$0);
       caml_call1(eprintf(_bF_), _dp_);
       print_raw_backtrace(stderr, raw_backtrace);
       var status = caml_ml_debug_info_status(0);
       if(status < 0){
        var _dq_ = abs(status);
        prerr_endline(caml_check_bound(errors, _dq_)[1 + _dq_]);
       }
       var _dr_ = caml_ml_flush(stderr), _dv_ = _dr_;
      }
      catch(exn$1){
       var
        exn = caml_wrap_exception(exn$1),
        raw_backtrace$0 = caml_get_exception_raw_backtrace(0),
        _dt_ = to_string(exn$0);
       caml_call1(eprintf(_bH_), _dt_);
       print_raw_backtrace(stderr, raw_backtrace);
       var _du_ = to_string(exn);
       caml_call1(eprintf(_bI_), _du_);
       print_raw_backtrace(stderr, raw_backtrace$0);
       var _dv_ = caml_ml_flush(stderr);
      }
      var _dw_ = _dv_;
     }
     catch(_dy_){
      var _ds_ = caml_wrap_exception(_dy_);
      if(_ds_ !== Out_of_memory) throw caml_maybe_attach_backtrace(_ds_, 0);
      var _dw_ = prerr_endline(_bG_);
     }
     return _dw_;
    }
    catch(_dx_){return 0;}
   ...
   function set(s, i1, i2, i3, i4){
    caml_ba_set_1(s, 0, caml_int64_or(i1, _bJ_));
    caml_ba_set_1(s, 1, i2);
    var i3$0 = caml_notequal(i3, _bK_) ? i3 : _bN_;
    caml_ba_set_1(s, 2, i3$0);
    var i4$0 = caml_notequal(i4, _bL_) ? i4 : _bM_;
   ...
   function make_self_init(param){
    ...
    var
     d2 = bytes(b),
     _dl_ = get_int64_le(d2, 8),
     _dm_ = get_int64_le(d2, 0),
     _dn_ = get_int64_le(d1, 8);
    set(s, get_int64_le(d1, 0), _dn_, _dm_, _dl_);
    return s;
   }
   function split(s){
    var
   ...
   try{var _cA_ = caml_sys_getenv("OCAMLRUNPARAM"), params = _cA_;}
   catch(_dh_){
    var _bS_ = caml_wrap_exception(_dh_);
    if(_bS_ !== Not_found) throw caml_maybe_attach_backtrace(_bS_, 0);
    try{var _cz_ = caml_sys_getenv("CAMLRUNPARAM"), _bV_ = _cz_;}
    catch(_di_){
     var _bT_ = caml_wrap_exception(_di_);
     if(_bT_ !== Not_found) throw caml_maybe_attach_backtrace(_bT_, 0);
     var _bV_ = _bU_;
    }
    var params = _bV_;
   }
   ...
   if(lim < 0)
    ...
    try{
     ...
     var _n_ = caml_wrap_exception(_dg_);
     if(_n_ !== Not_found) throw caml_maybe_attach_backtrace(_n_, 0);
    }
    ...
    if(t28.addEventListener === undefined$0){
     var
      ...
      callback =
        function(e){
         var _dd_ = [0, h, e, [0]];
         return function(_de_, _df_){return caml_js_call(_dd_, _de_, _df_);};
        };
   ...
   function unsafeCreateElementEx(type, name, doc, elt){
    for(;;){
     ...
     var _c9_ = createElementSyntax[1];
     if(785140586 === _c9_){
      try{
       var
        t49 = document.createElement('<input name="x">'),
        _da_ = t49.tagName.toLowerCase() === cst_input ? 1 : 0,
        _db_ = _da_ ? t49.name === "x" ? 1 : 0 : _da_,
        _c__ = _db_;
      }
      catch(_dc_){var _c__ = 0;}
      var _c$_ = _c__ ? 982028505 : -1003883683;
      createElementSyntax[1] = _c$_;
      continue;
     }
     if(982028505 <= _c9_){
   ...
   function createLabel(doc){return unsafeCreateElement(doc, _b0_);}
   function createDiv(doc){return unsafeCreateElement(doc, _b1_);}
   var
    Canvas_not_available = [248, _b5_, caml_fresh_oo_id(0)],
    html_element = global.HTMLElement;
   html_element === undefined$0;
   var console$0 = caml_js_get_console(0), overflow_limit = 2147483000.;
   ...
   function handle_with_async_exception_ho(f, v){
    try{var _c8_ = caml_call1(f, v); return _c8_;}
    catch(exn$0){
   ...
   function run_callbacks(callbacks, result){
    if(1 === result[0])
     var _c7_ = result[1] === Canceled ? 1 : 0, is_canceled = _c7_;
    else
     var is_canceled = 0;
    if(is_canceled){
     var
    ...
    if(1 === current_callback_nesting_depth[1])
     for(;;){
      if(0 !== deferred_callbacks[1]){
       var _c6_ = deferred_callbacks[2];
       if(! _c6_) throw caml_maybe_attach_backtrace(Empty, 1);
       var content = _c6_[1];
       if(_c6_[2]){
        var next = _c6_[2];
   ...
   function wakeup(r, exn){
    var p = underlying(r), _c5_ = p[1];
    switch(_c5_[0]){
      case 1:
       return _c5_[1] === Canceled
               ? 0
               : caml_call1(ksprintf(invalid_arg, _b__), api_function_name);
      case 2:
       var result = [0, exn]; resolve(_b$_, 0, p, result); return 0;
      default:
    ...
    function create_result_promise_and_call(param){
     ...
     function callback(p_result){
      if(1 === p_result[0]){
       ...
       resolve(_cc_, 0, p$1, p_result);
       return 0;
      }
      var v = p_result[1];
      current_storage[1] = saved_storage;
      try{var _c4_ = caml_call1(f, v), user_provided_promise = _c4_;}
      catch(exn$0){
       var exn = caml_wrap_exception(exn$0);
      ...
      if(p$0 !== outer_promise){
       ...
       switch(match[0]){
         case 1:
          resolve(_cb_, 0, outer_promise, p$0[1]); break;
         case 2:
          var
           p_callbacks = match[1],
          ...
          break;
         default: resolve(_ca_, 0, outer_promise, p$0[1]);
       }
      }
      return 0;
     }
    ...
    switch(result[0]){
      ...
      default:
       ...
       return run_callback_or_defer_it
               (_cd_, function(param){return caml_call1(f, v);}, _c3_);
    }
   }
   var
    pause_hook = [0, function(_c2_){return 0;}],
    paused = create$0(0),
    _cg_ = [0, 0];
   function wakeup_paused(param){
    if(paused[2] === paused){_cg_[1] = 0; return 0;}
    var tmp = create$0(0);
    tmp[1][2] = paused[2];
    paused[2][1] = tmp[1];
    tmp[1] = paused[1];
   ...
   function toggle_button(txt1, txt2, action){
    var
     ...
     t5 = createInput([0, button_type], 0, document);
    t5.value = txt1$0;
    var
     t8 =
       handler
   ...
   function checkbox(txt, checked, action){
    var t11 = createInput([0, "checkbox"], 0, document), t10 = ! ! checked;
    t11.checked = t10;
    var
     t13 =
       handler
        (function(param){caml_call1(action, t11.checked | 0); return true$0;});
    t11.onclick = t13;
    var lab = createLabel(document);
    appendChild(lab, t11);
    appendChild(lab, document.createTextNode(caml_jsstring_of_string(txt)));
    return lab;
   }
   function vect(param, _c0_){
    var
     z2 = _c0_[3],
     y2 = _c0_[2],
     x2 = _c0_[1],
   ...
   function matrix_mul(m$0, m){
    var
     m$1 = matrix_transp(m),
     _cY_ = matrix_vect_mul(m$1, m$0[3]),
     _cZ_ = matrix_vect_mul(m$1, m$0[2]);
    return [0, matrix_vect_mul(m$1, m$0[1]), _cZ_, _cY_];
   }
   ...
   function create_canvas(t17, t19){
    var t52 = unsafeCreateElement(document, _b6_);
   ...
   var
    vertices = caml_make_vect(98, [254, 0., 0., 0.]),
    faces = caml_make_vect(192, [0, 0, 0, 0]);
   caml_check_bound(vertices, 96)[97] = [254, 0., -1., 0.];
   caml_check_bound(vertices, 97)[98] = [254, 0., 1., 0.];
   var i$2 = 0, north = 96, south = 97;
   a:
   for(;;){
    var j = 0;
    for(;;){
     var
      phi = i$2 * 0.5235987755982988,
     ...
     if(0 === j){
      var _cj_ = 2 * k | 0;
      caml_check_bound(faces, _cj_)[1 + _cj_] = [0, north, k, (k + 8 | 0) % 96 | 0];
      var _ck_ = (2 * k | 0) + 1 | 0;
      caml_check_bound(faces, _ck_)[1 + _ck_] =
       [0, south, ((k + 16 | 0) - 1 | 0) % 96 | 0, (k + 8 | 0) - 1 | 0];
     }
     else{
      var _cm_ = 2 * k | 0;
      caml_check_bound(faces, _cm_)[1 + _cm_] = [0, k, (k + 8 | 0) % 96 | 0, k - 1 | 0];
      var _cn_ = (2 * k | 0) + 1 | 0;
      caml_check_bound(faces, _cn_)[1 + _cn_] =
       [0, k - 1 | 0, (k + 8 | 0) % 96 | 0, ((k + 8 | 0) - 1 | 0) % 96 | 0];
     }
     var _cl_ = j + 1 | 0;
     if(7 !== j){var j = _cl_; continue;}
     var _ci_ = i$2 + 1 | 0;
     if(11 !== i$2){var i$2 = _ci_; continue a;}
     var
      start =
        function(param$0){
         function _cC_(texture){
          var
           w = texture.width,
           h = texture.height,
           canvas = create_canvas(w, h),
           ctx = canvas.getContext(cst_2d),
           h$0 = h / 8 | 0,
           w$0 = w / 8 | 0,
          ...
          var
           ...
           ctx$0 = canvas$0.getContext(cst_2d),
           no_lighting = [0, 0],
           canvas$1 = create_canvas(width, width),
           canvas$2 = create_canvas(width, width);
          appendChild(document.body, canvas$1);
          var
           t167 = canvas$1.getContext(cst_2d),
           t164 = canvas$2.getContext(cst_2d),
           tw = texture.width,
           th = texture.height,
           uv =
             map
              (function(v$0){
                ...
                if(! (0. <= u))
                 throw caml_maybe_attach_backtrace
                        ([0, Assert_failure, _cr_], 1);
                if(! (u < tw))
                 throw caml_maybe_attach_backtrace
                        ([0, Assert_failure, _cq_], 1);
                if(! (0. <= v))
                 throw caml_maybe_attach_backtrace
           ...
           m = [0, matrix_identity],
           phi_rot = [0, 0.],
           rateText = document.createTextNode(cst$2),
           ctrl = createDiv(document);
          ctrl.className = "controls";
          var d = createDiv(document);
          appendChild
           (d, document.createTextNode("Click and drag mouse to rotate."));
          appendChild(ctrl, d);
          var form = createDiv(document);
          function br(param){return unsafeCreateElement(document, _b3_);}
          appendChild
           (form,
            toggle_button(_ct_, _cs_, function(p){paused[1] = p; return 0;}));
          appendChild(form, br(0));
          appendChild
           (form,
            toggle_button(_cv_, _cu_, function(f){follow[1] = f; return 0;}));
          appendChild(form, br(0));
          var t1 = createInput([0, button_type], 0, document);
          ...
          appendChild(form, br(0));
          var lab = createLabel(document);
          appendChild(lab, document.createTextNode("Date:"));
          var
           t124 = unsafeCreateElementEx(0, 0, document, _bY_),
           param$0 = param;
          for(;;){
           if(param$0){
            var
             l = param$0[2],
             txt = param$0[1],
             o = unsafeCreateElement(document, _bX_);
            appendChild
             (o, document.createTextNode(caml_jsstring_of_string(txt)));
            t124.add(o, no_handler);
            var param$0 = l;
            continue;
           }
           var
           ...
           t124.onchange = t125;
           appendChild(lab, t124);
           appendChild(form, lab);
           appendChild(ctrl, form);
           var form$0 = createDiv(document);
           appendChild
            (form$0,
             checkbox(_cw_, 1, function(l){lighting[1] = l; return 0;}));
           appendChild(form$0, br(0));
           appendChild
            (form$0,
             checkbox(_cx_, 1, function(l){clipped[1] = l; return 0;}));
           appendChild(form$0, br(0));
           appendChild(form$0, document.createTextNode("Frames per second: "));
           appendChild(form$0, rateText);
           appendChild(ctrl, form$0);
           appendChild(document.body, ctrl);
           var t131 = unsafeCreateElement(document, _b2_);
           t131.innerHTML =
            "Credit: <a href='http://visibleearth.nasa.gov/'>Visual Earth<\/a>, Nasa";
           appendChild(document.body, t131);
           var
            mx = [0, 0],
            my = [0, 0],
            t137 =
                     ...
                     (document,
                      ...
                      handler
                       (function(t135){
                         ...
                         if(0 !== dx){
                          var _cQ_ = m[1];
                          m[1] = matrix_mul(xz_rotation(2. * dx / 600), _cQ_);
                         }
                         mx[1] = x;
                         my[1] = y;
                         return true$0;
            ...
            loop =
              function(t$0, phi$0){
               ...
               if(lighting$0){
                ...
                var
                 i$0 =
                   (6.283185307179586 - phi) * w$1 / 2. / 3.141592653589793
                   % w$1
                   | 0;
                ctx$0.drawImage(canvas, i$0, 0.);
                ctx$0.drawImage(canvas, i$0 - w$1, 0.);
               }
               ...
               var
                ...
                _cH_ =
                  map(function(v){return matrix_vect_mul(m$0, v);}, vertices),
                dir = matrix_vect_mul(matrix_transp(m$0), v);
               t164.clearRect(0., 0., 600, 600);
               t164.save();
               if(clipped[1]){
                t164.beginPath();
                t164.arc(300., 300., 285., 0., -6.283185307179586, true$0);
                t164.clip();
               }
               t164.setTransform(298., 0., 0., 298., 300., 300.);
               t164.globalCompositeOperation = "lighter";
               var _cE_ = faces.length - 1 - 1 | 0, _cD_ = 0;
               if(_cE_ >= 0){
                var i = _cD_;
                for(;;){
                 var
                  ...
                  v2 = param[2],
                  v1 = param[1],
                  match$1 = caml_check_bound(_cH_, v1)[1 + v1],
                  y1$0 = match$1[2],
                  x1$0 = match$1[1],
                  match$2 = caml_check_bound(_cH_, v2)[1 + v2],
                  y2$0 = match$2[2],
                  x2$0 = match$2[1],
                  match$3 = caml_check_bound(_cH_, v3)[1 + v3],
                  y3 = match$3[2],
                  x3 = match$3[1],
                 ...
                 if(0. <= x1 * x2 + y1 * y2 + z1 * z2){
                  t164.beginPath();
                  t164.moveTo(x1$0, y1$0);
                  t164.lineTo(x2$0, y2$0);
                  t164.lineTo(x3, y3);
                  t164.closePath();
                  t164.save();
                  t164.clip();
                  var
                   match$4 = caml_check_bound(face_info, i)[1 + i],
                   dv = match$4[10],
                   du = match$4[9],
                   v$0 = match$4[8],
                   u = match$4[7],
                   ...
                   d$0 = dy2 * dv3 - dy3 * dv2,
                   e = dy2 * du3 - dy3 * du2,
                   f$0 = y1$0 - d$0 * u1 - e * v1$0;
                  t164.transform(a, d$0, b, e, c, f$0);
                  t164.drawImage(canvas$0, u, v$0, du, dv, u, v$0, du, dv);
                  t164.restore();
                 }
                 var _cF_ = i + 1 | 0;
               ...
               try{t167.getImageData(0., 0., 1., 1.);}catch(_cP_){}
               var
                t$1 = (new date_constr).getTime(),
                hz = 1000. / (t$1 - ti[1]),
               ...
               var
                _cJ_ = fps[1],
                t179 =
                  caml_jsstring_of_string(caml_call1(sprintf(_cy_), _cJ_));
               rateText.data = t179;
               ti[1] = t$1;
               function _cK_(param){
                var
                 t = (new date_constr).getTime(),
                 dt = t - t$0,
                 dt$0 = dt < 0. ? 0. : 1000. < dt ? 0. : dt,
                 angle = 6.283185307179586 * dt$0 / 1000. / 10.,
                 _cN_ = 1 - paused[1],
                 _cO_ = _cN_ ? follow[1] : _cN_;
                if(_cO_) phi_rot[1] = phi_rot[1] + angle;
                var phi = paused[1] ? phi$0 : phi$0 + angle;
                return loop(t, phi);
               }
               var match$0 = task(0), w = match$0[2], t = match$0[1], d = 10.;
               function callback(_cM_){return wakeup(w, _cM_);}
               var id = [0, 0];
               function loop$0(d, param){
                ...
                var
                 cb =
                   remain == 0.
                    ? callback
                    : function(_cL_){return loop$0(remain, _cL_);};
                id[1] =
                 [0, global.setTimeout(caml_js_wrap_callback(cb), step)];
                return 0;
               }
               loop$0(d, 0);
               function f(param){
               ...
               return symbol_bind(t, _cK_);
              };
           return loop((new date_constr).getTime(), 0.);
          }
         }
         var img = unsafeCreateElement(document, _b4_);
         ...
         img.onload = t21;
         img.src = "../planet/texture.jpg";
         var
          p = symbol_bind(symbol_bind(t, _cB_), _cC_),
