...
let%expect_test "test-compiler/lib-effects/test1.ml" =
  ...
  print_fun_decl code (Some "cond1$0");
  print_fun_decl code (Some "cond1$1");
  print_var_decl code "cond1";
  print_fun_decl code (Some "cond2$0");
  print_fun_decl code (Some "cond2$1");
  print_var_decl code "cond2";
  print_fun_decl code (Some "cond3$0");
  print_fun_decl code (Some "cond3$1");
  print_var_decl code "cond3";
  print_fun_decl code (Some "loop1$0");
  print_fun_decl code (Some "loop1$1");
  print_var_decl code "loop1";
  print_fun_decl code (Some "loop2$0");
  print_fun_decl code (Some "loop2$1");
  print_var_decl code "loop2";
  print_fun_decl code (Some "loop3$0");
  print_fun_decl code (Some "loop3$0");
  print_var_decl code "loop3";
  [%expect
    {|
    ...
    function exceptions$0(s){
     ...
     try{
      if(caml_string_equal(s, cst))
       throw caml_maybe_attach_backtrace(Stdlib[8], 1);
      var _R_ = [0, [0, caml_call1(Stdlib[79], cst_toto), n, m]];
      return _R_;
     }
     catch(_U_){
    ...
    //end
    function loop1$0(b){
     var all = [0, 0], ic = caml_call1(Stdlib[79], cst_static_examples_ml);
     for(;;){
      var line = caml_call1(Stdlib[83], ic);
      all[1] = [0, line, all[1]];
      if(! b) continue;
      caml_call1(Stdlib[53], line);
     }
    }
    //end
    function loop1$1(b, cont){
     var all = [0, 0], _t_ = Stdlib[79];
     return caml_cps_call2
             (_t_,
                        ...
                        (_v_,
                         ...
                         function(line){
                          ...
                          return b
                                  ...
                                  : caml_cps_exact_mono_call1(_u_, 0);
                         });
               }
               return _u_(0);
              });
    ...
    function loop2$0(param){
     var all = [0, 0], ic = caml_call1(Stdlib[79], cst_static_examples_ml$0);
    ...
    function loop3$0(param){
     var l = caml_call1(Stdlib_List[9], _l_), x = l;
